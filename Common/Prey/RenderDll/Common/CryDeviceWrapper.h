...
/*=============================================================================
   CryDeviceWrapper.h :	DirectD3D11 Wrapper to allow to inject hooks before and
                        after each function call

   Revision history:
* Created by Christopher Bolte
...
// only enable the device hook checks if a system requiering those is compiled in
	#if defined(DO_RENDERLOG) || (CAPTURE_REPLAY_LOG)
		#define CRY_DRIVE_WRAPPER_SUPPORT_HOOKS
	#endif
...
public:
	...
	virtual void FlushToFence_PostCallHook(UINT64 fenceValue)                             {}
	virtual void WaitForFence_PostCallHook(UINT64 fenceValue)                             {}
...
public:
	...
	// Modern device object factory
	static CDeviceObjectFactory& GetObjectFactory();
...
public:
	...
	HRESULT FlushToFence(UINT64 fenceValue);
	HRESULT WaitForFence(UINT64 fenceValue);
...
static_assert(sizeof(CCryDeviceContextWrapper) == 24);
...
///////////////////////////////////////////////////////////////////////////////
	#if defined(CRY_DRIVE_WRAPPER_SUPPORT_HOOKS)
...
///////////////////////////////////////////////////////////////////////////////
	...
	#endif // CRY_DRIVE_WRAPPER_SUPPORT_HOOKS
...
inline UINT64 CCryDeviceContextWrapper::InsertFence()
{
	...
	assert(m_pDeviceContext != NULL);
	CRY_DEVICE_WRAPPER_PROFILE();
	_CRY_DEVICE_WRAPPER_DETAIL_INVOKE_PRE_FUNCTION_HOOK_(InsertFence);
	UINT64 result = m_pDeviceContext->InsertFence();
	_CRY_DEVICE_WRAPPER_DETAIL_INVOKE_POST_FUNCTION_HOOK_(InsertFence);
	#else
	UINT64 result = 0;
	CryFatalError("InsertFence not implemented right now any other than DX12");
	#endif
...
///////////////////////////////////////////////////////////////////////////////
inline HRESULT CCryDeviceContextWrapper::TestForFence(UINT64 fenceValue)
{
	#if CRY_USE_DX12
	assert(m_pDeviceContext != NULL);
	CRY_DEVICE_WRAPPER_PROFILE();
	_CRY_DEVICE_WRAPPER_DETAIL_INVOKE_PRE_FUNCTION_HOOK_(TestForFence, fenceValue);
	HRESULT result = m_pDeviceContext->TestForFence(fenceValue);
	_CRY_DEVICE_WRAPPER_DETAIL_INVOKE_POST_FUNCTION_HOOK_(TestForFence, fenceValue);
	#else
	HRESULT result = E_FAIL;
	CryFatalError("TestForFence not implemented right now any other than DX12");
	#endif
...
///////////////////////////////////////////////////////////////////////////////
inline HRESULT CCryDeviceContextWrapper::FlushToFence(UINT64 fenceValue)
{
	#if CRY_USE_DX12
	assert(m_pDeviceContext != NULL);
	CRY_DEVICE_WRAPPER_PROFILE();
	_CRY_DEVICE_WRAPPER_DETAIL_INVOKE_PRE_FUNCTION_HOOK_(FlushToFence, fenceValue);
	HRESULT result = m_pDeviceContext->FlushToFence(fenceValue);
	_CRY_DEVICE_WRAPPER_DETAIL_INVOKE_POST_FUNCTION_HOOK_(FlushToFence, fenceValue);
	#else
	HRESULT result = E_FAIL;
	CryFatalError("FlushToFence not implemented right now any other than DX12");
	#endif
...
///////////////////////////////////////////////////////////////////////////////
inline HRESULT CCryDeviceContextWrapper::WaitForFence(UINT64 fenceValue)
{
	#if CRY_USE_DX12
	assert(m_pDeviceContext != NULL);
	CRY_DEVICE_WRAPPER_PROFILE();
	_CRY_DEVICE_WRAPPER_DETAIL_INVOKE_PRE_FUNCTION_HOOK_(WaitForFence, fenceValue);
	HRESULT result = m_pDeviceContext->WaitForFence(fenceValue);
	_CRY_DEVICE_WRAPPER_DETAIL_INVOKE_POST_FUNCTION_HOOK_(WaitForFence, fenceValue);
	#else
	HRESULT result = E_FAIL;
	CryFatalError("WaitForFence not implemented right now any other than DX12");
	#endif
