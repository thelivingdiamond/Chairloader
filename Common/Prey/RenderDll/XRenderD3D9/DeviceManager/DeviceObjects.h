...
struct SDeviceObjectHelpers
{
	...
	private:
		...
		uint8              m_CachedMemory[((sizeof(T) + (Alignment - 1)) & (~(Alignment - 1))) + (Alignment - 1)];
...
////////////////////////////////////////////////////////////////////////////
class CDeviceComputeCommandInterface;
