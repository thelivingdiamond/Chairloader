...
// CEngineModule_CryInput
// Header:  CryEngine/cryinput/cryinput.h
// Include: Prey/CryInput/CryInput.cpp
...
public:
	...
	static inline auto s_factory = PreyGlobal<CSingletonFactory<CEngineModule_CryInput>>(0x23B9070);
