...
#ifndef CHAIRLOADER_IFLASHPLAYER_H
#define CHAIRLOADER_IFLASHPLAYER_H
#include <cstring>

#include "Prey/CryCore/BaseTypes.h"
#include "Prey/CryCore/Assert/CryAssert.h"
#include "Prey/CryMath/Cry_Color.h"
#include "Prey/CryMath/Cry_Matrix33.h"
#include "Prey/CryMath/Cry_Matrix44.h"
...
struct IFlashPlayer
{
	...
	// Rendering
	virtual void           SetBackgroundColor(const Color_tpl<uint8>& color) = 0;
	...
	virtual void		   AllowWireframeRendering(bool allow) = 0;
...
{
	// <interfuscator:shuffle>
	virtual void RenderCallback(bool releaseOnExit = true) = 0;
	virtual void RenderPlaybackLocklessCallback(int cbIdx, bool finalPlayback = true, bool releaseOnExit = true) = 0;
	virtual void DummyRenderCallback(bool releaseOnExit = true) = 0;
	// </interfuscator:shuffle>
...
#endif //CHAIRLOADER_IFLASHPLAYER_H
