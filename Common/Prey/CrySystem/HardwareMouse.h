...
// Include: CryEngine/crysystem/HardwareMouse.h
...
public:
	...
	static inline auto FOnSystemEvent = PreyFunction<void(ISystemEventListener* const _this, ESystemEvent event, uint64_t wparam, uint64_t lparam)>(0xDA3B90);
	static inline auto FRelease = PreyFunction<void(IHardwareMouse* const _this)>(0xDA3D30);
	static inline auto FOnPreInitRenderer = PreyFunction<void(IHardwareMouse* const _this)>(0xDA3B70);
	static inline auto FOnPostInitInput = PreyFunction<void(IHardwareMouse* const _this)>(0xDA3B40);
	static inline auto FEvent = PreyFunction<void(IHardwareMouse* const _this, int iX, int iY, EHARDWAREMOUSEEVENT eHardwareMouseEvent, int wheelDelta)>(0xDA37B0);
	static inline auto FAddListener = PreyFunction<void(IHardwareMouse* const _this, IHardwareMouseEventListener* pHardwareMouseEventListener)>(0xDA34B0);
	static inline auto FRemoveListener = PreyFunction<void(IHardwareMouse* const _this, IHardwareMouseEventListener* pHardwareMouseEventListener)>(0xE4CAC0);
	static inline auto FSetMouseGameMode = PreyFunction<void(IHardwareMouse* const _this, bool bGameMode)>(0xDA4080);
	static inline auto FIncrementCounter = PreyFunction<void(IHardwareMouse* const _this)>(0xDA3960);
	static inline auto FDecrementCounter = PreyFunction<void(IHardwareMouse* const _this)>(0xDA3760);
	static inline auto FPauseMouse = PreyFunction<void(IHardwareMouse* const _this, bool _forceUpdate)>(0xDA3CE0);
	static inline auto FUnPauseMouse = PreyFunction<void(IHardwareMouse* const _this)>(0xDA41A0);
	static inline auto FGetHardwareMousePosition = PreyFunction<void(IHardwareMouse* const _this, float* pfX, float* pfY)>(0xDA38D0);
	...
	static inline auto FReset = PreyFunction<void(IHardwareMouse* const _this, bool bVisibleByDefault)>(0xDA3F50);
	static inline auto FConfineCursor = PreyFunction<void(IHardwareMouse* const _this, bool confine, bool centerCursor)>(0xDA3550);
	static inline auto FHide = PreyFunction<void(IHardwareMouse* const _this, bool hide)>(0xDA3930);
	static inline auto FUseSystemCursor = PreyFunction<void(IHardwareMouse* const _this, bool useSystemCursor)>(0xDA42A0);
	static inline auto FGetSystemEventListener = PreyFunction<ISystemEventListener* (IHardwareMouse* const _this)>(0xDA3910);
	static inline auto FUpdate = PreyFunction<void(IHardwareMouse* const _this)>(0xDA41D0);
	static inline auto FRender = PreyFunction<void(IHardwareMouse* const _this)>(0xDA3D60);
