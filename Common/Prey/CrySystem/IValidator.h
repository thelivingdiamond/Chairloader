...
{
	VALIDATOR_MODULE_UNKNOWN = 0x0,
	VALIDATOR_MODULE_RENDERER = 0x1,
	VALIDATOR_MODULE_3DENGINE = 0x2,
	VALIDATOR_MODULE_ASSETS = 0x3,
	VALIDATOR_MODULE_AI = 0x4,
	VALIDATOR_MODULE_ANIMATION = 0x5,
	VALIDATOR_MODULE_ENTITYSYSTEM = 0x6,
	VALIDATOR_MODULE_SCRIPTSYSTEM = 0x7,
	VALIDATOR_MODULE_SYSTEM = 0x8,
	VALIDATOR_MODULE_AUDIO = 0x9,
	VALIDATOR_MODULE_GAME = 0xA,
	VALIDATOR_MODULE_MOVIE = 0xB,
	VALIDATOR_MODULE_EDITOR = 0xC,
	VALIDATOR_MODULE_NETWORK = 0xD,
	VALIDATOR_MODULE_PHYSICS = 0xE,
	VALIDATOR_MODULE_FLOWGRAPH = 0xF,
	VALIDATOR_MODULE_ONLINE = 0x10,
};
...
enum EValidatorFlags
{
	...
	VALIDATOR_FLAG_NO_CONTEXT       = 0x0100,
};
