...
#include <Prey/CryCore/BoostHelpers.h>
...
struct IReadWriteXMLSink
{
	...
	virtual XmlNodeRef CreateXMLFromSource(XmlNodeRef *result, const char* definitionFile, IWriteXMLSource* pSource) = 0;
...
{
	// TODO: There's some BS with pointers
	// <interfuscator:shuffle>
