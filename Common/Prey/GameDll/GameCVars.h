...
// Header file automatically created from a PDB.
#pragma once
#include <Prey/GameDll/gameconstantcvars.h>
...
{ // Size=3680 (0xE60)
	...
	int wpn_firstTimePickup;
	float g_arkLightDisableDistance;
	static inline auto bInOnHudShowOptionalHud = PreyGlobal<bool>(0x2D83480);
	...
	static inline auto FInitCVars = PreyFunction<void(SCVars* const _this, IConsole* pConsole)>(0x180E8B0);
	static inline auto FReleaseCVars = PreyFunction<void(SCVars* const _this)>(0x181E080);
	static inline auto FInitAIPerceptionCVars = PreyFunction<void(SCVars* const _this, IConsole* pConsole)>(0x180E640);
	static inline auto FRefreshFOVCVars = PreyFunction<void(SCVars* const _this, const float _aspectRatio)>(0x181D5C0);
	static inline auto FUpdateShowOptionalHud = PreyFunction<void(ICVar* const _pCvar)>(0x1820B20);
};
#endif // !MOONCRASH
