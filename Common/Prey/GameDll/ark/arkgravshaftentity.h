...
// CArkGravShaftEntity
// Header:  Prey/GameDll/ark/ArkGravShaftEntity.h
class CArkGravShaftEntity
	: public CGameObjectExtensionHelper<CArkGravShaftEntity, IGameObjectExtension>
	, public IParticleEffectListener
	, public IArkRepairableListener
	, public IArkLightListener
	, public IArkGravShaft
	, public IArkPlayerHealthListener
{ // Size=576 (0x240)
public:
	// CArkGravShaftEntity::ArkContainedEntity
	// Header:  Prey/GameDll/ark/ArkGravShaftEntity.h
	struct ArkContainedEntity
	{ // Size=32 (0x20)
		unsigned m_entityId;
		bool m_bIsBouncing;
		std::vector<int> m_particleSlots;
	...
	#if 0
		unsigned GetEntityId() const;
		const std::vector<int>& GetParticleSlots() const;
		bool IsBouncing() const;
		void ClearParticleEmitterSlots();
		bool IsPlayer() const;
		void AddParticleEmitterSlot(const int _arg0_);
		bool operator==(const unsigned& _arg0_) const;
		void SetBouncing(const bool _arg0_);
		ArkContainedEntity(const unsigned& _arg0_);
	#endif
	};
	...
	bool m_bBiDirectional;
	bool m_bReversed;
	static inline auto s_gravShafts = PreyGlobal<std::vector<CArkGravShaftEntity*>>(0x2D62D80);
	...
	bool UpdateEntityPhysics(CArkGravShaftEntity::ArkContainedEntity& _containedEntity, const float _frameTime) const { return FUpdateEntityPhysics(this, _containedEntity, _frameTime); }
	void PlayShaftEffects() { FPlayShaftEffects(this); }
	void DestroyParticleEffect(CArkGravShaftEntity::ArkContainedEntity& _containedEntity, bool _bKill) const { FDestroyParticleEffectOv0(this, _containedEntity, _bKill); }
	void StopAllAudio() { FStopAllAudio(this); }
	void PlayEntityEnterEffects(CArkGravShaftEntity::ArkContainedEntity& _containedEntity) { FPlayEntityEnterEffects(this, _containedEntity); }
	void InitializeActiveState() { FInitializeActiveState(this); }
	void InitializePlayerMovementState() const { FInitializePlayerMovementState(this); }
	void ClearLinks() { FClearLinks(this); }
	void RebuildLinks() { FRebuildLinks(this); }
	std::tuple<Vec3_tpl<float>,Vec3_tpl<float> > CalculateLinkPositions(TNavigationID<1> _navAgentID) const { alignas(std::tuple<Vec3_tpl<float>,Vec3_tpl<float> >) std::byte _return_buf_[sizeof(std::tuple<Vec3_tpl<float>,Vec3_tpl<float> >)]; return *FCalculateLinkPositions(this, reinterpret_cast<std::tuple<Vec3_tpl<float>,Vec3_tpl<float> >*>(_return_buf_), _navAgentID); }
	void OnNavMeshChange() { FOnNavMeshChange(this); }
	void EnablePlayerNightmareAvoidanceField(bool _bEnable) { FEnablePlayerNightmareAvoidanceField(this, _bEnable); }
	void ExecuteLuaEvent(const char* _pEventName, const IEntity* const _pContainedEntity) const { FExecuteLuaEvent(this, _pEventName, _pContainedEntity); }
	virtual void OnBrokenChanged(bool _bBroken, bool _bWasForced);
	Vec3 GetHeightTestPos(IEntity* pEntity, const Vec3& _position) const { alignas(Vec3) std::byte _return_buf_[sizeof(Vec3)]; return *FGetHeightTestPos(this, reinterpret_cast<Vec3*>(_return_buf_), pEntity, _position); }
	void SetDisrupted(const bool _bDisrupted) { FSetDisrupted(this, _bDisrupted); }
...
#if 0
	bool IsGoingTo1G() const;
	static const std::vector<CArkGravShaftEntity*>& GetGravShafts();
	void SpawnParticleEmitter(CArkGravShaftEntity::ArkContainedEntity& _arg0_) const;
	void CacheParticleEffects();
	void ReleaseCachedParticleEffects();
	void DestroyParticleEffect();
	void PlayShaftPowerOnEffects();
	...
	void PlayShaftAudio();
	void PlayInitialShaftAudio();
	void PlayEntityExitEffects(CArkGravShaftEntity::ArkContainedEntity& _arg0_);
	Vec3 GetXYPosInShaft(const Vec3& _arg0_) const;
	float GetHeightInShaft(const Vec3& _arg0_) const;
	void SetEnabled(const bool _arg0_);
	void DrawDebug() const;
	void AddMimicEntity(const unsigned _arg0_);
	void RemoveMimicEntity(const unsigned _arg0_);
#endif

	static inline auto FCArkGravShaftEntityOv1 = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x154DDE0);
	static inline auto FBitNotCArkGravShaftEntity = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x154DFA0);
	static inline auto FUpdate = PreyFunction<void(CArkGravShaftEntity* const _this, SEntityUpdateContext& _ctx, int _updateSlot)>(0x1554AC0);
	static inline auto FProcessEvent = PreyFunction<void(CArkGravShaftEntity* const _this, SEntityEvent& _event)>(0x1552BD0);
	static inline auto FInit = PreyFunction<bool(CArkGravShaftEntity* const _this, IGameObject* _pGameObject)>(0x154FF60);
	static inline auto FInitClient = PreyFunction<void(CArkGravShaftEntity* const _this, int _channelId)>(0x1333E90);
	static inline auto FPostInit = PreyFunction<void(CArkGravShaftEntity* const _this, IGameObject* _pGameObject)>(0x1552970);
	static inline auto FPostInitClient = PreyFunction<void(CArkGravShaftEntity* const _this, int _channelId)>(0x1333E90);
	static inline auto FReloadExtension = PreyFunction<bool(CArkGravShaftEntity* const _this, IGameObject* _pGameObject, const SEntitySpawnParams& _params)>(0x13B0900);
	static inline auto FPostReloadExtension = PreyFunction<void(CArkGravShaftEntity* const _this, IGameObject* _pGameObject, const SEntitySpawnParams& _params)>(0x1333E90);
	static inline auto FGetEntityPoolSignature = PreyFunction<bool(CArkGravShaftEntity* const _this, TSerialize _signature)>(0x13B0900);
	static inline auto FRelease = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x1553F30);
	static inline auto FFullSerialize = PreyFunction<void(CArkGravShaftEntity* const _this, TSerialize _ser)>(0x154F780);
	static inline auto FNetSerialize = PreyFunction<bool(CArkGravShaftEntity* const _this, TSerialize _ser, EEntityAspects _aspect, uint8_t _profile, int _flags)>(0x1A302A0);
	static inline auto FPostSerialize = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x1552AB0);
	static inline auto FSerializeSpawnInfo = PreyFunction<void(CArkGravShaftEntity* const _this, TSerialize _ser)>(0x1333E90);
	static inline auto FGetSpawnInfo = PreyFunction<_smart_ptr<ISerializableInfo>*(CArkGravShaftEntity* const _this, _smart_ptr<ISerializableInfo>* _return_value_)>(0x361570);
	static inline auto FPostUpdate = PreyFunction<void(CArkGravShaftEntity* const _this, float _frameTime)>(0x1333E90);
	static inline auto FPostRemoteSpawn = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x1333E90);
	static inline auto FHandleEvent = PreyFunction<void(CArkGravShaftEntity* const _this, const SGameObjectEvent& _event)>(0x1333E90);
	static inline auto FSetChannelId = PreyFunction<void(CArkGravShaftEntity* const _this, uint16_t _id)>(0x1333E90);
	static inline auto FSetAuthority = PreyFunction<void(CArkGravShaftEntity* const _this, bool _bAuth)>(0x1333E90);
	static inline auto FGetMemoryUsage = PreyFunction<void(const CArkGravShaftEntity* const _this, ICrySizer* _pS)>(0x154FF00);
	static inline auto FOnCreateEmitter = PreyFunction<void(IParticleEffectListener* const _this, IParticleEmitter* _pEmitter)>(0x1333E90);
	static inline auto FOnDeleteEmitter = PreyFunction<void(IParticleEffectListener* const _this, IParticleEmitter* _pEmitter)>(0x1552250);
	static inline auto FOnStartup = PreyFunction<void(IArkLightListener* const _this)>(0x15526A0);
	static inline auto FOnStartDisrupt = PreyFunction<void(IArkLightListener* const _this)>(0x1552690);
	static inline auto FOnStopDisrupt = PreyFunction<void(IArkLightListener* const _this)>(0x15526D0);
	static inline auto FGetEntityState = PreyFunction<IArkGravShaft::EntityState(const IArkGravShaft* const _this, unsigned _id)>(0x154F970);
	static inline auto FWaitToEnter = PreyFunction<bool(const IArkGravShaft* const _this, unsigned _id)>(0x15555B0);
	static inline auto FSetWaiting = PreyFunction<void(IArkGravShaft* const _this, unsigned _id, bool _bWaiting)>(0x1554420);
	static inline auto FGetLinkPositionEnter = PreyFunction<bool(const IArkGravShaft* const _this, TNavigationID<1> _navAgentTypeId, Vec3& _enterPos)>(0x154FC60);
	static inline auto FGetLinkPositionExit = PreyFunction<bool(const IArkGravShaft* const _this, TNavigationID<1> _navAgentTypeId, Vec3& _exitPos)>(0x154FDB0);
	static inline auto FGetEnterDirection = PreyFunction<Vec3*(const IArkGravShaft* const _this, Vec3* _return_value_)>(0x154F950);
	static inline auto FGetExitDirection = PreyFunction<Vec3*(const IArkGravShaft* const _this, Vec3* _return_value_)>(0x154FB90);
	static inline auto FGetTravelDirection = PreyFunction<float(const IArkGravShaft* const _this)>(0x154FF30);
	static inline auto FIsActive = PreyFunction<bool(const IArkGravShaft* const _this)>(0x15521B0);
	static inline auto FOnPlayerDead = PreyFunction<void(IArkPlayerHealthListener* const _this)>(0x1552280);
	static inline auto FIsGoingTo0G = PreyFunction<bool(const CArkGravShaftEntity* const _this)>(0x15521E0);
	static inline auto FOnPlayerStartMimicking = PreyFunction<void(const unsigned _mimicEntityId)>(0x15522F0);
	static inline auto FOnPlayerStopMimicking = PreyFunction<void(const unsigned _mimicEntityId)>(0x1552500);
	static inline auto FInitArea = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x15500A0);
	static inline auto FInitProperties = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x1550CB0);
	static inline auto FInitPhysicsParams = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x15502B0);
	static inline auto FSpawnParticleEmitterOv1 = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x15544C0);
	static inline auto FReverseTravelDirection = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x15540F0);
	static inline auto FClearGloo = PreyFunction<void(const CArkGravShaftEntity* const _this)>(0x154EC70);
	static inline auto FQueryEntitiesInShaft = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x15533F0);
	static inline auto FBounceEntity = PreyFunction<void(const CArkGravShaftEntity* const _this, CArkGravShaftEntity::ArkContainedEntity& _containedEntity)>(0x154E2F0);
	static inline auto FUpdateEntityPhysics = PreyFunction<bool(const CArkGravShaftEntity* const _this, CArkGravShaftEntity::ArkContainedEntity& _containedEntity, const float _frameTime)>(0x1554D80);
	static inline auto FPlayShaftEffects = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x15528D0);
	static inline auto FDestroyParticleEffectOv0 = PreyFunction<void(const CArkGravShaftEntity* const _this, CArkGravShaftEntity::ArkContainedEntity& _containedEntity, bool _bKill)>(0x154F1F0);
	static inline auto FStopAllAudio = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x1554880);
	static inline auto FPlayEntityEnterEffects = PreyFunction<void(CArkGravShaftEntity* const _this, CArkGravShaftEntity::ArkContainedEntity& _containedEntity)>(0x15526E0);
	static inline auto FInitializeActiveState = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x1551E00);
	static inline auto FInitializePlayerMovementState = PreyFunction<void(const CArkGravShaftEntity* const _this)>(0x1551FC0);
	static inline auto FClearLinks = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x154F170);
	static inline auto FRebuildLinks = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x15537C0);
	static inline auto FCalculateLinkPositions = PreyFunction<std::tuple<Vec3_tpl<float>,Vec3_tpl<float> >*(const CArkGravShaftEntity* const _this, std::tuple<Vec3_tpl<float>,Vec3_tpl<float> >* _return_value_, TNavigationID<1> _navAgentID)>(0x154E9C0);
	static inline auto FOnNavMeshChange = PreyFunction<void(CArkGravShaftEntity* const _this)>(0x1552270);
	static inline auto FEnablePlayerNightmareAvoidanceField = PreyFunction<void(CArkGravShaftEntity* const _this, bool _bEnable)>(0x154F500);
	static inline auto FExecuteLuaEvent = PreyFunction<void(const CArkGravShaftEntity* const _this, const char* _pEventName, const IEntity* const _pContainedEntity)>(0x154F630);
	static inline auto FOnBrokenChanged = PreyFunction<void(IArkRepairableListener* const _this, bool _bBroken, bool _bWasForced)>(0x1552240);
	static inline auto FGetHeightTestPos = PreyFunction<Vec3*(const CArkGravShaftEntity* const _this, Vec3* _return_value_, IEntity* pEntity, const Vec3& _position)>(0x154FBB0);
	static inline auto FSetDisrupted = PreyFunction<void(CArkGravShaftEntity* const _this, const bool _bDisrupted)>(0x15542B0);
	static inline auto FUpdateFloorPos = PreyFunction<void(const CArkGravShaftEntity* const _this, TNavigationID<1> _navAgentId, Vec3& _pos)>(0x1555340);
	static inline auto FStartUsing = PreyFunction<bool(CArkGravShaftEntity* const _this, CArkGravShaftEntity::ArkContainedEntity& _containedEntity)>(0x15547D0);
	static inline auto FStopUsing = PreyFunction<void(CArkGravShaftEntity* const _this, CArkGravShaftEntity::ArkContainedEntity& _containedEntity)>(0x15548C0);
	static inline auto FEnableLinkedLights = PreyFunction<void(const CArkGravShaftEntity* const _this, const bool _bEnable)>(0x154F3E0);
};
#endif // !MOONCRASH
