...
public:
	...
	static inline auto FSerializeXML = PreyFunction<bool(ArkFlowNodeNpcMakeConscious *const _this, IFlowNode::SActivationInfo *__formal, XmlNodeRef const &__formal, bool __formal)>(0x1B933B0);
	static inline auto FSerialize = PreyFunction<void(ArkFlowNodeNpcMakeConscious *const _this, IFlowNode::SActivationInfo *__formal, TSerialize ser)>(0xA13080);
	static inline auto FPostSerialize = PreyFunction<void(ArkFlowNodeNpcMakeConscious *const _this, IFlowNode::SActivationInfo *__formal)>(0xA13080);
};
