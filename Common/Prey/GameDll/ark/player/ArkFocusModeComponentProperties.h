...
public:
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkMouseSensitivityProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x108D2F0);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkMouseSensitivityProperty* const _this, ArkReflectedObject* const _pObject)>(0x108CDE0);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkMouseRotationSpeedProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x12C1F30);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkMouseRotationSpeedProperty* const _this, ArkReflectedObject* const _pObject)>(0x1444320);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkMouseRotationDampingProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x12C1F50);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkMouseRotationDampingProperty* const _this, ArkReflectedObject* const _pObject)>(0x16C9CA0);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkControllerAbsoluteDeadzoneProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x1443640);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkControllerAbsoluteDeadzoneProperty* const _this, ArkReflectedObject* const _pObject)>(0x12C1F70);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkControllerDeltaDeadzoneProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x12C1F90);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkControllerDeltaDeadzoneProperty* const _this, ArkReflectedObject* const _pObject)>(0x108A0C0);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkControllerInactiveStickDeadzoneProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x16C9CC0);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkControllerInactiveStickDeadzoneProperty* const _this, ArkReflectedObject* const _pObject)>(0x12C1FB0);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkDefaultPostProcessEffectProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x12C1FD0);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkDefaultPostProcessEffectProperty* const _this, ArkReflectedObject* const _pObject)>(0x12C1FF0);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkPsiPostProcessEffectProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x1089B00);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkPsiPostProcessEffectProperty* const _this, ArkReflectedObject* const _pObject)>(0x107B470);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkFocusParticleEffectPathProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x16C9D40);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkFocusParticleEffectPathProperty* const _this, ArkReflectedObject* const _pObject)>(0x1089B40);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkExitFromFocusParticleEffectPathProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x12C2010);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkExitFromFocusParticleEffectPathProperty* const _this, ArkReflectedObject* const _pObject)>(0x1089B80);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkPsiParticleEffectPathProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x12C1A40);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkPsiParticleEffectPathProperty* const _this, ArkReflectedObject* const _pObject)>(0x16C9E20);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkExitFromPsiParticleEffectPathProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x12C1AA0);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkExitFromPsiParticleEffectPathProperty* const _this, ArkReflectedObject* const _pObject)>(0x107B590);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkFocusToPsiParticleEffectPathProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x12C1B00);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkFocusToPsiParticleEffectPathProperty* const _this, ArkReflectedObject* const _pObject)>(0x107B5D0);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkPsiToFocusParticleEffectPathProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x12C1B60);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkPsiToFocusParticleEffectPathProperty* const _this, ArkReflectedObject* const _pObject)>(0x12C1BC0);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkSelectPowerLegendProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x12C1BE0);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkSelectPowerLegendProperty* const _this, ArkReflectedObject* const _pObject)>(0x12C1C90);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkSelectWeaponLegendProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x12C1CB0);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkSelectWeaponLegendProperty* const _this, ArkReflectedObject* const _pObject)>(0x16CA1A0);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkNoPowersAudioTriggerProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x12C1D60);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkNoPowersAudioTriggerProperty* const _this, ArkReflectedObject* const _pObject)>(0x12C1DD0);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkFocusModeComponentProperties::ArkNoPowersStringsProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x12C1DF0);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkFocusModeComponentProperties::ArkNoPowersStringsProperty* const _this, ArkReflectedObject* const _pObject)>(0x12C1E60);
		static inline auto FIsArray = PreyFunction<bool(const ArkFocusModeComponentProperties::ArkNoPowersStringsProperty* const _this)>(0x1A302A0);
		static inline auto FReset = PreyFunction<void(const ArkFocusModeComponentProperties::ArkNoPowersStringsProperty* const _this, ArkReflectedObject* _pObject)>(0x12C1EB0);
	};

	static inline auto s_ArkMouseSensitivityProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkMouseSensitivityProperty>(0x2D497F8);
	float m_MouseSensitivity;
	static inline auto s_ArkMouseRotationSpeedProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkMouseRotationSpeedProperty>(0x2D49818);
	float m_MouseRotationSpeed;
	static inline auto s_ArkMouseRotationDampingProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkMouseRotationDampingProperty>(0x2D49838);
	float m_MouseRotationDamping;
	static inline auto s_ArkControllerAbsoluteDeadzoneProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkControllerAbsoluteDeadzoneProperty>(0x2D49858);
	float m_ControllerAbsoluteDeadzone;
	static inline auto s_ArkControllerDeltaDeadzoneProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkControllerDeltaDeadzoneProperty>(0x2D49878);
	float m_ControllerDeltaDeadzone;
	static inline auto s_ArkControllerInactiveStickDeadzoneProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkControllerInactiveStickDeadzoneProperty>(0x2D49898);
	float m_ControllerInactiveStickDeadzone;
	static inline auto s_ArkDefaultPostProcessEffectProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkDefaultPostProcessEffectProperty>(0x2D498B8);
	uint64_t m_DefaultPostProcessEffect;
	static inline auto s_ArkPsiPostProcessEffectProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkPsiPostProcessEffectProperty>(0x2D498D8);
	uint64_t m_PsiPostProcessEffect;
	static inline auto s_ArkFocusParticleEffectPathProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkFocusParticleEffectPathProperty>(0x2D498F8);
	string m_FocusParticleEffectPath;
	static inline auto s_ArkExitFromFocusParticleEffectPathProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkExitFromFocusParticleEffectPathProperty>(0x2D49918);
	string m_ExitFromFocusParticleEffectPath;
	static inline auto s_ArkPsiParticleEffectPathProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkPsiParticleEffectPathProperty>(0x2D49938);
	string m_PsiParticleEffectPath;
	static inline auto s_ArkExitFromPsiParticleEffectPathProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkExitFromPsiParticleEffectPathProperty>(0x2D49958);
	string m_ExitFromPsiParticleEffectPath;
	static inline auto s_ArkFocusToPsiParticleEffectPathProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkFocusToPsiParticleEffectPathProperty>(0x2D49978);
	string m_FocusToPsiParticleEffectPath;
	static inline auto s_ArkPsiToFocusParticleEffectPathProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkPsiToFocusParticleEffectPathProperty>(0x2D49998);
	string m_PsiToFocusParticleEffectPath;
	static inline auto s_ArkSelectPowerLegendProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkSelectPowerLegendProperty>(0x2D499B8);
	ArkInputLegend m_SelectPowerLegend;
	static inline auto s_ArkSelectWeaponLegendProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkSelectWeaponLegendProperty>(0x2D499D8);
	ArkInputLegend m_SelectWeaponLegend;
	static inline auto s_ArkNoPowersAudioTriggerProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkNoPowersAudioTriggerProperty>(0x2D499F8);
	string m_NoPowersAudioTrigger;
	static inline auto s_ArkNoPowersStringsProperty = PreyGlobal<ArkFocusModeComponentProperties::ArkNoPowersStringsProperty>(0x2D49A18);
	std::vector<string> m_NoPowersStrings;
	...
	static inline auto FCreate = PreyFunction<ArkReflectedObject* ()>(0x12C2C70);
	static inline auto FGetClass = PreyFunction<ArkClass* ()>(0x12C2D30);
	static inline auto FInit = PreyFunction<bool(ArkFocusModeComponentProperties* const _this)>(0x12C2E80);
};
#endif // !MOONCRASH
