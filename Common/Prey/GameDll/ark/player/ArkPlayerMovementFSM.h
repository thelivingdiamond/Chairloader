...
#include <Prey/GameDll/ark/player/ArkPlayerMovementStates.h>
#include <Prey/GameDll/ark/player/arkplayergroundstate.h>
#include <_unknown/ArkPlayerMovementStates__Inactive.h>
...
public:
	...
	static constexpr const uint64_t k_stateCount = 21;
	EArkPlayerMovementStateId m_currentStateId;
	ArkPlayerMovementStates::Ground m_groundState;
	ArkPlayerMovementStates::Death m_deathState;
	ArkPlayerMovementStates::DeathByRecyclerGrenade m_deathByRecyclerGrenadeState;
	...
	ArkPlayerMovementStates::Slide m_slideState;
	ArkPlayerMovementStates::Mimic m_mimicState;
	ArkPlayerMovementStates::Glooed m_glooedState;
	ArkPlayerMovementStates::Disarming m_disarmingState;
	ArkPlayerMovementStates::GravShaftG m_gravShaftGState;
	ArkPlayerMovementStates::GravShaftToG m_gravShaftToGState;
	ArkPlayerMovementStates::GravShaftZeroG m_gravShaftZeroGState;
	ArkPlayerMovementStates::Lift m_liftState;
	ArkPlayerMovementStates::Shift m_shiftState;
	ArkPlayerMovementStates::Inactive m_inactiveState;
	...
	static inline auto FGetCurrentStateOv1 = PreyFunction<ArkPlayerMovementStates::Base& (ArkPlayerMovementFsmBase_template_<void>* const _this)>(0x154F830);
	static inline auto FArkPlayerMovementFsmBase_template_LessvoidGreaterOv1 = PreyFunction<void(ArkPlayerMovementFsmBase_template_<void>* const _this)>(0x1694510);
	static inline auto FBitNotArkPlayerMovementFsmBase_template_LessvoidGreater = PreyFunction<void(ArkPlayerMovementFsmBase_template_<void>* const _this)>(0x1670160);
	static inline auto FExitCurrentState = PreyFunction<void(ArkPlayerMovementFsmBase_template_<void>* const _this)>(0x125C330);
};
...
public:
	...
	boost::optional<ClimbPosInfo> m_climbPosInfo;
	ArkPlayerMovementFSM::StagingInfo m_stagingInfo;
	string m_deathPoseIdle;
	string m_deathPoseIdleOneHand;
	string m_deathPoseIdleTwoHands;
	string m_deathPoseIdleCarry;
	ArkPlayerMovementFSM::EArkFlyMode m_flyMode;
	float m_carrySpeedScale;
	float m_climbHorizontalFromEdgeProbeDistance;
	float m_climbVerticalReachDistance;
	...
	float m_airControl;
	bool m_bInputSneak;
	bool m_bInputGlidePressed;
	bool m_bDodgeRequested;
	bool m_bInputJumpPressed;
	bool m_bJumpRequested;
	bool m_bMovementRestricted;
	float m_verticalSpeed;
	float m_jumpRequestedTime;
	ArkTimeRemaining m_thrusterForceDuration;
	float m_minGlooedMoveMultiplier;
	float m_maxGlooedMoveMultiplier;

	ArkPlayerMovementFSM();
	void LoadConfig(const XmlNodeRef& _root) { FLoadConfig(this, _root); }
	void Update(const float _frameTime) { FUpdate(this, _frameTime); }
	Vec2 GetMovementInput() const { alignas(Vec2) std::byte _return_buf_[sizeof(Vec2)]; return *FGetMovementInput(this, reinterpret_cast<Vec2*>(_return_buf_)); }
	bool FireDodgeThrusters(Vec3& _velocity) { return FFireDodgeThrusters(this, _velocity); }
	bool KillThrustersAccel(Vec3& _velocity, bool _bForce) { return FKillThrustersAccel(this, _velocity, _bForce); }
	void SetInputJumpPressed(bool _bPressed) { FSetInputJumpPressed(this, _bPressed); }
	bool IsInputJumpPressed() const { return FIsInputJumpPressed(this); }
	bool IsInputGlidePressed() const { return FIsInputGlidePressed(this); }
	void SetDodgeRequested(bool _bRequested) { FSetDodgeRequested(this, _bRequested); }
	void SetInputGlidePressed(bool _bPressed) { FSetInputGlidePressed(this, _bPressed); }
	bool IsJumpRequested() const { return FIsJumpRequested(this); }
	float GetTimeOfJumpRequest() const { return FGetTimeOfJumpRequest(this); }
	void SetJumpRequested(bool _requested) { FSetJumpRequested(this, _requested); }
	void SetInputSneak(bool _bPressed) { FSetInputSneak(this, _bPressed); }
	...
	void LimitRotation(Quat& _rotation) const { FLimitRotation(this, _rotation); }
	bool IsInZeroG() const { return FIsInZeroG(this); }
	bool IsInLowG() const { return FIsInLowG(this); }
	bool CheckZeroG() { return FCheckZeroG(this); }
	bool IsSprinting() const { return FIsSprinting(this); }
	float GetViewHeightInterpolationSpeed() const { return FGetViewHeightInterpolationSpeed(this); }
	void ProcessRotation(Quat& _rotation, Ang3 _inputRotation) { FProcessRotation(this, _rotation, _inputRotation); }
	...
	static int GetNumPointsInZeroG() { return FGetNumPointsInZeroG(); }
	static Vec3 GetWindVelocity() { return FGetWindVelocity(); }
	static bool TrySetStance(EStance _stance, bool _bForce) { return FTrySetStance(_stance, _bForce); }
	float CalculateGlooedMovementMultiplier(const float _glooedRatio) const { return FCalculateGlooedMovementMultiplier(this, _glooedRatio); }
	const char* GetDeathPose() const { return FGetDeathPose(this); }
	boost::optional<ClimbPosInfo> GetClimbPosInfo_Internal() const { alignas(boost::optional<ClimbPosInfo>) std::byte _return_buf_[sizeof(boost::optional<ClimbPosInfo>)]; return *FGetClimbPosInfo_Internal(this, reinterpret_cast<boost::optional<ClimbPosInfo>*>(_return_buf_)); }
	Ang3 GetCameraRotationInfluenceFromState(float _frameTime) { alignas(Ang3) std::byte _return_buf_[sizeof(Ang3)]; return *FGetCameraRotationInfluenceFromState(this, reinterpret_cast<Ang3*>(_return_buf_), _frameTime); }
	...
	void SetFlyMode(const int _arg0_);
	void SetFlyMode(const ArkPlayerMovementFSM::EArkFlyMode _arg0_);
	bool IsInFlyMode() const;
	float GetFPIKPitchWeight() const;
	boost::optional<ClimbPosInfo> GetClimbPosInfo() const;
	float GetVerticalSpeed() const;
	float GetAirControl() const;
	const char* GetStateDeathPose() const;
#endif

	static inline auto FArkPlayerMovementFSMOv2 = PreyFunction<void(ArkPlayerMovementFSM* const _this)>(0x1694950);
	static inline auto FLoadConfig = PreyFunction<void(ArkPlayerMovementFSM* const _this, const XmlNodeRef& _root)>(0x16974E0);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMovementFSM* const _this, const float _frameTime)>(0x16989E0);
	static inline auto FGetMovementInput = PreyFunction<Vec2*(const ArkPlayerMovementFSM* const _this, Vec2* _return_value_)>(0x16963F0);
	static inline auto FFireDodgeThrusters = PreyFunction<bool(ArkPlayerMovementFSM* const _this, Vec3& _velocity)>(0x1695AB0);
	static inline auto FKillThrustersAccel = PreyFunction<bool(ArkPlayerMovementFSM* const _this, Vec3& _velocity, bool _bForce)>(0x16970B0);
	static inline auto FSetInputJumpPressed = PreyFunction<void(ArkPlayerMovementFSM* const _this, bool _bPressed)>(0x1698600);
	static inline auto FIsInputJumpPressed = PreyFunction<bool(const ArkPlayerMovementFSM* const _this)>(0x1697000);
	static inline auto FIsInputGlidePressed = PreyFunction<bool(const ArkPlayerMovementFSM* const _this)>(0x1696FF0);
	static inline auto FSetDodgeRequested = PreyFunction<void(ArkPlayerMovementFSM* const _this, bool _bRequested)>(0x16985E0);
	static inline auto FSetInputGlidePressed = PreyFunction<void(ArkPlayerMovementFSM* const _this, bool _bPressed)>(0x16985F0);
	static inline auto FIsJumpRequested = PreyFunction<bool(const ArkPlayerMovementFSM* const _this)>(0x1697010);
	static inline auto FGetTimeOfJumpRequest = PreyFunction<float(const ArkPlayerMovementFSM* const _this)>(0x16966F0);
	static inline auto FSetJumpRequested = PreyFunction<void(ArkPlayerMovementFSM* const _this, bool _requested)>(0x1698690);
	static inline auto FSetInputSneak = PreyFunction<void(ArkPlayerMovementFSM* const _this, bool _bPressed)>(0x1698610);
	static inline auto FIsInputSneakPressed = PreyFunction<bool(const ArkPlayerMovementFSM* const _this)>(0x148FA40);
	static inline auto FGetCameraRotationInfluence = PreyFunction<Ang3*(ArkPlayerMovementFSM* const _this, Ang3* _return_value_, float _frameTime)>(0x1695BE0);
	static inline auto FGetWorldMovement = PreyFunction<Vec2*(const ArkPlayerMovementFSM* const _this, Vec2* _return_value_)>(0x1696A20);
	static inline auto FOnFlyModePressed = PreyFunction<void(ArkPlayerMovementFSM* const _this)>(0x1697F50);
	static inline auto FLimitRotation = PreyFunction<void(const ArkPlayerMovementFSM* const _this, Quat& _rotation)>(0x1697260);
	static inline auto FIsInZeroG = PreyFunction<bool(const ArkPlayerMovementFSM* const _this)>(0x1696E10);
	static inline auto FIsInLowG = PreyFunction<bool(const ArkPlayerMovementFSM* const _this)>(0x1696B30);
	static inline auto FCheckZeroG = PreyFunction<bool(ArkPlayerMovementFSM* const _this)>(0x1695870);
	static inline auto FIsSprinting = PreyFunction<bool(const ArkPlayerMovementFSM* const _this)>(0x1697020);
	static inline auto FGetViewHeightInterpolationSpeed = PreyFunction<float(const ArkPlayerMovementFSM* const _this)>(0x1696700);
	static inline auto FProcessRotation = PreyFunction<void(ArkPlayerMovementFSM* const _this, Quat& _rotation, Ang3 _inputRotation)>(0x1698190);
	static inline auto FRestrictMovement = PreyFunction<void(ArkPlayerMovementFSM* const _this, bool _bRestrict)>(0x1698460);
	static inline auto FSerialize = PreyFunction<void(ArkPlayerMovementFSM* const _this, TSerialize _ser)>(0x1698470);
	static inline auto FPostSerialize = PreyFunction<void(ArkPlayerMovementFSM* const _this)>(0x1698050);
	static inline auto FSetStagingInfo = PreyFunction<void(ArkPlayerMovementFSM* const _this, Ang3 _rotation, float _viewLimitYaw, float _viewLimitPitch, bool _bLockPlayer, int _stance)>(0x16987C0);
	static inline auto FGetMaxMovementSpeed = PreyFunction<float(const ArkPlayerMovementFSM* const _this, const EStance _stance)>(0x1696350);
	static inline auto FGetCarrySpeedScale = PreyFunction<float(const ArkPlayerMovementFSM* const _this)>(0x1695EB0);
	static inline auto FSetCarrySpeedScale = PreyFunction<void(ArkPlayerMovementFSM* const _this, const float _scale)>(0x16985D0);
	static inline auto FProcessClimb = PreyFunction<bool(ArkPlayerMovementFSM* const _this)>(0x1698070);
	static inline auto FCanFit = PreyFunction<bool(const Vec3& _pos, const EStance _stance, const Vec3& _sweepDir, const unsigned _ignore)>(0x1695620);
	static inline auto FSetMovementParameters = PreyFunction<void(ArkPlayerMovementFSM* const _this, ArkPlayerMovementStates::Ground::ArkGroundColliderParameters _groundColliderParams, ArkPlayerMovementStates::Ground::ArkGroundColliderParameters _gooProjectileColliderParams)>(0x1698770);
	static inline auto FSetRequestedStance = PreyFunction<void(ArkPlayerMovementFSM* const _this, EStance _stance)>(0x16987A0);
	static inline auto FGetLeanInput = PreyFunction<float(const ArkPlayerMovementFSM* const _this)>(0x16962C0);
	static inline auto FGetNumPointsInZeroG = PreyFunction<int()>(0x1696510);
	static inline auto FGetWindVelocity = PreyFunction<Vec3()>(0x16967D0);
	static inline auto FTrySetStance = PreyFunction<bool(EStance _stance, bool _bForce)>(0x1698870);
	static inline auto FCalculateGlooedMovementMultiplier = PreyFunction<float(const ArkPlayerMovementFSM* const _this, const float _glooedRatio)>(0x16955E0);
	static inline auto FGetDeathPose = PreyFunction<const char* (const ArkPlayerMovementFSM* const _this)>(0x1696160);
	static inline auto FGetClimbPosInfo_Internal = PreyFunction<boost::optional<ClimbPosInfo>*(const ArkPlayerMovementFSM* const _this, boost::optional<ClimbPosInfo>* _return_value_)>(0x1695EC0);
	static inline auto FGetCameraRotationInfluenceFromState = PreyFunction<Ang3*(ArkPlayerMovementFSM* const _this, Ang3* _return_value_, float _frameTime)>(0x1695DE0);
};
#endif // !MOONCRASH
