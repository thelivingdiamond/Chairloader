...
public:
	...
	int GetLevelFromDamage(const float _damage) const { return FGetLevelFromDamage(this, _damage); }
	...
	void DisablePostEffect(bool _arg0_);
	void SetAnimationTag();
	const char* GetCurrentPlayerMaterial() const;
#endif

	static inline auto FArkTraumaBaseOv1 = PreyFunction<void(ArkTraumaBase* const _this, uint64_t _id, EArkPlayerStatus _status)>(0x16D3030);
	static inline auto FBitNotArkTraumaBase = PreyFunction<void(ArkTraumaBase* const _this)>(0x13C18F0);
	static inline auto FSerialize = PreyFunction<void(ArkTraumaBase* const _this, TSerialize _ser)>(0x16D49C0);
	static inline auto FPostSerialize = PreyFunction<void(ArkTraumaBase* const _this)>(0x16D4330);
	static inline auto FUpdate = PreyFunction<void(ArkTraumaBase* const _this, float _frameTime)>(0x16D4E20);
	static inline auto FAccumulate = PreyFunction<void(ArkTraumaBase* const _this, float _damage)>(0x16D33A0);
	static inline auto FCanActivate = PreyFunction<bool(const ArkTraumaBase* const _this, int _level)>(0x16D3B40);
	static inline auto FActivate = PreyFunction<void(ArkTraumaBase* const _this, int _level)>(0x16D3570);
	static inline auto FForceRemove = PreyFunction<void(ArkTraumaBase* const _this, bool _bImmediate)>(0x16D3D70);
	static inline auto FReduceAccumulation = PreyFunction<void(ArkTraumaBase* const _this, float _amount, bool _bImmediate)>(0x16D4450);
	static inline auto FSuspend = PreyFunction<void(ArkTraumaBase* const _this)>(0x16D4C40);
	static inline auto FResume = PreyFunction<void(ArkTraumaBase* const _this)>(0x16D47B0);
	static inline auto FIsSuspended = PreyFunction<bool(const ArkTraumaBase* const _this)>(0x1188BE0);
	static inline auto FReset = PreyFunction<void(ArkTraumaBase* const _this)>(0x16D4770);
	static inline auto FGetPercent = PreyFunction<float(const ArkTraumaBase* const _this)>(0x16D3E80);
	static inline auto FIsHarmful = PreyFunction<bool(const ArkTraumaBase* const _this)>(0x1A302A0);
	static inline auto FIsMedical = PreyFunction<bool(const ArkTraumaBase* const _this)>(0x1A302A0);
	static inline auto FShowDamageIndicator = PreyFunction<bool(const ArkTraumaBase* const _this)>(0x13B0900);
	static inline auto FPlayPostEffect = PreyFunction<void(const ArkTraumaBase* const _this, float _param, bool _bFromSerialize)>(0x16D4220);
	static inline auto FGetMinPostEffectParamValue = PreyFunction<float(const ArkTraumaBase* const _this)>(0x13C1A80);
	static inline auto FGetMaxDamageThreshold = PreyFunction<float(const ArkTraumaBase* const _this)>(0x16D3E40);
	static inline auto FGetLevelFromDamage = PreyFunction<int(const ArkTraumaBase* const _this, const float _damage)>(0x16D3DE0);
	static inline auto FGetThresholdForLevel = PreyFunction<float(const ArkTraumaBase* const _this, const int _level)>(0x16D3ED0);
	static inline auto FIsEnabled = PreyFunction<bool(const ArkTraumaBase* const _this)>(0x16D3F00);
	static inline auto FCanStack = PreyFunction<bool(const ArkTraumaBase* const _this, float _amount)>(0x3BA5C0);
	static inline auto FReevaluatePhase = PreyFunction<void(ArkTraumaBase* const _this, bool _bImmediate)>(0x16D44D0);
	static inline auto FRemovePhase = PreyFunction<void(ArkTraumaBase* const _this, int _phase)>(0x16D4610);
	static inline auto FCleanUp = PreyFunction<void(ArkTraumaBase* const _this, bool _bSilent)>(0x16D3B80);
	static inline auto FApplyTraumaEffects = PreyFunction<void(ArkTraumaBase* const _this, bool _bFromSerialize)>(0x16D39A0);
	static inline auto FUpdateVisuals = PreyFunction<void(ArkTraumaBase* const _this, bool _bImmediate, bool _bFromSerialize)>(0x16D5140);
	static inline auto FRemoveHudIcon = PreyFunction<void(ArkTraumaBase* const _this, int _phase)>(0x16D45C0);
	static inline auto FUpdateHudIcon = PreyFunction<void(ArkTraumaBase* const _this)>(0x16D4FB0);
	static inline auto FLoadConfig = PreyFunction<void(ArkTraumaBase* const _this)>(0x16D3F40);
	static inline auto FApplyStatModifiers = PreyFunction<void(ArkTraumaBase* const _this)>(0x16D3860);
	static inline auto FResumeStatModifiers = PreyFunction<void(ArkTraumaBase* const _this)>(0x16D4870);
	static inline auto FApplySignalModifiers = PreyFunction<void(ArkTraumaBase* const _this)>(0x16D37E0);
	static inline auto FStack = PreyFunction<void(ArkTraumaBase* const _this)>(0x16D4C30);
	static inline auto FRepeatEffect = PreyFunction<void(ArkTraumaBase* const _this)>(0x16D4710);
};
#endif // !MOONCRASH
