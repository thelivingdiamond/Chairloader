...
// Header: Exact
// Prey/GameDll/ark/player/trauma/ArkTraumaBase.h
class ArkTraumaBase // Id=80138E8 Size=296
{
public:
	const uint64_t m_id;
	...
	CCryName m_activationChanceStat;
	...
	ArkTrauma const &GetDesc() const;
	float GetCurrentAmount() const;
	int GetCurrentLevel() const;
	bool IsActive() const;
	void DisablePostEffect(bool arg0);
	...
	static inline auto FCanActivate = PreyFunction<bool(ArkTraumaBase const *const _this, int _level)>(0x15AFA60);
	...
	static inline auto FIsSuspended = PreyFunction<bool(ArkTraumaBase const *const _this)>(0x1142110);
	static inline auto FReset = PreyFunction<void(ArkTraumaBase *const _this)>(0x15B03D0);
	static inline auto FGetPercent = PreyFunction<float(ArkTraumaBase const *const _this)>(0x15AFC10);
	static inline auto FIsHarmful = PreyFunction<bool(ArkTraumaBase const *const _this)>(0x1B933B0);
	static inline auto FIsMedical = PreyFunction<bool(ArkTraumaBase const *const _this)>(0x1B933B0);
	static inline auto FShowDamageIndicator = PreyFunction<bool(ArkTraumaBase const *const _this)>(0xDD23F0);
	static inline auto FPlayPostEffect = PreyFunction<void(ArkTraumaBase const *const _this, float _param, bool _bFromSerialize)>(0x15AFFB0);
	static inline auto FGetMinPostEffectParamValue = PreyFunction<float(ArkTraumaBase const *const _this)>(0x1734A90);
	static inline auto FIsEnabled = PreyFunction<bool(ArkTraumaBase const *const _this)>(0x15AFC80);
	static inline auto FCanStack = PreyFunction<bool(ArkTraumaBase const *const _this, float _amount)>(0x3A0320);
