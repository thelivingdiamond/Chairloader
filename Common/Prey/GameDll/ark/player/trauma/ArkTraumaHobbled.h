...
public:
	...
	static inline auto FArkTraumaHobbledOv1 = PreyFunction<void(ArkTraumaHobbled* const _this)>(0x13C1E00);
	static inline auto FActivate = PreyFunction<void(ArkTraumaHobbled* const _this, int _level)>(0x13C1F10);
	static inline auto FUpdateVisuals = PreyFunction<void(ArkTraumaHobbled* const _this, bool _bImmediate, bool _bFromSerialize)>(0x13C20C0);
};
#endif // !MOONCRASH
