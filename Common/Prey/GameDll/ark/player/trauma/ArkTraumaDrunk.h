...
public:
	...
	static inline auto FArkTraumaDrunkOv1 = PreyFunction<void(ArkTraumaDrunk* const _this)>(0x13C1880);
	static inline auto FActivate = PreyFunction<void(ArkTraumaDrunk* const _this, int _level)>(0x13C1A30);
	static inline auto FOnStatChange = PreyFunction<void(IArkStatsListener* const _this, const unsigned _ownerId, const CCryName& _stat64i32, const float _previousValue, const float _newValue)>(0x13C1A90);
};
#endif // !MOONCRASH
