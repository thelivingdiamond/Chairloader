...
public:
	...
	static inline auto FGetConfiguration = PreyFunction<void(ArkFlowNodeFlashlight* const _this, SFlowNodeConfig& _config)>(0x1682070);
	static inline auto FProcessEvent = PreyFunction<void(ArkFlowNodeFlashlight* const _this, IFlowNode::EFlowEvent _event, IFlowNode::SActivationInfo* _pActInfo)>(0x1682370);
	static inline auto FGetMemoryUsage = PreyFunction<void(const ArkFlowNodeFlashlight* const _this, ICrySizer* _pS)>(0x455F00);
};
...
public:
	...
	void PostSerialize() { FPostSerialize(this); }
	virtual void OnStatChange(const unsigned _ownerId, const CCryName& _stat64i32, const float _previousValue, const float _newValue);
	void RefillCharge() { FRefillCharge(this); }
	virtual void LightVisibilityUpdated(bool _bVisible);
	float GetTargetDimRangeDiffuse() const { return FGetTargetDimRangeDiffuse(this); }
	...
	static inline auto FArkPlayerFlashlightOv1 = PreyFunction<void(ArkPlayerFlashlight* const _this)>(0x1682FB0);
	static inline auto FBitNotArkPlayerFlashlight = PreyFunction<void(ArkPlayerFlashlight* const _this)>(0x16830B0);
	static inline auto FReset = PreyFunction<void(ArkPlayerFlashlight* const _this)>(0x1683880);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerFlashlight* const _this, const float _frameTime)>(0x1683B30);
	static inline auto FLoadConfig = PreyFunction<void(ArkPlayerFlashlight* const _this, const XmlNodeRef& _node)>(0x16833B0);
	static inline auto FToggle = PreyFunction<void(ArkPlayerFlashlight* const _this)>(0x1683AE0);
	static inline auto FIsPowered = PreyFunction<bool(const ArkPlayerFlashlight* const _this)>(0x1683250);
	static inline auto FSerialize = PreyFunction<void(ArkPlayerFlashlight* const _this, TSerialize& _ser)>(0x1683970);
	static inline auto FPostSerialize = PreyFunction<void(ArkPlayerFlashlight* const _this)>(0x16837A0);
	static inline auto FOnStatChange = PreyFunction<void(ArkPlayerFlashlight* const _this, const unsigned _ownerId, const CCryName& _stat64i32, const float _previousValue, const float _newValue)>(0x1683740);
	static inline auto FRefillCharge = PreyFunction<void(ArkPlayerFlashlight* const _this)>(0x1683840);
	static inline auto FLightVisibilityUpdated = PreyFunction<void(IArkPlayerLightOwner* const _this, bool _bVisible)>(0x1683270);
	static inline auto FGetTargetDimRangeDiffuse = PreyFunction<float(const ArkPlayerFlashlight* const _this)>(0x1683150);
};
#endif // !MOONCRASH
