...
public:
	...
	enum class ButtonMashMode
	{
		mimic_grab = 0,
		poltergeist_disarm = 1,
		player_glooed = 2,
		tentacle_grab = 3,
		any = 4,
		_count = 5,
	...
	static inline auto s_handleGenerator = PreyGlobal<int>(0x23EEBA0);
	std::vector<ArkPlayerInput::ModeAndHandle> m_modeStack;
	TActionHandler<ArkPlayerInput> m_actionHandler;
	Ang3 m_deltaRotation;
	Ang3 m_gamePadRotation;
	...
	int m_mashesRemaining;
	int m_mimicGrabMashesRequired;
	int m_poltergeistDisarmMashesRequired;
	int m_playerGlooedMashesRequired;
	int m_tentacleGrabMashesRequired;
	ArkPlayerInput::CinematicMode m_cinematicMode;
	ArkPlayerInput::ButtonMashMode m_buttonMashMode;
	float m_sprintCameraRotationRateScale;
	float m_zoomCameraRotationRateScale;
	float m_sprintCancelForwardThreshold;
	float m_sprintCancelBackwardThreshold;
	...
	float m_accelerationMaxTurnSpeed;
	ArkPlayerInput::Mode m_disabledMode;
	ArkSimpleTimer m_buttonMashCooldown;
	...
	bool OnActionSneak(unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value) { return FOnActionSneak(this, _entityId, _actionId, _activationMode, _value); }
	bool OnActionSprint(unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value) { return FOnActionSprint(this, _entityId, _actionId, _activationMode, _value); }
	bool OnActionGlideDodge(unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value) { return FOnActionGlideDodge(this, _entityId, _actionId, _activationMode, _value); }
	bool OnActionGamePadMoveX(unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value) { return FOnActionGamePadMoveX(this, _entityId, _actionId, _activationMode, _value); }
	bool OnActionGamePadMoveY(unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value) { return FOnActionGamePadMoveY(this, _entityId, _actionId, _activationMode, _value); }
	bool OnActionGamePadMoveReticleX(unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value) { return FOnActionGamePadMoveReticleX(this, _entityId, _actionId, _activationMode, _value); }
	bool OnActionGamePadMoveReticleY(unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value) { return FOnActionGamePadMoveReticleY(this, _entityId, _actionId, _activationMode, _value); }
	...
	bool IsZeroGBraking() const;
	Vec2 GetReticleMovement() const;
	void EnterButtonMashSequence(const ArkPlayerInput::ButtonMashMode _arg0_);
	bool IsButtonMashingOnCooldown() const;
	bool IsMashesThresholdReached() const;
	bool IsInButtonMash() const;
	void ExitButtonMashSequence();
	void InhibitSprint(const bool _arg0_);
	void InhibitJump(const bool _arg0_);
	void InhibitRotation(const bool _arg0_);
	ArkPlayerInput::CinematicMode GetCinematicMode() const;
	...
	static inline auto FArkPlayerInputOv1 = PreyFunction<void(ArkPlayerInput* const _this, ArkPlayer& _player)>(0x1686230);
	static inline auto FBitNotArkPlayerInput = PreyFunction<void(ArkPlayerInput* const _this)>(0x16874B0);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerInput* const _this, const float _frameTime)>(0x168A470);
	static inline auto FOnActionMoveForward = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x16895C0);
	static inline auto FOnActionMoveBack = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689560);
	static inline auto FOnActionMoveLeft = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689620);
	static inline auto FOnActionMoveRight = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689680);
	static inline auto FOnActionRotateYaw = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x16898E0);
	static inline auto FOnActionRotatePitch = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689890);
	static inline auto FOnActionJump = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688FA0);
	static inline auto FOnActionSneak = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689910);
	static inline auto FOnActionSprint = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689A00);
	static inline auto FOnActionGlideDodge = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688EF0);
	static inline auto FOnActionGamePadMoveX = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688D90);
	static inline auto FOnActionGamePadMoveY = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688DF0);
	static inline auto FOnActionGamePadMoveReticleX = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688D60);
	static inline auto FOnActionGamePadMoveReticleY = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688D70);
	static inline auto FOnActionGamePadRotateYaw = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688EC0);
	static inline auto FOnActionGamePadRotatePitch = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688E80);
	static inline auto FOnActionUse = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689E40);
	static inline auto FOnActionLoot = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x16893D0);
	static inline auto FOnActionSpecialUse = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x16899A0);
	static inline auto FOnActionViewTutorial = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x168A070);
	static inline auto FOnActionLeanLeft = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689350);
	static inline auto FOnActionLeanRight = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689390);
	static inline auto FOnActionToggleScope = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689D10);
	static inline auto FOnActionToggleInventory = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689C10);
	static inline auto FOnActionToggleObjectives = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _rActionId, int _activationMode, float _fValue)>(0x1689C90);
	static inline auto FOnActionToggleAbilities = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _rActionId, int _activationMode, float _fValue)>(0x1689B20);
	static inline auto FOnActionTogglePDA = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _rActionId, int _activationMode, float _fValue)>(0x1689CD0);
	static inline auto FOnActionToggleMap = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689C50);
	static inline auto FOnActionToggleData = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689B90);
	static inline auto FOnActionToggleStatus = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689E00);
	static inline auto FOnActionAttackPrimary = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688AA0);
	static inline auto FOnActionReload = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x16897A0);
	static inline auto FOnActionFlyMode = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688D30);
	static inline auto FOnActionWorldUIExamine = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x168A0A0);
	static inline auto FOnActionToggleArkProfile = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689B60);
	static inline auto FOnActionTogglePDrawHelpers = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x13B0900);
	static inline auto FOnActionIncreaseTimeDilation = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688F80);
	static inline auto FOnActionDecreaseTimeDilation = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688C40);
	static inline auto FOnActionNormalTimeDilation = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x16896E0);
	static inline auto FOnActionGamePadRecenterWorldUI = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688E50);
	static inline auto FOnActionExaminationBack = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688CC0);
	static inline auto FOnActionToggleFlashlight = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689BD0);
	static inline auto FOnActionInstakill = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x13B0900);
	static inline auto FOnActionThirdPerson = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689A80);
	static inline auto FOnActionPlayAudioLog = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689750);
	static inline auto FOnActionKeypad = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1689020);
	static inline auto FOnActionEquipLastWeapon = PreyFunction<bool(ArkPlayerInput* const _this, unsigned _entityId, const CCryName& _actionId, int _activationMode, float _value)>(0x1688C60);
	static inline auto FGetMovement = PreyFunction<Vec2*(const ArkPlayerInput* const _this, Vec2* _return_value_)>(0x1688310);
	static inline auto FClearMovement = PreyFunction<void(ArkPlayerInput* const _this)>(0x1687D80);
	static inline auto FGetRotation = PreyFunction<Ang3*(const ArkPlayerInput* const _this, Ang3* _return_value_, const float _frameTime)>(0x1688410);
	static inline auto FHandleGamepadCameraAcceleration = PreyFunction<void(ArkPlayerInput* const _this, float _frameTime)>(0x1688550);
	static inline auto FIsRotating = PreyFunction<bool(const ArkPlayerInput* const _this)>(0x16886C0);
	static inline auto FInit = PreyFunction<void(ArkPlayerInput* const _this, IGameObject& _gameObject)>(0x16886A0);
	static inline auto FLoadConfig = PreyFunction<void(ArkPlayerInput* const _this, const XmlNodeRef& _node)>(0x1688730);
	static inline auto FProcessSprintInput = PreyFunction<void(ArkPlayerInput* const _this, const bool _bSprint)>(0x168A1C0);
	static inline auto FReset = PreyFunction<void(ArkPlayerInput* const _this)>(0x168A210);
	static inline auto FEnableInputMode = PreyFunction<int(ArkPlayerInput* const _this, const ArkPlayerInput::Mode _mode)>(0x1688070);
	static inline auto FDisableInputMode = PreyFunction<void(ArkPlayerInput* const _this, const int _handle)>(0x1687D90);
	static inline auto FEnablePlayerInputMode = PreyFunction<void(ArkPlayerInput* const _this, bool _bEnable)>(0x16880F0);
	static inline auto FDoesCurrentInputModeSupportWeapon = PreyFunction<bool(const ArkPlayerInput* const _this)>(0x1687E50);
	static inline auto FSetCinematicMode = PreyFunction<void(ArkPlayerInput* const _this, const ArkPlayerInput::CinematicMode _cinematicMode)>(0x168A330);
	static inline auto FEnableActionMapForMode = PreyFunction<void(ArkPlayerInput* const _this, const ArkPlayerInput::Mode _mode, const bool _bEnable)>(0x1687E60);
	static inline auto FOnActionMapEvent = PreyFunction<void(IActionMapEventListener* const _this, const SActionMapEvent& _event)>(0x1689400);
	static inline auto FSetTimeScale = PreyFunction<void(ArkPlayerInput* const _this, const float _value)>(0x168A400);
	static inline auto FOnAction = PreyFunction<void(ArkPlayerInput* const _this, const CCryName& _action, int _activationMode, float _value)>(0x1688930);
	static inline auto FProcessLeanInput = PreyFunction<void(ArkPlayerInput* const _this)>(0x168A150);
};
#endif // !MOONCRASH
