...
// ArkAimAssistComponent
// Header:  Prey/GameDll/ark/player/ArkAimAssistComponent.h
class ArkAimAssistComponent : public IEntitySystemSink, public IEntityEventListener
{ // Size=240 (0xF0)
public:
	// ArkAimAssistComponent::ArkAimAssistTarget
	// Header:  Prey/GameDll/ark/player/ArkAimAssistComponent.h
	...
	void AddPotentialTarget(IEntity& _entity) { FAddPotentialTarget(this, _entity); }

#if 0
	static void RegisterCVars();
	boost::optional<Vec3_tpl<float> > GetAimPos() const;
	std::pair<const IEntity*, bool> GetCurrentTarget() const;
	bool IsAimAssistEntity(const IEntity& _arg0_) const;
	void RescanPotentialTargets();
	void RemovePotentialTarget(IEntity& _arg0_);
#endif

	static inline auto FArkAimAssistComponentOv1 = PreyFunction<void(ArkAimAssistComponent* const _this)>(0x135B4C0);
	static inline auto FUpdate = PreyFunction<void(ArkAimAssistComponent* const _this)>(0x135DC10);
	static inline auto FLoadConfig = PreyFunction<void(ArkAimAssistComponent* const _this, const XmlNodeRef& _node)>(0x135D3C0);
	static inline auto FApply = PreyFunction<void(const ArkAimAssistComponent* const _this, Ang3& _gamepadRotation)>(0x135C270);
	static inline auto FReset = PreyFunction<void(ArkAimAssistComponent* const _this)>(0x135D740);
	static inline auto FPostSerialize = PreyFunction<void(ArkAimAssistComponent* const _this)>(0x135D5D0);
	static inline auto FGetReticlePosAtTargetDistance = PreyFunction<boost::optional<Vec3_tpl<float> >*(const ArkAimAssistComponent* const _this, boost::optional<Vec3_tpl<float> >* _return_value_)>(0x135D2C0);
	static inline auto FGetBoneAimPos = PreyFunction<boost::optional<Vec3_tpl<float> >*(const ArkAimAssistComponent* const _this, boost::optional<Vec3_tpl<float> >* _return_value_)>(0x135D090);
	static inline auto FOnBeforeSpawn = PreyFunction<bool(ArkAimAssistComponent* const _this, SEntitySpawnParams& _params)>(0x1A302A0);
	static inline auto FOnSpawn = PreyFunction<void(ArkAimAssistComponent* const _this, IEntity* _pEntity, SEntitySpawnParams& _params)>(0x135D5C0);
	static inline auto FOnRemove = PreyFunction<bool(ArkAimAssistComponent* const _this, IEntity* _pEntity)>(0x1A302A0);
	static inline auto FOnReused = PreyFunction<void(ArkAimAssistComponent* const _this, IEntity* _pEntity, SEntitySpawnParams& _params)>(0x1333E90);
	static inline auto FOnEvent = PreyFunction<void(ArkAimAssistComponent* const _this, IEntity* _pEntity, SEntityEvent& _event)>(0x1333E90);
	static inline auto FOnEntityEvent = PreyFunction<void(IEntityEventListener* const _this, IEntity* _pEntity, SEntityEvent& _event)>(0x135D4C0);
	static inline auto FClearPotentialTargets = PreyFunction<void(ArkAimAssistComponent* const _this)>(0x135CA30);
	static inline auto FAddPotentialTarget = PreyFunction<void(ArkAimAssistComponent* const _this, IEntity& _entity)>(0x135C070);
};
...
{ // Size=56 (0x38)
	...
	static inline auto FDraw = PreyFunction<void(const ArkAimEntityDebug* const _this, const Matrix44& _unprojMtx, float _projRatio)>(0x135CAF0);
};
#endif // !MOONCRASH
