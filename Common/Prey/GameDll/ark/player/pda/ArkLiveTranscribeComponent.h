...
public:
	...
	static inline auto FArkLiveTranscribeComponentOv1 = PreyFunction<void(ArkLiveTranscribeComponent* const _this)>(0x130CDA0);
	...
	static inline auto FLoadConfig = PreyFunction<void(ArkLiveTranscribeComponent* const _this, const XmlNodeRef& _config)>(0x130D1A0);
