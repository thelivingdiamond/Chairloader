...
// Header test file for path Prey/GameDll/ark/player/
#include "ArkAimAssistComponent.h"
static_assert(sizeof(ArkAimAssistComponent) == 240);
static_assert(sizeof(ArkAimAssistComponent::ArkAimAssistTarget) == 64);
static_assert(sizeof(ArkAimEntityDebug) == 56);
...
static_assert(sizeof(ArkAudioSwitch) == 4);
static_assert(sizeof(TArkAudioSwitch<enum ArkTraumaBleeding::EAudioBleed>) == 12);
static_assert(sizeof(TArkAudioSwitch<enum ArkTraumaHobbled::EAudioHobbled>) == 12);
static_assert(sizeof(TArkAudioSwitch<enum EPlayerSex>) == 12);

#include "ArkAudioSwitchState.h"
static_assert(sizeof(ArkAudioSwitchState) == 4);

#include "ArkBountyComponent.h"
static_assert(sizeof(ArkBountyComponent) == 24);

#include "ArkChecklistComponent.h"
static_assert(sizeof(ArkChecklistComponent) == 152);
...
#include "ArkObjectiveComponent.h"
static_assert(sizeof(ArkObjective) == 128);
static_assert(sizeof(ArkObjectiveComponent) == 368);
static_assert(sizeof(ArkObjectiveTask) == 80);
static_assert(sizeof(ArkObjectiveUtils::CArkObjectiveDescriptionData) == 24);
static_assert(sizeof(ArkPathMapNode) == 16);
static_assert(sizeof(CArkObjectiveClue) == 16);
...
#include "ArkPetSkin.h"
static_assert(sizeof(ArkPetSkin) == 72);
static_assert(sizeof(ArkPetSkin::ArkAbilityProperty) == 32);
static_assert(sizeof(ArkPetSkin::ArkDescriptionProperty) == 32);
static_assert(sizeof(ArkPetSkin::ArkIDProperty) == 32);
static_assert(sizeof(ArkPetSkin::ArkIconProperty) == 32);
static_assert(sizeof(ArkPetSkin::ArkLabelProperty) == 32);
static_assert(sizeof(ArkPetSkin::ArkMaterialProperty) == 32);
static_assert(sizeof(ArkPetSkin::ArkMeshAttachmentProperty) == 32);
static_assert(sizeof(ArkPetSkin::ArkNameProperty) == 32);
static_assert(sizeof(ArkPetSkin::ArkParticleProperty) == 32);
static_assert(sizeof(ArkPetSkinLibrary) == 40);
static_assert(sizeof(ArkPetSkinLibrary::ArkPetSkinsProperty) == 32);
static_assert(sizeof(ArkPetSkinLibrary::ArkUnlockGameTokenProperty) == 32);
static_assert(sizeof(ArkPetSkinLibrary::ArkVersionProperty) == 32);
...
#include "ArkPlayer.h"
static_assert(sizeof(ArkPlayer) == 8120);

#include "ArkPlayerAchievementComponent.h"
static_assert(sizeof(ArkPlayerAchievementComponent) == 120);
static_assert(sizeof(ArkPlayerAchievementComponent::GlooHit) == 40);

#include "ArkPlayerAction.h"
static_assert(sizeof(ArkPlayerAction) == 128);
static_assert(sizeof(ArkPlayerDisarmFailAction) == 128);
static_assert(sizeof(ArkPlayerDisarmStartAction) == 128);
static_assert(sizeof(ArkPlayerDisarmWinAction) == 128);
static_assert(sizeof(ArkPlayerGlooedAction) == 128);

#include "ArkPlayerAudio.h"
static_assert(sizeof(ArkPlayerAudio) == 152);
...
#include "ArkPlayerComponent.h"
static_assert(sizeof(ArkPlayerComponent) == 352);
static_assert(sizeof(ClimbPosInfo) == 16);
...
#include "ArkPlayerHelmet.h"
static_assert(sizeof(ArkPlayerHelmet) == 88);

#include "ArkPlayerInput.h"
static_assert(sizeof(ArkPlayerInput) == 232);
static_assert(sizeof(ArkPlayerInput::ModeAndHandle) == 8);
static_assert(sizeof(ArkPlayerInput::MovementButtonPressInfo) == 4);

#include "ArkPlayerInteraction.h"
static_assert(sizeof(ArkPlayerInteraction) == 2280);
...
#include "ArkPlayerMovementFSM.h"
static_assert(sizeof(ArkPlayerMovementFSM) == 1696);
static_assert(sizeof(ArkPlayerMovementFSM::StagingInfo) == 20);
static_assert(sizeof(ArkPlayerMovementFsmBase_template_<void>) == 1552);
static_assert(sizeof(ArkPlayerMovementFsmBase_template_<void>::StateSelector<1>) == 1);

#include "ArkPlayerMovementStates.h"
static_assert(sizeof(ArkPlayerMovementStates::Base) == 1);
static_assert(sizeof(ArkPlayerMovementStates::Cinematic) == 12);
static_assert(sizeof(ArkPlayerMovementStates::Climb) == 56);
static_assert(sizeof(ArkPlayerMovementStates::Death) == 48);
static_assert(sizeof(ArkPlayerMovementStates::DeathByRecyclerGrenade) == 96);
static_assert(sizeof(ArkPlayerMovementStates::Disarming) == 1);
static_assert(sizeof(ArkPlayerMovementStates::Fall) == 48);
static_assert(sizeof(ArkPlayerMovementStates::Fly) == 1);
static_assert(sizeof(ArkPlayerMovementStates::Glooed) == 1);
static_assert(sizeof(ArkPlayerMovementStates::GravShaft) == 16);
static_assert(sizeof(ArkPlayerMovementStates::GravShaftG) == 16);
static_assert(sizeof(ArkPlayerMovementStates::GravShaftToG) == 32);
static_assert(sizeof(ArkPlayerMovementStates::GravShaftZeroG) == 16);
static_assert(sizeof(ArkPlayerMovementStates::Jump) == 64);
static_assert(sizeof(ArkPlayerMovementStates::Lift) == 144);
static_assert(sizeof(ArkPlayerMovementStates::Mimic) == 1);
static_assert(sizeof(ArkPlayerMovementStates::Shift) == 56);
static_assert(sizeof(ArkPlayerMovementStates::Slide) == 16);
static_assert(sizeof(ArkPlayerMovementStates::Smoke) == 12);
static_assert(sizeof(ArkPlayerMovementStates::ZeroG) == 392);
static_assert(sizeof(ArkPlayerMovementStates::ZeroG::AlignParams) == 8);
static_assert(sizeof(ArkPlayerMovementStates::ZeroG::RollParams) == 16);
...
#include "ArkPlayerPropulsionComponent.h"
static_assert(sizeof(ArkPlayerPropulsionComponent) == 216);
...
#include "ArkPlayerSignalReceiver.h"
static_assert(sizeof(ArkPlayerSignalReceiver) == 472);
static_assert(sizeof(ArkPlayerSignalReceiver::SignalAction) == 16);
...
#include "ArkPsiComponent.h"
static_assert(sizeof(CArkPsiComponent) == 1280);
...
#include "ArkStationAccessComponent.h"
static_assert(sizeof(ArkStationAccessComponent) == 24);

#include "ArkUtilityComponent.h"
static_assert(sizeof(ArkUtilityComponent) == 256);

#include "ArkWeaponSkinComponent.h"
static_assert(sizeof(ArkWeaponSkinComponent) == 96);
...
#include "arkplayergroundstate.h"
static_assert(sizeof(ArkPlayerMovementStates::Ground) == 512);
static_assert(sizeof(ArkPlayerMovementStates::Ground::ArkGroundColliderParameters) == 12);
#endif // !MOONCRASH
