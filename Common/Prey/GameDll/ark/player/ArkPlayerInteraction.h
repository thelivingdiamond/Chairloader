...
public:
	...
	void PostSerialize() { FPostSerialize(this); }
	void Reset() { FReset(this); }
	static uint64_t GetEntityRepairRequirement(const IEntity* const _pEntity) { return FGetEntityRepairRequirement(_pEntity); }
	static uint64_t GetEntityFortifyRequirement(const IEntity* const _pEntity) { return FGetEntityFortifyRequirement(_pEntity); }
	static uint64_t GetEntityBaseHackingRequirement(const IEntity* const _pEntity) { return FGetEntityBaseHackingRequirement(_pEntity); }
	static uint64_t GetEntityHackingRequirement(const IEntity* const _pEntity) { return FGetEntityHackingRequirement(_pEntity); }
	static uint64_t GetEntityCarryRequirement(const IEntity* const _pEntity) { return FGetEntityCarryRequirement(_pEntity); }
	static int AdjustHackingLevelForDoomClock(int _level) { return FAdjustHackingLevelForDoomClock(_level); }
	void TestAbilityRequirement(const uint64_t _abilityId, ArkInteractionTestResult& _result) const { FTestAbilityRequirement(this, _abilityId, _result); }
	EArkInteractionType GetInteractionType(EArkInteractionMode _mode) const { return FGetInteractionType(this, _mode); }
	bool GetInteractionHidden(EArkInteractionMode _mode) const { return FGetInteractionHidden(this, _mode); }
	bool Interact(EArkInteractionMode _interactMode) { return FInteract(this, _interactMode); }
	void ViewTutorial() { FViewTutorial(this); }
	...
	static inline auto FArkPlayerInteraction = PreyFunction<void(ArkPlayerInteraction* const _this)>(0x168AB10);
	static inline auto FGetInteractionTypeFromString = PreyFunction<EArkInteractionType(const char* _string)>(0x168C690);
	static inline auto FPopulateInteractionInfo = PreyFunction<bool(const IEntity* const _pEntity, std::array<ArkInteractionInfo, 4>& _interactionArray)>(0x168D0D0);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerInteraction* const _this, float _frameTime)>(0x168E3C0);
	static inline auto FPreSerialize = PreyFunction<void(ArkPlayerInteraction* const _this)>(0x168D620);
	static inline auto FSerialize = PreyFunction<void(ArkPlayerInteraction* const _this, TSerialize _ser)>(0x168D7C0);
	static inline auto FPostSerialize = PreyFunction<void(ArkPlayerInteraction* const _this)>(0x168D610);
	static inline auto FReset = PreyFunction<void(ArkPlayerInteraction* const _this)>(0x168D790);
	static inline auto FGetEntityRepairRequirement = PreyFunction<uint64_t(const IEntity* const _pEntity)>(0x168C420);
	static inline auto FGetEntityFortifyRequirement = PreyFunction<uint64_t(const IEntity* const _pEntity)>(0x168C380);
	static inline auto FGetEntityBaseHackingRequirement = PreyFunction<uint64_t(const IEntity* const _pEntity)>(0x168C230);
	static inline auto FGetEntityHackingRequirement = PreyFunction<uint64_t(const IEntity* const _pEntity)>(0x168C3A0);
	static inline auto FGetEntityCarryRequirement = PreyFunction<uint64_t(const IEntity* const _pEntity)>(0x168C250);
	static inline auto FAdjustHackingLevelForDoomClock = PreyFunction<int(int _level)>(0x168C0E0);
	static inline auto FTestAbilityRequirement = PreyFunction<void(const ArkPlayerInteraction* const _this, const uint64_t _abilityId, ArkInteractionTestResult& _result)>(0x168DBE0);
	static inline auto FGetInteractionType = PreyFunction<EArkInteractionType(const ArkPlayerInteraction* const _this, EArkInteractionMode _mode)>(0x168C680);
	static inline auto FGetInteractionHidden = PreyFunction<bool(const ArkPlayerInteraction* const _this, EArkInteractionMode _mode)>(0x168C670);
	static inline auto FInteract = PreyFunction<bool(ArkPlayerInteraction* const _this, EArkInteractionMode _interactMode)>(0x168C960);
	static inline auto FViewTutorial = PreyFunction<void(ArkPlayerInteraction* const _this)>(0x168FAC0);
	static inline auto FStopHoldToUseInteract = PreyFunction<void(ArkPlayerInteraction* const _this)>(0x168D830);
	static inline auto FStopSpecialUseInteract = PreyFunction<void(ArkPlayerInteraction* const _this)>(0x168DAC0);
	static inline auto FHasValidInteractionInfoOv1 = PreyFunction<bool(const ArkPlayerInteraction* const _this)>(0x168C930);
	static inline auto FTestInteractionType = PreyFunction<ArkInteractionTestResult*(const ArkPlayerInteraction* const _this, ArkInteractionTestResult* _return_value_, const IEntity* const _pEntity, const EArkInteractionMode _interactionMode, const ArkInteractionInfo& _interactionInfo)>(0x168DD50);
	static inline auto FPerformInteraction = PreyFunction<void(ArkPlayerInteraction* const _this, EArkInteractionType _interaction, EArkInteractionMode _mode, IEntity* const _pEntity, float _delay)>(0x168CC50);
	static inline auto FProcessInput = PreyFunction<void(ArkPlayerInteraction* const _this, const CCryName& _actionId, const int _activationMode, const float _value)>(0x168D730);
	static inline auto FDisableInteractionPrompt = PreyFunction<void(ArkPlayerInteraction* const _this, bool _bDisable)>(0x168C170);
	static inline auto FTriggerGameStateInteraction = PreyFunction<void(const ArkPlayerInteraction* const _this, const IEntity* const _pEntity)>(0x168E350);
	static inline auto FTestWorldUI = PreyFunction<bool(const IEntity* _pEntity, bool& _bHideLine)>(0x168E2D0);
	static inline auto FGetOwningEntity = PreyFunction<const IEntity* (const IEntity* _pEntity)>(0x168C6F0);
	static inline auto FGetPromptTutorial = PreyFunction<uint64_t(const IEntity* _pEntity)>(0x168C750);
};
#endif // !MOONCRASH
