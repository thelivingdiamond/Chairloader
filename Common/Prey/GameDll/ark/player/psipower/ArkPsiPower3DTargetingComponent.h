...
public:
	...
	virtual bool Start();
	virtual void Stop();
	void SetTargetingEmitterStrength(const float _strength) { FSetTargetingEmitterStrength(this, _strength); }
	std::vector<IEntity*> GetEntitiesInSphere(const float _fRadius) const { alignas(std::vector<IEntity*>) std::byte _return_buf_[sizeof(std::vector<IEntity*>)]; return *FGetEntitiesInSphere(this, reinterpret_cast<std::vector<IEntity*>*>(_return_buf_), _fRadius); }
	virtual void OnCreateEmitter(IParticleEmitter* pEmitter);
	virtual void OnDeleteEmitter(IParticleEmitter* _pEmitter);
	virtual bool UsePositionEmitter() const;
	...
	static inline auto FCArkPsiPower3DTargetingComponentOv1 = PreyFunction<void(CArkPsiPower3DTargetingComponent* const _this, const IArkPsiPower* _pPower)>(0x16A9D00);
	static inline auto FBitNotCArkPsiPower3DTargetingComponent = PreyFunction<void(CArkPsiPower3DTargetingComponent* const _this)>(0x16A9DB0);
	static inline auto FGetTargetingData = PreyFunction<ArkPsiTargetingData& (const CArkPsiPower3DTargetingComponent* const _this)>(0x16A9FE0);
	static inline auto FUpdate = PreyFunction<void(CArkPsiPower3DTargetingComponent* const _this, const float _fDt)>(0x16AA2A0);
	static inline auto FGetTargetPos = PreyFunction<Vec3*(const CArkPsiPower3DTargetingComponent* const _this, Vec3* _return_value_)>(0x29FCF0);
	static inline auto FGetTargetDir = PreyFunction<Vec3*(const CArkPsiPower3DTargetingComponent* const _this, Vec3* _return_value_)>(0x16A9EF0);
	static inline auto FStart = PreyFunction<bool(CArkPsiPower3DTargetingComponent* const _this)>(0x16AA060);
	static inline auto FStop = PreyFunction<void(CArkPsiPower3DTargetingComponent* const _this)>(0x16AA240);
	static inline auto FSetTargetingEmitterStrength = PreyFunction<void(CArkPsiPower3DTargetingComponent* const _this, const float _strength)>(0x16AA050);
	static inline auto FGetEntitiesInSphere = PreyFunction<std::vector<IEntity*>*(const CArkPsiPower3DTargetingComponent* const _this, std::vector<IEntity*>* _return_value_, const float _fRadius)>(0x16A9ED0);
	static inline auto FOnCreateEmitter = PreyFunction<void(IParticleEffectListener* const _this, IParticleEmitter* pEmitter)>(0x1333E90);
	static inline auto FOnDeleteEmitter = PreyFunction<void(IParticleEffectListener* const _this, IParticleEmitter* _pEmitter)>(0x16AA010);
	static inline auto FUsePositionEmitter = PreyFunction<bool(const CArkPsiPower3DTargetingComponent* const _this)>(0x1A302A0);
	static inline auto FUpdateTargetPosition = PreyFunction<Vec3*(CArkPsiPower3DTargetingComponent* const _this, Vec3* _return_value_)>(0x16AA380);
};
#endif // !MOONCRASH
