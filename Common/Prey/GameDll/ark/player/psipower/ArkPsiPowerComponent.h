...
public:
	...
	static inline auto FInitialize = PreyFunction<void(ArkPsiTargetingData* const _this, const XmlNodeRef _root)>(0x16B1E00);
};
...
public:
	...
	ArkAudioTrigger m_cooldownFinishedTrigger;
	ArkAudioTrigger m_activatePowerFailTrigger;
	std::array<std::unique_ptr<IArkPsiPower>, 23> m_powers;
	std::array<uint64_t, 23> m_petSkins;
	std::unordered_map<unsigned int, int> m_selectedUITargetIds;
	std::unordered_map<unsigned int, int> m_unselectedUITargetIds;
	ArkInputLegend m_targetingLegend;
	ArkInputLegend m_mimicTargetingLegend;
	...
	bool IsPowerActive(const EArkPsiPowers _power) const { return FIsPowerActive(this, _power); }
	bool IsPowerTargeting(const EArkPsiPowers _power) const { return FIsPowerTargeting(this, _power); }
	const char* GetIconForPower(EArkPsiPowers _power) const { return FGetIconForPower(this, _power); }
	void ClearSelectedPower() { FClearSelectedPower(this); }
	void ClearEquippedPower() { FClearEquippedPower(this); }
	bool SelectPower(const EArkPsiPowers _power) { return FSelectPower(this, _power); }
	bool ActivateSelectedPower() { return FActivateSelectedPower(this); }
	...
	void ResetSneakTimer() { FResetSneakTimer(this); }
	bool ShouldGenerateGameNoises() const { return FShouldGenerateGameNoises(this); }
	uint64_t GetPetSkinForPower(EArkPsiPowers _power) const { return FGetPetSkinForPower(this, _power); }
	void SetPetSkinForPower(EArkPsiPowers _power, uint64_t _skin) { FSetPetSkinForPower(this, _power, _skin); }
	void CreatePowers() { FCreatePowers(this); }
	void ClearUITargets() { FClearUITargets(this); }
	void StartTargeting(const IArkPsiPower& _power) { FStartTargeting(this, _power); }
	void DeactivateLatentPower(const EArkPsiPowers _power) { FDeactivateLatentPower(this, _power); }
	void UpdateEquippedPowerUI(const bool _bFinished) const { FUpdateEquippedPowerUI(this, _bFinished); }
	void NotifyActionFailed(const char* _pText) const { FNotifyActionFailed(this, _pText); }
	void PickPetSkinForPower(EArkPsiPowers _power) { FPickPetSkinForPower(this, _power); }
	...
	static inline auto FArkPsiPowerComponent = PreyFunction<void(ArkPsiPowerComponent* const _this)>(0x16AE390);
	static inline auto FBitNotArkPsiPowerComponent = PreyFunction<void(ArkPsiPowerComponent* const _this)>(0x16AE800);
	static inline auto FProcessInput = PreyFunction<void(ArkPsiPowerComponent* const _this, const CCryName& _actionId, int _activationMode, float _value)>(0x16B2780);
	static inline auto FReset = PreyFunction<void(ArkPsiPowerComponent* const _this)>(0x16B2A30);
	static inline auto FUpdate = PreyFunction<void(ArkPsiPowerComponent* const _this, const float _fFrameTime)>(0x16B60B0);
	static inline auto FUpdateHUDMarkerElements = PreyFunction<void(ArkPsiPowerComponent* const _this)>(0x16B67A0);
	static inline auto FRegisterLatentPower = PreyFunction<void(ArkPsiPowerComponent* const _this, EArkPsiPowers _power)>(0x16B29E0);
	static inline auto FUnregisterLatentPower = PreyFunction<void(ArkPsiPowerComponent* const _this, EArkPsiPowers _power)>(0x16B51C0);
	static inline auto FUnlockPower = PreyFunction<bool(ArkPsiPowerComponent* const _this, EArkPsiPowers _powerEnum, const int _level)>(0x16B4F30);
	static inline auto FLockPower = PreyFunction<void(ArkPsiPowerComponent* const _this, EArkPsiPowers _powerEnum)>(0x16B20E0);
	static inline auto FGetPowerLevel = PreyFunction<int(const ArkPsiPowerComponent* const _this, const EArkPsiPowers _power)>(0x16B1B80);
	static inline auto FIsPowerLocked = PreyFunction<bool(const ArkPsiPowerComponent* const _this, const EArkPsiPowers _power, const int _level)>(0x16B2070);
	static inline auto FSerialize = PreyFunction<void(ArkPsiPowerComponent* const _this, TSerialize _ser)>(0x16B3A80);
	static inline auto FPostSerialize = PreyFunction<void(ArkPsiPowerComponent* const _this)>(0x16B2700);
	static inline auto FGetIArkPsiPowerOv1 = PreyFunction<IArkPsiPower* (ArkPsiPowerComponent* const _this, const EArkPsiPowers _power)>(0x16B1AE0);
	static inline auto FGetIArkPsiPowerOv0 = PreyFunction<const IArkPsiPower* (const ArkPsiPowerComponent* const _this, const EArkPsiPowers _power)>(0x16B1AE0);
	static inline auto FIsPowerActive = PreyFunction<bool(const ArkPsiPowerComponent* const _this, const EArkPsiPowers _power)>(0x16B2040);
	static inline auto FIsPowerTargeting = PreyFunction<bool(const ArkPsiPowerComponent* const _this, const EArkPsiPowers _power)>(0x16B20B0);
	static inline auto FGetIconForPower = PreyFunction<const char* (const ArkPsiPowerComponent* const _this, EArkPsiPowers _power)>(0x16B1B00);
	static inline auto FClearSelectedPower = PreyFunction<void(ArkPsiPowerComponent* const _this)>(0x16AFDD0);
	static inline auto FClearEquippedPower = PreyFunction<void(ArkPsiPowerComponent* const _this)>(0x16AFBD0);
	static inline auto FSelectPower = PreyFunction<bool(ArkPsiPowerComponent* const _this, const EArkPsiPowers _power)>(0x16B2B30);
	static inline auto FActivateSelectedPower = PreyFunction<bool(ArkPsiPowerComponent* const _this)>(0x16AF5D0);
	static inline auto FStopLatentPowers = PreyFunction<void(ArkPsiPowerComponent* const _this)>(0x16B4E30);
	static inline auto FOnLevelToLevelTransition = PreyFunction<void(ArkPsiPowerComponent* const _this)>(0x16B2330);
	static inline auto FDisableTargetedPowers = PreyFunction<void(ArkPsiPowerComponent* const _this, const bool _bDisable)>(0x16B1270);
	static inline auto FStop = PreyFunction<void(ArkPsiPowerComponent* const _this)>(0x16B4DA0);
	static inline auto FOnStatChange = PreyFunction<void(ArkPsiPowerComponent* const _this, const unsigned _ownerId, const CCryName& _stat64i32, const float _previousValue, const float _newValue)>(0x16B2370);
	static inline auto FGetUnlockedPowers = PreyFunction<std::vector<enum::EArkPsiPowers>*(const ArkPsiPowerComponent* const _this, std::vector<enum::EArkPsiPowers>* _return_value_)>(0x16B1C00);
	static inline auto FRefreshTargetingHandler = PreyFunction<void(ArkPsiPowerComponent* const _this, const bool _bZeroG)>(0x16B28F0);
	static inline auto FCanEnterFocusMode = PreyFunction<bool(const ArkPsiPowerComponent* const _this, bool _bOpenMenu)>(0x16AFA80);
	static inline auto FEquipPower = PreyFunction<bool(ArkPsiPowerComponent* const _this, const EArkPsiPowers& _power)>(0x16B1300);
	static inline auto FActivateLatentPower = PreyFunction<void(ArkPsiPowerComponent* const _this, const EArkPsiPowers _power)>(0x16AF560);
	static inline auto FGetAbilityForPower = PreyFunction<const ArkAbility* (const ArkPsiPowerComponent* const _this, EArkPsiPowers _power)>(0x16B1510);
	static inline auto FHandleBlacklist = PreyFunction<bool(ArkPsiPowerComponent* const _this, const IArkPsiPower& _power)>(0x16B1CA0);
	static inline auto FUpdateInputLegend = PreyFunction<void(ArkPsiPowerComponent* const _this, const EArkPsiPowers _power)>(0x16B6CB0);
	static inline auto FResetJumpTimer = PreyFunction<void(ArkPsiPowerComponent* const _this)>(0x16B2B10);
	static inline auto FResetSneakTimer = PreyFunction<void(ArkPsiPowerComponent* const _this)>(0x16B2B20);
	static inline auto FShouldGenerateGameNoises = PreyFunction<bool(const ArkPsiPowerComponent* const _this)>(0x16B4250);
	static inline auto FGetPetSkinForPower = PreyFunction<uint64_t(const ArkPsiPowerComponent* const _this, EArkPsiPowers _power)>(0x16B1B70);
	static inline auto FSetPetSkinForPower = PreyFunction<void(ArkPsiPowerComponent* const _this, EArkPsiPowers _power, uint64_t _skin)>(0x16B4190);
	static inline auto FCreatePowers = PreyFunction<void(ArkPsiPowerComponent* const _this)>(0x16B0060);
	static inline auto FClearUITargets = PreyFunction<void(ArkPsiPowerComponent* const _this)>(0x16AFFF0);
	static inline auto FStartTargeting = PreyFunction<void(ArkPsiPowerComponent* const _this, const IArkPsiPower& _power)>(0x16B4700);
	static inline auto FDeactivateLatentPower = PreyFunction<void(ArkPsiPowerComponent* const _this, const EArkPsiPowers _power)>(0x16B11F0);
	static inline auto FUpdateEquippedPowerUI = PreyFunction<void(const ArkPsiPowerComponent* const _this, const bool _bFinished)>(0x16B64B0);
	static inline auto FNotifyActionFailed = PreyFunction<void(const ArkPsiPowerComponent* const _this, const char* _pText)>(0x16B21B0);
	static inline auto FPickPetSkinForPower = PreyFunction<void(ArkPsiPowerComponent* const _this, EArkPsiPowers _power)>(0x16B2390);
};
#endif // !MOONCRASH
