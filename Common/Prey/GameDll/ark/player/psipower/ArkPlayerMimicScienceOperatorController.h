...
// Header: FromCpp
// Prey/GameDll/ark/player/psipower/ArkPlayerMimicScienceOperatorController.h
class ArkPlayerMimicScienceOperatorController : public ArkPlayerMimicOperatorController<ArkPlayerMimicScienceOperatorController>, public ArkNpcAnimActionObserver // Id=801B68E Size=456
{
public:
	...
	ArkPsiMimicScienceOperatorProperties const &m_properties;
	...
	IEntity const *GetAttackTarget() const { return FGetAttackTarget(this); }
	ArkPsiMimicScienceOperatorProperties const &GetProperties() const { return FGetProperties(this); }
	...
	static inline auto FProcessInput = PreyFunction<void(ArkPlayerMimicScienceOperatorController *const _this, CCryName const &_actionId, const bool _bPressed)>(0x12F11D0);
	...
	static inline auto FIsAttacking = PreyFunction<bool(ArkPlayerMimicScienceOperatorController const *const _this)>(0x12F0D30);
	static inline auto FGetMovementSpeed = PreyFunction<float(ArkPlayerMimicScienceOperatorController const *const _this)>(0x12F0B70);
	static inline auto FGetAttackTarget = PreyFunction<IEntity const *(ArkPlayerMimicScienceOperatorController const *const _this)>(0x12F0AA0);
	static inline auto FGetProperties = PreyFunction<ArkPsiMimicScienceOperatorProperties const &(ArkPlayerMimicScienceOperatorController const *const _this)>(0x12F0BB0);
