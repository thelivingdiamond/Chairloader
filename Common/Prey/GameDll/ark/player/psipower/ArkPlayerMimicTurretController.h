...
public:
	...
	ArkSimpleTimer m_attackTimer;
	ArkSimpleTimer m_forceUprightTimer;
	Ang3 m_inputAngleVelocity;
	ArkTurret* m_pTurret;
	const ArkPsiMimicTurretProperties& m_properties;
	bool m_bFlipping;
	...
	static inline auto FArkPlayerMimicTurretController = PreyFunction<void(ArkPlayerMimicTurretController* const _this)>(0x13FE750);
	static inline auto FInitialize = PreyFunction<void(ArkPlayerMimicTurretController* const _this, IEntity& _mimicEntity)>(0x13FE8B0);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMimicTurretController* const _this, const float _frameTime, IEntity& _mimicEntity)>(0x13FE9B0);
	static inline auto FProcessInput = PreyFunction<void(ArkPlayerMimicTurretController* const _this, const CCryName& _actionId, const bool _bPressed)>(0x13FE8F0);
	static inline auto FGetModalLegend = PreyFunction<const ArkInputLegend& (const ArkPlayerMimicTurretController* const _this)>(0x13FE7F0);
	static inline auto FSerialize = PreyFunction<void(ArkPlayerMimicTurretController* const _this, TSerialize _ser)>(0x13FE930);
	static inline auto FIsDeployed = PreyFunction<bool(const ArkPlayerMimicTurretController* const _this)>(0x13FE8E0);
	static inline auto FGetMuzzlePosition = PreyFunction<Vec3*(const ArkPlayerMimicTurretController* const _this, Vec3* _return_value_)>(0x13FE820);
	static inline auto FGetGimbalPosition = PreyFunction<Vec3*(const ArkPlayerMimicTurretController* const _this, Vec3* _return_value_)>(0x13FE7D0);
	static inline auto FGetMuzzleRotation = PreyFunction<const Quat*(const ArkPlayerMimicTurretController* const _this, const Quat* _return_value_)>(0x13FE840);
};
#endif // !MOONCRASH
