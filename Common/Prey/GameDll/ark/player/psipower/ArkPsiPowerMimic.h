...
public:
	...
	static inline auto FCArkPsiPowerMimic = PreyFunction<void(CArkPsiPowerMimic* const _this)>(0x16BE6F0);
	static inline auto FCancel = PreyFunction<void(CArkPsiPowerMimic* const _this)>(0x13BA750);
	static inline auto FOnReset = PreyFunction<void(CArkPsiPowerMimic* const _this)>(0x16C0240);
	static inline auto FGetCost = PreyFunction<int(const CArkPsiPowerMimic* const _this)>(0x16BF6A0);
	static inline auto FUpdate = PreyFunction<void(CArkPsiPowerMimic* const _this, const float _frameTime)>(0x16C1760);
	static inline auto FStartTargeting = PreyFunction<bool(CArkPsiPowerMimic* const _this)>(0x16C1050);
	static inline auto FUpdateTargeting = PreyFunction<void(CArkPsiPowerMimic* const _this, const float _fFrameTime)>(0x16C2110);
	static inline auto FRefreshTargets = PreyFunction<void(CArkPsiPowerMimic* const _this)>(0x16C0BB0);
	static inline auto FGetSelectedTargets = PreyFunction<std::vector<IEntity*>*(const CArkPsiPowerMimic* const _this, std::vector<IEntity*>* _return_value_)>(0x16C6560);
	static inline auto FGetUnselectedTargets = PreyFunction<std::vector<IEntity*>*(const CArkPsiPowerMimic* const _this, std::vector<IEntity*>* _return_value_)>(0x16C65F0);
	static inline auto FGetTargetPosition = PreyFunction<Vec3*(const CArkPsiPowerMimic* const _this, Vec3* _return_value_)>(0x16C65B0);
	static inline auto FGetModalLegend = PreyFunction<const ArkInputLegend& (const CArkPsiPowerMimic* const _this)>(0x16BF9C0);
	static inline auto FCanEnterFocusMode = PreyFunction<bool(const CArkPsiPowerMimic* const _this, const EArkPsiPowers& _equippedPower)>(0x16BEAB0);
	static inline auto FProcessInput = PreyFunction<void(CArkPsiPowerMimic* const _this, const CCryName& _actionId, int _activationMode, float _value)>(0x16C0AE0);
	static inline auto FProcessInputForTargeting = PreyFunction<void(CArkPsiPowerMimic* const _this, const CCryName& _actionId, int _activationMode, float _value)>(0x1333E90);
	static inline auto FSerialize = PreyFunction<void(CArkPsiPowerMimic* const _this, TSerialize _serializer)>(0x16C0CC0);
	static inline auto FPostSerialize = PreyFunction<void(CArkPsiPowerMimic* const _this)>(0x16C09B0);
	static inline auto FGetTargetingComponent = PreyFunction<const ArkPsiPowerTargetingComponent* (const CArkPsiPowerMimic* const _this)>(0x10ED490);
	static inline auto FGetEnum = PreyFunction<EArkPsiPowers(const CArkPsiPowerMimic* const _this)>(0xA72AA0);
	static inline auto FShouldGenerateGameNoises = PreyFunction<bool(const CArkPsiPowerMimic* const _this)>(0x16C1040);
	static inline auto FOnBroken = PreyFunction<void(IArkBreakableListener* const _this, const IEntity& _entity)>(0x16C01C0);
	static inline auto FMorphOut = PreyFunction<bool(CArkPsiPowerMimic* const _this)>(0x16BFBC0);
	static inline auto FFinishMorphIn = PreyFunction<void(CArkPsiPowerMimic* const _this)>(0x16BF390);
	static inline auto FMorphInObject = PreyFunction<void(CArkPsiPowerMimic* const _this)>(0x16BFAF0);
	static inline auto FGetMimicVisibility = PreyFunction<float(const CArkPsiPowerMimic* const _this)>(0x16BF8F0);
	static inline auto FGetTargetedEntityId = PreyFunction<unsigned(const CArkPsiPowerMimic* const _this)>(0x16BFAE0);
	static inline auto FGetMimickedEntityId = PreyFunction<unsigned(const CArkPsiPowerMimic* const _this)>(0x16BF9A0);
	static inline auto FCleanUp = PreyFunction<void(CArkPsiPowerMimic* const _this)>(0x16BEAD0);
	static inline auto FStop = PreyFunction<bool(CArkPsiPowerMimic* const _this)>(0x16C13E0);
	static inline auto FStart_Derived = PreyFunction<bool(CArkPsiPowerMimic* const _this)>(0x16C1080);
	static inline auto FGetCanCancel = PreyFunction<bool(const CArkPsiPowerMimic* const _this)>(0x16BF690);
	static inline auto FUpdateCamera = PreyFunction<void(CArkPsiPowerMimic* const _this, SViewParams& _params)>(0x16C1FA0);
	static inline auto FSetLevel_Derived = PreyFunction<void(CArkPsiPowerMimic* const _this, const int _level)>(0x16C0F60);
	static inline auto FGetExecutionError = PreyFunction<EArkPsiPowerError(const CArkPsiPowerMimic* const _this)>(0x16C5DD0);
	static inline auto FPlayerCanFit = PreyFunction<bool(const CArkPsiPowerMimic* const _this, const EStance _stance, const Vec3& _position)>(0x16C0260);
	static inline auto FComputeInitialWorldTransform = PreyFunction<boost::optional<QuatT_tpl<float> >*(const CArkPsiPowerMimic* const _this, boost::optional<QuatT_tpl<float> >* _return_value_, const IEntity& _targetEntity)>(0x16BEC90);
	static inline auto FFilterTarget = PreyFunction<bool(const CArkPsiPowerMimic* const _this, const IEntity& _entity)>(0x16BF140);
};
#endif // !MOONCRASH
