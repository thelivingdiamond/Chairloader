...
public:
	...
	static inline auto FGetEntitiesInSphere = PreyFunction<std::vector<IEntity*>*(const CArkPsiPowerAlienTargetingComponent* const _this, std::vector<IEntity*>* _return_value_, const float _radius)>(0x16AC220);
};
#endif // !MOONCRASH
