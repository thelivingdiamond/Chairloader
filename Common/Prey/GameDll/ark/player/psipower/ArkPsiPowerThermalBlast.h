...
// CArkPsiPowerThermalBlast
// Header:  Prey/GameDll/ark/player/psipower/ArkPsiPowerThermalBlast.h
class CArkPsiPowerThermalBlast : public CArkPsiPowerBlast<CArkPsiPower3DTargetingComponent,CArkPsiThermalBlast,ThermalBlastPowerProperties,2>
{ // Size=696 (0x2B8)
public:
	CArkPsiPowerThermalBlast();
	virtual ~CArkPsiPowerThermalBlast();
	...
	static inline auto FCArkPsiPowerThermalBlastOv1 = PreyFunction<void(CArkPsiPowerThermalBlast* const _this)>(0x1584E30);
	static inline auto FGetSelectedTargets = PreyFunction<std::vector<IEntity*>*(const CArkPsiPowerThermalBlast* const _this, std::vector<IEntity*>* _return_value_)>(0x1585540);
};
...
public:
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkPsiPowerThermalBlastProperties::ArkDisplayNameProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x1443F00);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkPsiPowerThermalBlastProperties::ArkDisplayNameProperty* const _this, ArkReflectedObject* const _pObject)>(0x1088870);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkPsiPowerThermalBlastProperties::ArkDescriptionProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x10B19D0);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkPsiPowerThermalBlastProperties::ArkDescriptionProperty* const _this, ArkReflectedObject* const _pObject)>(0x1093260);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkPsiPowerThermalBlastProperties::ArkCooldownDurationSecProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x157DA30);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkPsiPowerThermalBlastProperties::ArkCooldownDurationSecProperty* const _this, ArkReflectedObject* const _pObject)>(0x13C06B0);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkPsiPowerThermalBlastProperties::ArkBlastTypePropertiesProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x157E5D0);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkPsiPowerThermalBlastProperties::ArkBlastTypePropertiesProperty* const _this, ArkReflectedObject* const _pObject)>(0x1082790);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkPsiPowerThermalBlastProperties::ArkTargetingPropertiesProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x157E610);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkPsiPowerThermalBlastProperties::ArkTargetingPropertiesProperty* const _this, ArkReflectedObject* const _pObject)>(0x1084620);
	};

	static inline auto s_ArkDisplayNameProperty = PreyGlobal<ArkPsiPowerThermalBlastProperties::ArkDisplayNameProperty>(0x2D6AF18);
	string m_DisplayName;
	static inline auto s_ArkDescriptionProperty = PreyGlobal<ArkPsiPowerThermalBlastProperties::ArkDescriptionProperty>(0x2D6AF38);
	string m_Description;
	static inline auto s_ArkCooldownDurationSecProperty = PreyGlobal<ArkPsiPowerThermalBlastProperties::ArkCooldownDurationSecProperty>(0x2D6AF58);
	float m_CooldownDurationSec;
	static inline auto s_ArkBlastTypePropertiesProperty = PreyGlobal<ArkPsiPowerThermalBlastProperties::ArkBlastTypePropertiesProperty>(0x2D6AF78);
	ArkPsiThermalBlastProperties m_BlastTypeProperties;
	static inline auto s_ArkTargetingPropertiesProperty = PreyGlobal<ArkPsiPowerThermalBlastProperties::ArkTargetingPropertiesProperty>(0x2D6AF98);
	ArkPsiPowerTargetingComponentProperties m_TargetingProperties;
	...
	static inline auto FGetClass = PreyFunction<ArkClass* ()>(0x1585370);
};
...
public:
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ThermalBlastPowerProperties::ArkCommonProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x14030A0);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ThermalBlastPowerProperties::ArkCommonProperty* const _this, ArkReflectedObject* const _pObject)>(0x108CDE0);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ThermalBlastPowerProperties::ArkUniqueProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x13B8620);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ThermalBlastPowerProperties::ArkUniqueProperty* const _this, ArkReflectedObject* const _pObject)>(0x13BF510);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ThermalBlastPowerProperties::ArkLevelsProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x1583AC0);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ThermalBlastPowerProperties::ArkLevelsProperty* const _this, ArkReflectedObject* const _pObject)>(0x1583BC0);
		static inline auto FIsArray = PreyFunction<bool(const ThermalBlastPowerProperties::ArkLevelsProperty* const _this)>(0x1A302A0);
		static inline auto FReset = PreyFunction<void(const ThermalBlastPowerProperties::ArkLevelsProperty* const _this, ArkReflectedObject* _pObject)>(0x157E7A0);
	};

	using LevelProperties = ArkPsiPowerThermalBlastProperties;
	using UniqueProperties = bool;

	static inline auto s_ArkCommonProperty = PreyGlobal<ThermalBlastPowerProperties::ArkCommonProperty>(0x2D6AFB8);
	ArkPsiPowerCommonProperties m_Common;
	static inline auto s_ArkUniqueProperty = PreyGlobal<ThermalBlastPowerProperties::ArkUniqueProperty>(0x2D6AFD8);
	bool m_Unique;
	static inline auto s_ArkLevelsProperty = PreyGlobal<ThermalBlastPowerProperties::ArkLevelsProperty>(0x2D6AFF8);
	std::vector<ArkPsiPowerThermalBlastProperties> m_Levels;
	...
	static inline auto FCreate = PreyFunction<ArkReflectedObject* ()>(0x15852A0);
	static inline auto FGetClass = PreyFunction<ArkClass* ()>(0x1585410);
	static inline auto FInit = PreyFunction<bool(ThermalBlastPowerProperties* const _this)>(0x15855E0);
};
#endif // !MOONCRASH
