...
#include "ArkPlayerBurrowAction.h"
static_assert(sizeof(ArkPlayerBurrowAction) == 168);
...
#include "ArkPlayerMimicMilitaryOperatorController.h"
static_assert(sizeof(ArkPlayerMimicMilitaryOperatorController) == 1040);
...
#include "ArkPlayerMimicTurretController.h"
static_assert(sizeof(ArkPlayerMimicTurretController) == 56);
...
#include "ArkPsiFlareLight.h"
static_assert(sizeof(ArkPsiFlareLight) == 48);
static_assert(sizeof(ArkPsiFlareLightProperties) == 56);
static_assert(sizeof(ArkPsiFlareLightProperties::ArkColorProperty) == 32);
static_assert(sizeof(ArkPsiFlareLightProperties::ArkDiffuseCoeffProperty) == 32);
static_assert(sizeof(ArkPsiFlareLightProperties::ArkLightTexturePathProperty) == 32);
static_assert(sizeof(ArkPsiFlareLightProperties::ArkMaterialPathProperty) == 32);
static_assert(sizeof(ArkPsiFlareLightProperties::ArkMaxFrustumAngleDegProperty) == 32);
static_assert(sizeof(ArkPsiFlareLightProperties::ArkMinFrustumAngleDegProperty) == 32);
static_assert(sizeof(ArkPsiFlareLightProperties::ArkSpecularCoeffProperty) == 32);
static_assert(sizeof(ArkPsiFlareLightProperties::ArkTargetAttachmentNameProperty) == 32);

#include "ArkPsiFlarePointLight.h"
static_assert(sizeof(ArkPsiFlarePointLight) == 24);
static_assert(sizeof(ArkPsiFlarePointLightProperties) == 40);
static_assert(sizeof(ArkPsiFlarePointLightProperties::ArkColorProperty) == 32);
static_assert(sizeof(ArkPsiFlarePointLightProperties::ArkDiffuseCoeffProperty) == 32);
static_assert(sizeof(ArkPsiFlarePointLightProperties::ArkLensFlareNameProperty) == 32);
static_assert(sizeof(ArkPsiFlarePointLightProperties::ArkRadiusProperty) == 32);
static_assert(sizeof(ArkPsiFlarePointLightProperties::ArkSpecularCoeffProperty) == 32);
...
#include "ArkPsiPowerBurrow.h"
static_assert(sizeof(ArkPsiPowerBurrow) == 736);
static_assert(sizeof(ArkPsiPowerBurrowProperties) == 248);
static_assert(sizeof(ArkPsiPowerBurrowProperties::ArkBlastTypePropertiesProperty) == 32);
static_assert(sizeof(ArkPsiPowerBurrowProperties::ArkCooldownDurationSecProperty) == 32);
static_assert(sizeof(ArkPsiPowerBurrowProperties::ArkDescriptionProperty) == 32);
static_assert(sizeof(ArkPsiPowerBurrowProperties::ArkDisplayNameProperty) == 32);
static_assert(sizeof(ArkPsiPowerBurrowProperties::ArkTargetingPropertiesProperty) == 32);
static_assert(sizeof(BurrowPowerProperties) == 248);
static_assert(sizeof(BurrowPowerProperties::ArkCommonProperty) == 32);
static_assert(sizeof(BurrowPowerProperties::ArkLevelsProperty) == 32);
static_assert(sizeof(BurrowPowerProperties::ArkUniqueProperty) == 32);

#include "ArkPsiPowerCastMatter.h"
static_assert(sizeof(ArkPsiPowerCastMatter) == 568);
static_assert(sizeof(ArkPsiPowerCastMatterProperties) == 136);
static_assert(sizeof(ArkPsiPowerCastMatterProperties::ArkCooldownDurationSecProperty) == 32);
static_assert(sizeof(ArkPsiPowerCastMatterProperties::ArkDescriptionProperty) == 32);
static_assert(sizeof(ArkPsiPowerCastMatterProperties::ArkDisplayNameProperty) == 32);
static_assert(sizeof(ArkPsiPowerCastMatterProperties::ArkGroundParticlEffectProperty) == 32);
static_assert(sizeof(ArkPsiPowerCastMatterProperties::ArkMaxProjectilesProperty) == 32);
static_assert(sizeof(ArkPsiPowerCastMatterProperties::ArkProjectileArchetypeProperty) == 32);
static_assert(sizeof(ArkPsiPowerCastMatterProperties::ArkProjectileMaxSpawnDelayProperty) == 32);
static_assert(sizeof(ArkPsiPowerCastMatterProperties::ArkProjectileMinSpawnDelayProperty) == 32);
static_assert(sizeof(ArkPsiPowerCastMatterProperties::ArkTargetAreaRadiusProperty) == 32);
static_assert(sizeof(ArkPsiPowerCastMatterProperties::ArkTargetingPropertiesProperty) == 32);
static_assert(sizeof(CastMatterPowerProperties) == 248);
static_assert(sizeof(CastMatterPowerProperties::ArkCommonProperty) == 32);
static_assert(sizeof(CastMatterPowerProperties::ArkLevelsProperty) == 32);
static_assert(sizeof(CastMatterPowerProperties::ArkUniqueProperty) == 32);
...
static_assert(sizeof(ArkPsiPowerCombatFocusProperties::ArkStatPackageProperty) == 32);
static_assert(sizeof(ArkPsiPowerCombatFocusProperties::ArkTimeScaleProperty) == 32);
static_assert(sizeof(CArkPsiPowerCombatFocus) == 104);
static_assert(sizeof(CombatFocusPowerProperties) == 248);
static_assert(sizeof(CombatFocusPowerProperties::ArkCommonProperty) == 32);
static_assert(sizeof(CombatFocusPowerProperties::ArkLevelsProperty) == 32);
static_assert(sizeof(CombatFocusPowerProperties::ArkUniqueProperty) == 32);
...
#include "ArkPsiPowerComponent.h"
static_assert(sizeof(ArkPsiPowerComponent) == 880);
static_assert(sizeof(ArkPsiTargetingData) == 72);

#include "ArkPsiPowerConsumeCorpse.h"
static_assert(sizeof(ArkPsiPowerConsumeCorpse) == 528);
static_assert(sizeof(ArkPsiPowerConsumeCorpseProperties) == 136);
static_assert(sizeof(ArkPsiPowerConsumeCorpseProperties::ArkConsumeAudioTriggerProperty) == 32);
static_assert(sizeof(ArkPsiPowerConsumeCorpseProperties::ArkCooldownDurationSecProperty) == 32);
static_assert(sizeof(ArkPsiPowerConsumeCorpseProperties::ArkDescriptionProperty) == 32);
static_assert(sizeof(ArkPsiPowerConsumeCorpseProperties::ArkDisplayNameProperty) == 32);
static_assert(sizeof(ArkPsiPowerConsumeCorpseProperties::ArkLerpDurationProperty) == 32);
static_assert(sizeof(ArkPsiPowerConsumeCorpseProperties::ArkLerpTargetPositionOffsetProperty) == 32);
static_assert(sizeof(ArkPsiPowerConsumeCorpseProperties::ArkPlayerSignalPackageIdProperty) == 32);
static_assert(sizeof(ArkPsiPowerConsumeCorpseProperties::ArkTargetingPropertiesProperty) == 32);
static_assert(sizeof(ConsumeCorpsePowerProperties) == 248);
static_assert(sizeof(ConsumeCorpsePowerProperties::ArkCommonProperty) == 32);
static_assert(sizeof(ConsumeCorpsePowerProperties::ArkLevelsProperty) == 32);
static_assert(sizeof(ConsumeCorpsePowerProperties::ArkUniqueProperty) == 32);
...
#include "ArkPsiPowerFlare.h"
static_assert(sizeof(ArkPsiPowerFlareProperties) == 368);
static_assert(sizeof(ArkPsiPowerFlareProperties::ArkBlastTypePropertiesProperty) == 32);
static_assert(sizeof(ArkPsiPowerFlareProperties::ArkCooldownDurationSecProperty) == 32);
static_assert(sizeof(ArkPsiPowerFlareProperties::ArkDescriptionProperty) == 32);
static_assert(sizeof(ArkPsiPowerFlareProperties::ArkDisplayNameProperty) == 32);
static_assert(sizeof(ArkPsiPowerFlareProperties::ArkTargetingPropertiesProperty) == 32);
static_assert(sizeof(CArkPsiPowerFlare) == 696);
static_assert(sizeof(FlarePowerProperties) == 248);
static_assert(sizeof(FlarePowerProperties::ArkCommonProperty) == 32);
static_assert(sizeof(FlarePowerProperties::ArkLevelsProperty) == 32);
static_assert(sizeof(FlarePowerProperties::ArkUniqueProperty) == 32);

#include "ArkPsiPowerGroundTargetingComponent.h"
static_assert(sizeof(ArkPsiPowerGroundTargetingComponent) == 480);
...
static_assert(sizeof(ArkPsiPowerKineticShieldProperties::ArkTimeoutParticleEffectProperty) == 32);
static_assert(sizeof(ArkPsiPowerKineticShieldProperties::ArkWarningDurationSecProperty) == 32);
static_assert(sizeof(CArkPsiPowerKineticShield) == 704);
static_assert(sizeof(KineticShieldPowerProperties) == 248);
static_assert(sizeof(KineticShieldPowerProperties::ArkCommonProperty) == 32);
static_assert(sizeof(KineticShieldPowerProperties::ArkLevelsProperty) == 32);
static_assert(sizeof(KineticShieldPowerProperties::ArkUniqueProperty) == 32);
...
#include "ArkPsiPowerPlayerProximityTargetingComponent.h"
static_assert(sizeof(ArkPsiPowerPlayerProximityTargetingComponent) == 464);
...
#include "ArkPsiPowerSummonPetMimic.h"
static_assert(sizeof(ArkPsiPowerSummonPetMimic) == 712);
static_assert(sizeof(ArkPsiPowerSummonPetMimicProperties) == 176);
static_assert(sizeof(ArkPsiPowerSummonPetMimicProperties::ArkArchetypeProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetMimicProperties::ArkCooldownDurationSecProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetMimicProperties::ArkDescriptionProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetMimicProperties::ArkDisplayNameProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetMimicProperties::ArkIconProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetMimicProperties::ArkMaxBoundsProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetMimicProperties::ArkMinBoundsProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetMimicProperties::ArkSearchCooldownSecProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetMimicProperties::ArkSummonFXAttachmentProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetMimicProperties::ArkSummonFXProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetMimicProperties::ArkTargetingPropertiesProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetMimicProperties::ArkUnsummonFXProperty) == 32);
static_assert(sizeof(SummonPetMimicPowerProperties) == 248);
static_assert(sizeof(SummonPetMimicPowerProperties::ArkCommonProperty) == 32);
static_assert(sizeof(SummonPetMimicPowerProperties::ArkLevelsProperty) == 32);
static_assert(sizeof(SummonPetMimicPowerProperties::ArkUniqueProperty) == 32);

#include "ArkPsiPowerSummonPetTurret.h"
static_assert(sizeof(ArkPsiPowerSummonPetTurret) == 696);
static_assert(sizeof(ArkPsiPowerSummonPetTurretProperties) == 176);
static_assert(sizeof(ArkPsiPowerSummonPetTurretProperties::ArkArchetypeProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetTurretProperties::ArkCooldownDurationSecProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetTurretProperties::ArkDescriptionProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetTurretProperties::ArkDisplayNameProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetTurretProperties::ArkIconProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetTurretProperties::ArkMaxBoundsProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetTurretProperties::ArkMinBoundsProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetTurretProperties::ArkRandomNameStringCollectionProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetTurretProperties::ArkSummonFXAttachmentProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetTurretProperties::ArkSummonFXProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetTurretProperties::ArkTargetingPropertiesProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetTurretProperties::ArkUnsummonFXProperty) == 32);
static_assert(sizeof(SummonPetTurretPowerProperties) == 248);
static_assert(sizeof(SummonPetTurretPowerProperties::ArkCommonProperty) == 32);
static_assert(sizeof(SummonPetTurretPowerProperties::ArkLevelsProperty) == 32);
static_assert(sizeof(SummonPetTurretPowerProperties::ArkUniqueProperty) == 32);
...
#include "arkplayermimic.h"
static_assert(sizeof(ArkPlayerMimic<ArkPlayerMimicOperatorEntity,ArkPlayerMimicEngineeringOperatorCamera,ArkPlayerMimicEngineeringOperatorController>) == 336);
static_assert(sizeof(ArkPlayerMimic<ArkPlayerMimicOperatorEntity,ArkPlayerMimicMilitaryOperatorCamera,ArkPlayerMimicMilitaryOperatorController>) == 1168);
static_assert(sizeof(ArkPlayerMimic<ArkPlayerMimicRigidEntity,ArkPlayerMimicRigidCamera,ArkPlayerMimicRigidController>) == 632);
static_assert(sizeof(ArkPlayerMimic<ArkPlayerMimicTurretEntity,ArkPlayerMimicTurretCamera,ArkPlayerMimicTurretController>) == 152);
...
#include "arkpsipowerblast.h"
static_assert(sizeof(CArkPsiPowerBlast<CArkPsiPower3DTargetingComponent,CArkPsiElectrostaticBurst,ElectrostaticBurstPowerProperties,0>) == 696);
static_assert(sizeof(CArkPsiPowerBlast<CArkPsiPower3DTargetingComponent,CArkPsiFlareBlast,FlarePowerProperties,1>) == 696);
static_assert(sizeof(CArkPsiPowerBlast<CArkPsiPower3DTargetingComponent,CArkPsiKineticBlast,KineticBlastPowerProperties,4>) == 696);
static_assert(sizeof(CArkPsiPowerBlast<CArkPsiPower3DTargetingComponent,CArkPsiThermalBlast,ThermalBlastPowerProperties,2>) == 696);
static_assert(sizeof(CArkPsiPowerBlast<CArkPsiPowerAlienTargetingComponent,CArkPsiFearBlast,FearPowerProperties,9>) == 696);
...
static_assert(sizeof(ArkPsiPowerCyberkinesisProperties::ArkSignalPackageIdProperty) == 32);
static_assert(sizeof(ArkPsiPowerCyberkinesisProperties::ArkTargetingPropertiesProperty) == 32);
static_assert(sizeof(CyberkinesisPowerProperties) == 256);
static_assert(sizeof(CyberkinesisPowerProperties::ArkCommonProperty) == 32);
static_assert(sizeof(CyberkinesisPowerProperties::ArkFactionProperty) == 32);
static_assert(sizeof(CyberkinesisPowerProperties::ArkLevelsProperty) == 32);
...
#include "arkpsipowerfaction.h"
static_assert(sizeof(ArkPsiPowerFactionProperties) == 16);
static_assert(sizeof(ArkPsiPowerFactionProperties::ArkExecuteAudioTriggerProperty) == 32);
static_assert(sizeof(ArkPsiPowerFactionProperties::ArkHostileOnlyProperty) == 32);
...
static_assert(sizeof(ArkPsiPowerHypnosisProperties::ArkSignalPackageIdProperty) == 32);
static_assert(sizeof(ArkPsiPowerHypnosisProperties::ArkTargetingPropertiesProperty) == 32);
static_assert(sizeof(HypnosisPowerProperties) == 256);
static_assert(sizeof(HypnosisPowerProperties::ArkCommonProperty) == 32);
static_assert(sizeof(HypnosisPowerProperties::ArkFactionProperty) == 32);
static_assert(sizeof(HypnosisPowerProperties::ArkLevelsProperty) == 32);
...
#include "arkpsipowersummonpet.h"
static_assert(sizeof(ArkPsiPowerSummonPet<ArkPsiPowerSummonPetMimic,SummonPetMimicPowerProperties>) == 696);
static_assert(sizeof(ArkPsiPowerSummonPet<ArkPsiPowerSummonPetOperator,SummonPetOperatorPowerProperties>) == 696);
static_assert(sizeof(ArkPsiPowerSummonPet<ArkPsiPowerSummonPetTurret,SummonPetTurretPowerProperties>) == 696);

#include "arkpsipowersummonpetoperator.h"
static_assert(sizeof(ArkPsiPowerSummonPetOperatorProperties) == 168);
static_assert(sizeof(ArkPsiPowerSummonPetOperatorProperties::ArkArchetypeProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetOperatorProperties::ArkCooldownDurationSecProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetOperatorProperties::ArkDescriptionProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetOperatorProperties::ArkDisplayNameProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetOperatorProperties::ArkIconProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetOperatorProperties::ArkMaxBoundsProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetOperatorProperties::ArkMinBoundsProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetOperatorProperties::ArkSummonFXAttachmentProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetOperatorProperties::ArkSummonFXProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetOperatorProperties::ArkTargetingPropertiesProperty) == 32);
static_assert(sizeof(ArkPsiPowerSummonPetOperatorProperties::ArkUnsummonFXProperty) == 32);
static_assert(sizeof(SummonPetOperatorPowerProperties) == 248);
static_assert(sizeof(SummonPetOperatorPowerProperties::ArkCommonProperty) == 32);
static_assert(sizeof(SummonPetOperatorPowerProperties::ArkLevelsProperty) == 32);
static_assert(sizeof(SummonPetOperatorPowerProperties::ArkUniqueProperty) == 32);
...
#include "carkpsipower.h"
static_assert(sizeof(CArkPsiPower<BurrowPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<CastMatterPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<CombatFocusPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<ConsumeCorpsePowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<CreatePhantomPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<CyberkinesisPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<ElectrostaticBurstPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<FearPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<FlarePowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<HypnosisPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<KineticBlastPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<KineticShieldPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<LiftPowerProperties>) == 64);
...
static_assert(sizeof(CArkPsiPower<ShiftPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<SmokeFormPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<SummonPetMimicPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<SummonPetOperatorPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<SummonPetTurretPowerProperties>) == 64);
static_assert(sizeof(CArkPsiPower<ThermalBlastPowerProperties>) == 64);
#endif // !MOONCRASH
