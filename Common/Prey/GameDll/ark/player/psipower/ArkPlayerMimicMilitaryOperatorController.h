...
public:
	...
	static inline auto FArkPlayerMimicMilitaryOperatorController = PreyFunction<void(ArkPlayerMimicMilitaryOperatorController* const _this)>(0x13EB380);
	static inline auto FInitialize_Derived = PreyFunction<void(ArkPlayerMimicMilitaryOperatorController* const _this, IEntity& _mimicEntity)>(0x13EB6F0);
	static inline auto FUpdate_Derived = PreyFunction<void(ArkPlayerMimicMilitaryOperatorController* const _this, const float _frameTime, IEntity& _mimicEntity)>(0x13EB850);
	static inline auto FProcessInput = PreyFunction<void(ArkPlayerMimicMilitaryOperatorController* const _this, const CCryName& _actionId, const bool _bPressed)>(0x13EB780);
	static inline auto FSerialize = PreyFunction<void(ArkPlayerMimicMilitaryOperatorController* const _this, TSerialize _ser)>(0x13EB800);
	static inline auto FIsAttacking = PreyFunction<bool(const ArkPlayerMimicMilitaryOperatorController* const _this)>(0x13EB750);
	static inline auto FGetMovementSpeed = PreyFunction<float(const ArkPlayerMimicMilitaryOperatorController* const _this)>(0x13EB6B0);
	static inline auto FGetLaserMuzzlePosition = PreyFunction<Vec3*(const ArkPlayerMimicMilitaryOperatorController* const _this, Vec3* _return_value_)>(0x13EB4D0);
	static inline auto FGetLaserMuzzleRotation = PreyFunction<Quat*(const ArkPlayerMimicMilitaryOperatorController* const _this, Quat* _return_value_)>(0x13EB520);
	static inline auto FGetLaserTargetPosition = PreyFunction<Vec3*(const ArkPlayerMimicMilitaryOperatorController* const _this, Vec3* _return_value_)>(0x13EB570);
};
#endif // !MOONCRASH
