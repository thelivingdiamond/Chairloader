...
public:
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkPsiPowerHypnosisProperties::ArkDisplayNameProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x1443F00);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkPsiPowerHypnosisProperties::ArkDisplayNameProperty* const _this, ArkReflectedObject* const _pObject)>(0x1088870);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkPsiPowerHypnosisProperties::ArkDescriptionProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x10B19D0);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkPsiPowerHypnosisProperties::ArkDescriptionProperty* const _this, ArkReflectedObject* const _pObject)>(0x1093260);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkPsiPowerHypnosisProperties::ArkCooldownDurationSecProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x157DA30);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkPsiPowerHypnosisProperties::ArkCooldownDurationSecProperty* const _this, ArkReflectedObject* const _pObject)>(0x13C06B0);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkPsiPowerHypnosisProperties::ArkSignalPackageIdProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x1084740);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkPsiPowerHypnosisProperties::ArkSignalPackageIdProperty* const _this, ArkReflectedObject* const _pObject)>(0x1082790);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const ArkPsiPowerHypnosisProperties::ArkTargetingPropertiesProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x157DA40);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const ArkPsiPowerHypnosisProperties::ArkTargetingPropertiesProperty* const _this, ArkReflectedObject* const _pObject)>(0x16C41C0);
	};

	static inline auto s_ArkDisplayNameProperty = PreyGlobal<ArkPsiPowerHypnosisProperties::ArkDisplayNameProperty>(0x2D6AA28);
	string m_DisplayName;
	static inline auto s_ArkDescriptionProperty = PreyGlobal<ArkPsiPowerHypnosisProperties::ArkDescriptionProperty>(0x2D6AA48);
	string m_Description;
	static inline auto s_ArkCooldownDurationSecProperty = PreyGlobal<ArkPsiPowerHypnosisProperties::ArkCooldownDurationSecProperty>(0x2D6AA68);
	float m_CooldownDurationSec;
	static inline auto s_ArkSignalPackageIdProperty = PreyGlobal<ArkPsiPowerHypnosisProperties::ArkSignalPackageIdProperty>(0x2D6AA88);
	uint64_t m_SignalPackageId;
	static inline auto s_ArkTargetingPropertiesProperty = PreyGlobal<ArkPsiPowerHypnosisProperties::ArkTargetingPropertiesProperty>(0x2D6AAA8);
	ArkPsiPowerTargetingComponentProperties m_TargetingProperties;
	...
	static inline auto FGetClass = PreyFunction<ArkClass* ()>(0x157FAA0);
};
...
public:
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const HypnosisPowerProperties::ArkCommonProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x14030A0);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const HypnosisPowerProperties::ArkCommonProperty* const _this, ArkReflectedObject* const _pObject)>(0x108CDE0);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const HypnosisPowerProperties::ArkFactionProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x157DA80);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const HypnosisPowerProperties::ArkFactionProperty* const _this, ArkReflectedObject* const _pObject)>(0x13BF510);
	};
	...
	public:
		...
		static inline auto FSetValue = PreyFunction<void(const HypnosisPowerProperties::ArkLevelsProperty* const _this, ArkReflectedObject* const _pObject, const IArkValueBase* _v)>(0x157F390);
		static inline auto FGetMemPtr = PreyFunction<ArkReflectedObject* (const HypnosisPowerProperties::ArkLevelsProperty* const _this, ArkReflectedObject* const _pObject)>(0x157F460);
		static inline auto FIsArray = PreyFunction<bool(const HypnosisPowerProperties::ArkLevelsProperty* const _this)>(0x1A302A0);
		static inline auto FReset = PreyFunction<void(const HypnosisPowerProperties::ArkLevelsProperty* const _this, ArkReflectedObject* _pObject)>(0x157DC20);
	};

	using LevelProperties = ArkPsiPowerHypnosisProperties;
	using UniqueProperties = ArkPsiPowerFactionProperties;

	static inline auto s_ArkCommonProperty = PreyGlobal<HypnosisPowerProperties::ArkCommonProperty>(0x2D6AAC8);
	ArkPsiPowerCommonProperties m_Common;
	static inline auto s_ArkFactionProperty = PreyGlobal<HypnosisPowerProperties::ArkFactionProperty>(0x2D6AAE8);
	ArkPsiPowerFactionProperties m_Faction;
	static inline auto s_ArkLevelsProperty = PreyGlobal<HypnosisPowerProperties::ArkLevelsProperty>(0x2D6AB08);
	std::vector<ArkPsiPowerHypnosisProperties> m_Levels;
	...
	static inline auto FCreate = PreyFunction<ArkReflectedObject* ()>(0x157F9D0);
	static inline auto FGetClass = PreyFunction<ArkClass* ()>(0x157FB40);
	static inline auto FInit = PreyFunction<bool(HypnosisPowerProperties* const _this)>(0x157FC30);
};
#endif // !MOONCRASH
