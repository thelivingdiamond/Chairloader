...
public:
	...
	static float GetFPIKPitchWeight(const ArkPlayerMovementFSM& _arg0_);
	static float GetLeanInput(const ArkPlayerMovementFSM& _arg0_);
	static const char* GetDeathPose();
#endif

	static inline auto FProcessRotation = PreyFunction<void(const ArkPlayerMovementFSM& _fsm, Quat& _rotation, const Ang3 _inputRotation)>(0x16982F0);
	static inline auto FLimitRotation = PreyFunction<void(const ArkPlayerMovementFSM& _fsm, Quat& _rotation)>(0x12DC8D0);
	static inline auto FApplyBleedingMovementDamage = PreyFunction<void(ArkPlayer& _player, const float _damage)>(0x12DA8F0);
	static inline auto FGetMovementInput = PreyFunction<Vec2(const ArkPlayer& _player)>(0x12DC860);
	static inline auto FGetViewHeightInterpolationSpeed = PreyFunction<float(const ArkPlayer& _player)>(0x12DC8B0);
};
...
public:
	...
	static inline auto FEnter = PreyFunction<void(ArkPlayerMovementStates::Cinematic* const _this)>(0x12DA970);
	static inline auto FExit = PreyFunction<void(ArkPlayerMovementStates::Cinematic* const _this)>(0x12DBC70);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMovementStates::Cinematic* const _this, ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E11E0);
	static inline auto FProcessRotation = PreyFunction<void(ArkPlayerMovementStates::Cinematic* const _this, const ArkPlayerMovementFSM& _fsm, Quat& _rotation, const Ang3 _inputRotation)>(0x12DDF00);
};
...
public:
	_smart_ptr<TAction<SAnimationContext>> m_pClimbAction;
	string m_deathPoseHigh;
	string m_deathPoseLow;
	Vec3 m_targetPos;
	Vec3 m_cachedVelocity;
	float m_mediumToHighThreshold;
	bool m_bHighClimb;
	...
	void Exit() { FExit(this); }
	void LoadConfig(const XmlNodeRef& _root) { FLoadConfig(this, _root); }
	const char* GetDeathPose() const { return FGetDeathPose(this); }
	...
	static inline auto FEnter = PreyFunction<void(ArkPlayerMovementStates::Climb* const _this, Vec3 _targetPos)>(0x12DA9B0);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMovementStates::Climb* const _this, ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E12A0);
	static inline auto FExit = PreyFunction<void(ArkPlayerMovementStates::Climb* const _this)>(0x12DBC90);
	static inline auto FLoadConfig = PreyFunction<void(ArkPlayerMovementStates::Climb* const _this, const XmlNodeRef& _root)>(0x12DD470);
	static inline auto FGetDeathPose = PreyFunction<const char* (const ArkPlayerMovementStates::Climb* const _this)>(0x12DC6F0);
};
...
public:
	...
	static inline auto FEnter = PreyFunction<void(ArkPlayerMovementStates::Death* const _this, const float _verticalSpeed)>(0x12DAD30);
	static inline auto FExit = PreyFunction<void(ArkPlayerMovementStates::Death* const _this)>(0x12DC000);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMovementStates::Death* const _this, ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E1470);
};
...
public:
	...
	static inline auto FExit = PreyFunction<void(ArkPlayerMovementStates::DeathByRecyclerGrenade* const _this)>(0x12DC0C0);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMovementStates::DeathByRecyclerGrenade* const _this, ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E18B0);
	static inline auto FLoadConfig = PreyFunction<void(ArkPlayerMovementStates::DeathByRecyclerGrenade* const _this, const XmlNodeRef& _root)>(0x1697C10);
	static inline auto FUpdatePostEffectParam = PreyFunction<void(ArkPlayerMovementStates::DeathByRecyclerGrenade* const _this, const uint64_t _paramId, const ArkInterval<float> _values, const float _timeFactor)>(0x12E5C10);
};

// ArkPlayerMovementStates::Disarming
// Header:  Prey/GameDll/ark/player/ArkPlayerMovementStates.h
class Disarming : public ArkPlayerMovementStates::Base
{ // Size=1 (0x1)
public:
	static void Enter() { FEnter(); }
	static void Update(ArkPlayerMovementFSM& _fsm, const float _frameTime) { FUpdate(_fsm, _frameTime); }

#if 0
	static void ProcessRotation(const ArkPlayerMovementFSM& _arg0_, Quat& _arg1_, const Ang3 _arg2_);
#endif

	static inline auto FEnter = PreyFunction<void()>(0x12DADC0);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E19C0);
};
...
public:
	...
	static inline auto FEnter = PreyFunction<void(ArkPlayerMovementStates::Fall* const _this)>(0x12DADE0);
	static inline auto FExit = PreyFunction<void(ArkPlayerMovementStates::Fall* const _this)>(0x12DC120);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMovementStates::Fall* const _this, ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E1A00);
	static inline auto FOnCollision = PreyFunction<void(ArkPlayerMovementStates::Fall* const _this, const EventPhysCollision& _event)>(0x12DDDE0);
	static inline auto FGetDeathPose = PreyFunction<const char* (const ArkPlayerMovementStates::Fall* const _this)>(0x547450);
};
...
public:
	...
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x1333E90);
	static inline auto FEnter = PreyFunction<void()>(0x12DC1C0);
	static inline auto FExit = PreyFunction<void()>(0x12DC1C0);
};

// ArkPlayerMovementStates::Glooed
// Header:  Prey/GameDll/ark/player/ArkPlayerMovementStates.h
class Glooed : public ArkPlayerMovementStates::Base
{ // Size=1 (0x1)
public:
	static void Enter() { FEnter(); }
	static void Update(ArkPlayerMovementFSM& _fsm, const float _frameTime) { FUpdate(_fsm, _frameTime); }
	...
	static inline auto FEnter = PreyFunction<void()>(0x12DAE20);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x1333E90);
};
...
public:
	...
	static inline auto FEnter = PreyFunction<void(ArkPlayerMovementStates::GravShaftG* const _this)>(0x12DAE40);
	static inline auto FSetDesiredViewDirection = PreyFunction<void(ArkPlayerMovementStates::GravShaftG* const _this, const Vec3& _direction)>(0x12E0210);
	static inline auto FUpdate = PreyFunction<void(const ArkPlayerMovementStates::GravShaftG* const _this, ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E23D0);
};
...
public:
	...
	static inline auto FSetDesiredViewDirection = PreyFunction<void(ArkPlayerMovementStates::GravShaftToG* const _this, const Vec3& _direction)>(0x12E03D0);
	static inline auto FEnter = PreyFunction<void(ArkPlayerMovementStates::GravShaftToG* const _this)>(0x12DAED0);
	static inline auto FExit = PreyFunction<void(ArkPlayerMovementStates::GravShaftToG* const _this)>(0x12DC1E0);
	static inline auto FGetViewHeightInterpolationSpeed = PreyFunction<float(const ArkPlayerMovementStates::GravShaftToG* const _this, const ArkPlayer& _player)>(0x12DC8C0);
	static inline auto FUpdate = PreyFunction<void(const ArkPlayerMovementStates::GravShaftToG* const _this, ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E27E0);
	static inline auto FGetFPIKPitchWeight = PreyFunction<float(const ArkPlayerMovementFSM& _fsm)>(0x12DC710);
};
...
public:
	...
	static inline auto FSetDesiredViewDirection = PreyFunction<void(ArkPlayerMovementStates::GravShaftZeroG* const _this, const Vec3& _direction)>(0x12E0890);
	static inline auto FEnter = PreyFunction<void(ArkPlayerMovementStates::GravShaftZeroG* const _this)>(0x12DAF60);
	static inline auto FGetViewHeightInterpolationSpeed = PreyFunction<float(const ArkPlayerMovementStates::GravShaftZeroG* const _this, const ArkPlayer& _player)>(0x12DC8C0);
	static inline auto FUpdate = PreyFunction<void(const ArkPlayerMovementStates::GravShaftZeroG* const _this, ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E30A0);
	static inline auto FProcessRotation = PreyFunction<void(ArkPlayerMovementStates::GravShaftZeroG* const _this, const ArkPlayerMovementFSM& _fsm, Quat& _rotation, const Ang3 _inputRotation)>(0x12DE290);
};
...
public:
	...
	float m_bonusVelocity;
	float m_startHeight;
	float m_addJumpHeightOnSlope;
	float m_addJumpHeightOnMaxSlopeLowG;
	ArkSimpleTimer m_maxJumpTimer;
	...
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMovementStates::Jump* const _this, ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E30F0);
	static inline auto FEnter = PreyFunction<void(ArkPlayerMovementStates::Jump* const _this)>(0x12DAF80);
	static inline auto FGetDeathPose = PreyFunction<const char* (const ArkPlayerMovementStates::Jump* const _this)>(0x598E60);
};
...
public:
	...
	static inline auto FLiftOv2 = PreyFunction<void(ArkPlayerMovementStates::Lift* const _this)>(0x12D9FE0);
	static inline auto FEnter = PreyFunction<void(ArkPlayerMovementStates::Lift* const _this)>(0x12DB560);
	static inline auto FExit = PreyFunction<void(ArkPlayerMovementStates::Lift* const _this)>(0x12DC280);
	static inline auto FLoadConfig = PreyFunction<void(ArkPlayerMovementStates::Lift* const _this, const XmlNodeRef& _root)>(0x12DD520);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMovementStates::Lift* const _this, ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E33B0);
	static inline auto FOnCollision = PreyFunction<void(ArkPlayerMovementStates::Lift* const _this, ArkPlayerMovementFSM& _fsm, const EventPhysCollision& _event)>(0x12DDE00);
};
...
public:
	...
	static inline auto FEnter = PreyFunction<void(ArkPlayerMovementStates::Mimic* const _this)>(0x12DB590);
	static inline auto FExit = PreyFunction<void(ArkPlayerMovementStates::Mimic* const _this)>(0x12DC290);
};
...
public:
	...
	static inline auto FShiftOv2 = PreyFunction<void(ArkPlayerMovementStates::Shift* const _this)>(0x12DA010);
	static inline auto FStop = PreyFunction<void(ArkPlayerMovementStates::Shift* const _this)>(0x12E1110);
	static inline auto FSetTargetPosition = PreyFunction<void(ArkPlayerMovementStates::Shift* const _this, const Vec3& _position)>(0x12E0E20);
	static inline auto FSetTargetRotation = PreyFunction<void(ArkPlayerMovementStates::Shift* const _this, const Quat& _rotation)>(0x12E0F10);
	static inline auto FEnter = PreyFunction<void(ArkPlayerMovementStates::Shift* const _this)>(0x12DB5E0);
	static inline auto FExit = PreyFunction<void(ArkPlayerMovementStates::Shift* const _this)>(0x12DC310);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMovementStates::Shift* const _this, ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E3610);
	static inline auto FLoadConfig = PreyFunction<void(ArkPlayerMovementStates::Shift* const _this, const XmlNodeRef& _root)>(0x12DD5F0);
	static inline auto FLimitRotation = PreyFunction<void(const ArkPlayerMovementStates::Shift* const _this, const ArkPlayerMovementFSM& _fsm, Quat& _rotation)>(0x12DCFA0);
	static inline auto FGetFPIKPitchWeight = PreyFunction<float(const ArkPlayerMovementStates::Shift* const _this, const ArkPlayerMovementFSM& _fsm)>(0x12DC780);
};
...
public:
	...
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMovementStates::Slide* const _this, ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E38F0);
	static inline auto FEnter = PreyFunction<void(ArkPlayerMovementStates::Slide* const _this)>(0x12DB820);
	static inline auto FExit = PreyFunction<void(const ArkPlayerMovementStates::Slide* const _this)>(0x12DC360);
	static inline auto FLimitRotation = PreyFunction<void(const ArkPlayerMovementFSM& _fsm, Quat& _rotation)>(0x12DCFC0);
	static inline auto FGetDeathPose = PreyFunction<const char* (const ArkPlayerMovementStates::Slide* const _this)>(0x12DC700);
	static inline auto FStand = PreyFunction<void(ArkPlayerMovementFSM& _fsm)>(0x12E10B0);
};
...
public:
	...
	static inline auto FLoadConfig = PreyFunction<void(ArkPlayerMovementStates::Smoke* const _this, const XmlNodeRef& _root)>(0x12DD650);
	static inline auto FUpdate = PreyFunction<void(const ArkPlayerMovementStates::Smoke* const _this, ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E3F80);
	static inline auto FProcessRotation = PreyFunction<void(ArkPlayerMovementStates::Smoke* const _this, const ArkPlayerMovementFSM& _fsm, Quat& _rotation, const Ang3 _inputRotation)>(0x12DE600);
	static inline auto FEnter = PreyFunction<void(ArkPlayerMovementStates::Smoke* const _this)>(0x12DB920);
	static inline auto FExit = PreyFunction<void()>(0x12DC3F0);
};
...
public:
	...
	public:
		...
		static inline auto FZeroGParamsOv2 = PreyFunction<void(ArkPlayerMovementStates::ZeroG::ZeroGParams* const _this, const XmlNodeRef& _root)>(0x12DA050);
		static inline auto FGetMaxSpeed = PreyFunction<float(const ArkPlayerMovementStates::ZeroG::ZeroGParams* const _this)>(0x12DC790);
	};
	...
	static inline auto FZeroGOv2 = PreyFunction<void(ArkPlayerMovementStates::ZeroG* const _this)>(0x1694A40);
	static inline auto FEnter = PreyFunction<void(ArkPlayerMovementStates::ZeroG* const _this)>(0x12DB9B0);
	static inline auto FExit = PreyFunction<void(ArkPlayerMovementStates::ZeroG* const _this)>(0x12DC410);
	static inline auto FLoadConfig = PreyFunction<void(ArkPlayerMovementStates::ZeroG* const _this, const XmlNodeRef& _root)>(0x12DD6A0);
	static inline auto FPostSerialize = PreyFunction<void(ArkPlayerMovementStates::ZeroG* const _this)>(0x12DDED0);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerMovementStates::ZeroG* const _this, ArkPlayerMovementFSM& _fsm, const float _frameTime)>(0x12E45F0);
	static inline auto FProcessRotation = PreyFunction<void(ArkPlayerMovementStates::ZeroG* const _this, const ArkPlayerMovementFSM& _fsm, Quat& _rotation, const Ang3 _inputRotation)>(0x12DF450);
	static inline auto FGetMovementInput = PreyFunction<Vec2*(const ArkPlayerMovementStates::ZeroG* const _this, Vec2* _return_value_, const ArkPlayer& _player)>(0x12DC890);
	static inline auto FSetGameNoise = PreyFunction<void(ArkPlayerMovementStates::ZeroG* const _this, IEntity& _playerEntity, bool _bActive)>(0x12E0CE0);
	static inline auto FTrySetStance = PreyFunction<void(const EStance _newStance)>(0x12E1190);
};
