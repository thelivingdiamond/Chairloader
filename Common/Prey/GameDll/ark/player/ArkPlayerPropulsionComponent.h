...
// Header: FromCpp
// Prey/GameDll/ark/player/ArkPlayerPropulsionComponent.h
class ArkPlayerPropulsionComponent : public IArkStatsListener // Id=801718B Size=88
{
public:
	...
	static inline auto FLoadConfig = PreyFunction<void(ArkPlayerPropulsionComponent *const _this, XmlNodeRef const &_node)>(0x1245140);
	...
	static inline auto FOnStatChange = PreyFunction<void(ArkPlayerPropulsionComponent *const _this, const unsigned _ownerId, CCryName const &_stat64i32, const float _previousValue, const float _newValue)>(0x1245370);
	...
	static inline auto FUpdateGameNoisePosition = PreyFunction<void(ArkPlayerPropulsionComponent const *const _this)>(0x1245C50);
