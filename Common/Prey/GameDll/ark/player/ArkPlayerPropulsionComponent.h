...
public:
	...
	int m_jetPackNoiseId;
	unsigned m_cameraRotationHandle;
	unsigned m_propulsionForceHandle;
	unsigned m_propulsionDurationHandle;
	float m_glideCameraAmplitude;
	float m_glideCameraFrequency;
	float m_glideCameraNoise;
	float m_glideCameraMinFalloff;
	...
	bool m_bPropulsionActive;
	bool m_bDisrupted;
	bool m_bHasPropulsionSuit;
	ArkSimpleTimer m_cameraFallOffTimer;
	ArkSimpleCharge m_glideCharge;
	ArkAudioTrigger m_triggerGlideStart;
	ArkAudioTrigger m_triggerGlideStop;
	bool m_bDropActive;
	ArkTimeRemaining m_dropDamageTimer;
	uint64_t m_explosionSignalPackage;
	uint64_t m_cameraShakeId;
	ArkAudioTrigger m_triggerExplosion;
	ArkAudioTrigger m_triggerDropStart;
	ArkAudioTrigger m_triggerDropEnd;
	ArkFireAndForgetEffect m_explosionVfx;
	ArkSimpleTimer m_thrusterRecoveryTimer;
	ArkAudioTrigger m_triggerThrusterAudio;
	...
	bool StartPropulsion(bool _bForce) { return FStartPropulsion(this, _bForce); }
	void StopPropulsion() { FStopPropulsion(this); }
	bool FireThruster(bool _bRecov) { return FFireThruster(this, _bRecov); }
	bool StartDrop(bool _bForce) { return FStartDrop(this, _bForce); }
	bool IsDropActive() const { return FIsDropActive(this); }
	bool DropDamageTimer(const float _frameTime) { return FDropDamageTimerOv1(this, _frameTime); }
	void ActivateDropDamage() { FActivateDropDamage(this); }
	void SetDisrupted(bool _bDisrupted) { FSetDisrupted(this, _bDisrupted); }
	void Serialize(TSerialize& _ser) { FSerialize(this, _ser); }
	virtual void OnStatChange(const unsigned _ownerId, const CCryName& _stat64i32, const float _previousValue, const float _newValue);
	void StartEmittingGameNoise() { FStartEmittingGameNoise(this); }
	void StopEmittingGameNoise() { FStopEmittingGameNoise(this); }
	void UpdateGameNoisePosition() const { FUpdateGameNoisePosition(this); }
	bool GrantPropulsionSuit(float _propulsionForce, float _propulsionDuration) { return FGrantPropulsionSuit(this, _propulsionForce, _propulsionDuration); }
	void HandlePropulsionCameraRotation(Ang3& _rotation, float _frameTime) { FHandlePropulsionCameraRotation(this, _rotation, _frameTime); }
	...
	bool CanStartPropulsion() const;
	bool IsShowingUI() const;
	void DropDamageTimer(bool _arg0_);
	void FireGameNoise();
	void RevokePropulsionSuit();
	bool HasPropulsionSuit() const;
#endif

	static inline auto FArkPlayerPropulsionComponentOv1 = PreyFunction<void(ArkPlayerPropulsionComponent* const _this)>(0x12E5F80);
	static inline auto FLoadConfig = PreyFunction<void(ArkPlayerPropulsionComponent* const _this, const XmlNodeRef& _node)>(0x12E67F0);
	static inline auto FUpdate = PreyFunction<void(ArkPlayerPropulsionComponent* const _this, const float _frameTime)>(0x12E7680);
	static inline auto FReset = PreyFunction<void(ArkPlayerPropulsionComponent* const _this)>(0x12E6CF0);
	static inline auto FStartPropulsion = PreyFunction<bool(ArkPlayerPropulsionComponent* const _this, bool _bForce)>(0x12E7430);
	static inline auto FStopPropulsion = PreyFunction<void(ArkPlayerPropulsionComponent* const _this)>(0x12E7580);
	static inline auto FFireThruster = PreyFunction<bool(ArkPlayerPropulsionComponent* const _this, bool _bRecov)>(0x12E6370);
	static inline auto FStartDrop = PreyFunction<bool(ArkPlayerPropulsionComponent* const _this, bool _bForce)>(0x12E7210);
	static inline auto FIsDropActive = PreyFunction<bool(const ArkPlayerPropulsionComponent* const _this)>(0x12E67E0);
	static inline auto FDropDamageTimerOv1 = PreyFunction<bool(ArkPlayerPropulsionComponent* const _this, const float _frameTime)>(0x12E6360);
	static inline auto FActivateDropDamage = PreyFunction<void(ArkPlayerPropulsionComponent* const _this)>(0x12E6120);
	static inline auto FSetDisrupted = PreyFunction<void(ArkPlayerPropulsionComponent* const _this, bool _bDisrupted)>(0x12E6FA0);
	static inline auto FSerialize = PreyFunction<void(ArkPlayerPropulsionComponent* const _this, TSerialize& _ser)>(0x12E6DE0);
	static inline auto FOnStatChange = PreyFunction<void(ArkPlayerPropulsionComponent* const _this, const unsigned _ownerId, const CCryName& _stat64i32, const float _previousValue, const float _newValue)>(0x12E6C50);
	static inline auto FStartEmittingGameNoise = PreyFunction<void(ArkPlayerPropulsionComponent* const _this)>(0x12E7370);
	static inline auto FStopEmittingGameNoise = PreyFunction<void(ArkPlayerPropulsionComponent* const _this)>(0x12E7540);
	static inline auto FUpdateGameNoisePosition = PreyFunction<void(const ArkPlayerPropulsionComponent* const _this)>(0x12E7960);
	static inline auto FGrantPropulsionSuit = PreyFunction<bool(ArkPlayerPropulsionComponent* const _this, float _propulsionForce, float _propulsionDuration)>(0x12E6520);
	static inline auto FHandlePropulsionCameraRotation = PreyFunction<void(ArkPlayerPropulsionComponent* const _this, Ang3& _rotation, float _frameTime)>(0x12E66F0);
};
#endif // !MOONCRASH
