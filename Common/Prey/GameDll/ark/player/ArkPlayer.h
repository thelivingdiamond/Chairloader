...
public:
	...
	const ArkEquipmentModComponent& GetChipsetComponent(const bool _arg0_) const;
	ArkEquipmentModComponent& GetChipsetComponent(const bool _arg0_);
	...
	void HideLegs(bool _arg0_) const;
	...
	static inline auto FArkPlayer = PreyFunction<void(ArkPlayer* const _this)>(0x154D580);
	...
	static inline auto FGetPsiPowerComponentOv0 = PreyFunction<const ArkPsiPowerComponent& (const ArkPlayer* const _this)>(0x154FC50);
	static inline auto FGetStance = PreyFunction<EStance(const ArkPlayer* const _this)>(0x154FF40);
	static inline auto FIsZeroG = PreyFunction<bool(const ArkPlayer* const _this)>(0x1551840);
	static inline auto FGetInventory = PreyFunction<IInventory* (const ArkPlayer* const _this)>(0x158AEF0);
	static inline auto FGetHealth = PreyFunction<float(const ArkPlayer* const _this)>(0x154FA40);
	...
	static inline auto FGetMaxHealth = PreyFunction<float(const ArkPlayer* const _this)>(0x154FB10);
	static inline auto FSetViewRotation = PreyFunction<void(ArkPlayer* const _this, const Quat& _rotation)>(0x1557D90);
	static inline auto FGetViewRotation = PreyFunction<Quat*(const ArkPlayer* const _this, Quat* _return_value_)>(0x154FF50);
	static inline auto FGetMemoryUsage = PreyFunction<void(const ArkPlayer* const _this, ICrySizer* _pSizer)>(0x154FB30);
	static inline auto FGetCurrentItem = PreyFunction<IItem* (const ArkPlayer* const _this)>(0x158AEF0);
	static inline auto FGetLinkedEntity = PreyFunction<IEntity* (const ArkPlayer* const _this)>(0x158AEF0);
	static inline auto FGetSpectatorMode = PreyFunction<uint8_t(const ArkPlayer* const _this)>(0xDD23F0);
	static inline auto FIsDead = PreyFunction<bool(const ArkPlayer* const _this)>(0x1551450);
	static inline auto FRelease = PreyFunction<void(ArkPlayer* const _this)>(0xA97D40);
	static inline auto FIsPsiTargeting = PreyFunction<bool(const ArkPlayer* const _this)>(0x1551560);
	static inline auto FGetAnimatedCharacterOv1 = PreyFunction<const IAnimatedCharacter* (const ArkPlayer* const _this)>(0x154F7A0);
	static inline auto FGetAnimatedCharacterOv0 = PreyFunction<IAnimatedCharacter* (ArkPlayer* const _this)>(0x154F7A0);
	static inline auto FGetLocalEyePos = PreyFunction<Vec3*(const ArkPlayer* const _this, Vec3* _return_value_)>(0x154FAD0);
	static inline auto FGetMovementController = PreyFunction<IMovementController* (const ArkPlayer* const _this)>(0x154FC40);
	...
	static inline auto FUpdatePropulsionPackVisibility = PreyFunction<void(const ArkPlayer* const _this)>(0x1558CB0);
	static inline auto FGetScaledInputRotation = PreyFunction<Ang3*(ArkPlayer* const _this, Ang3* _return_value_, float _frameTime)>(0x154FCC0);
	...
	static inline auto FSetAnimationTag = PreyFunction<void(const ArkPlayer* const _this, const char* _tagName, const bool _bTagState)>(0x1557020);
	...
	static inline auto FPlayFragment = PreyFunction<_smart_ptr<TAction<SAnimationContext> >*(ArkPlayer* const _this, _smart_ptr<TAction<SAnimationContext> >* _return_value_, const char* _pName, IArkPlayer::EArkPlayerAnimationPriority _priority, const unsigned _flags)>(0x1553080);
	...
	static inline auto FExecuteGroundMaterialEffectByName = PreyFunction<void(const ArkPlayer* const _this, const char* const _pName, SMFXRunTimeEffectParams& _params)>(0x154F0F0);
	static inline auto FHide = PreyFunction<void(const ArkPlayer* const _this, const bool _bHide)>(0x1550370);
	static inline auto FOnJump = PreyFunction<void(ArkPlayer* const _this)>(0x1551B50);
	static inline auto FShowThirdPerson = PreyFunction<void(const ArkPlayer* const _this, const bool _bShow)>(0x1557E20);
	static inline auto FRagdollize = PreyFunction<void(ArkPlayer* const _this, const float _verticalSpeed)>(0x1555000);
	static inline auto FGetSex = PreyFunction<EPlayerSex(const ArkPlayer* const _this)>(0x154FE20);
	...
	static inline auto FHasAbility = PreyFunction<bool(const ArkPlayer* const _this, const uint64_t _abilityID)>(0x1550330);
	static inline auto FSetModel = PreyFunction<void(ArkPlayer* const _this, const char* const _modelName)>(0x15575F0);
	static inline auto FIsInGravShaft = PreyFunction<bool(const ArkPlayer* const _this)>(0x15514C0);
	static inline auto FLimitAttentionOnUnseenPlayer = PreyFunction<void(const ArkPlayer* const _this)>(0x15518D0);
	static inline auto FReleaseAttentionLimitOnPlayer = PreyFunction<void(const ArkPlayer* const _this)>(0x1555980);
	static inline auto FIsInCombat = PreyFunction<bool(const ArkPlayer* const _this)>(0x15514A0);
	static inline auto FOnCombatChange = PreyFunction<void(IArkPlayerCombatListener* const _this, bool _bInCombat)>(0x1551B30);
	static inline auto FCompensateStanceHeightChange = PreyFunction<void(ArkPlayer* const _this, const EStance _oldStance, const EStance _newStance)>(0x154EA50);
	static inline auto FGetAttackTargetPos = PreyFunction<Vec3*(const ArkPlayer* const _this, Vec3* _return_value_)>(0x154F7C0);
	static inline auto FUpdateCachedReticleViewPosAndDir = PreyFunction<void(ArkPlayer* const _this)>(0x15583F0);
	static inline auto FGetReticleViewPositionAndDir = PreyFunction<std::pair<Vec3, Vec3>*(const IArkPlayer* const _this, std::pair<Vec3, Vec3>* _return_value_)>(0x154FC80);
	static inline auto FOnNewGame = PreyFunction<void(ArkPlayer* const _this)>(0x1551BE0);
	static inline auto FGetPlayerWorldEyePos = PreyFunction<Vec3*(const ArkPlayer* const _this, Vec3* _return_value_)>(0x131F920);
	static inline auto FGetFragmentIds = PreyFunction<const CTagDefinition* (const ArkPlayer* const _this)>(0x154F9E0);
	static inline auto FKnockdown = PreyFunction<void(ArkPlayer* const _this)>(0x1551850);
	static inline auto FEnterMimicGrabSequence = PreyFunction<void(ArkPlayer* const _this, const IEntity& _mimicEntity)>(0x154EC00);
	static inline auto FExitMimicGrabSequence = PreyFunction<void(ArkPlayer* const _this)>(0x154F1A0);
	static inline auto FIsSafeForAutoSave = PreyFunction<EArkSaveFailure(const ArkPlayer* const _this)>(0x1551580);
	static inline auto FSetRoomEntityId = PreyFunction<void(ArkPlayer* const _this, unsigned _id)>(0x15577E0);
	static inline auto FIsMimicOv1 = PreyFunction<bool(const ArkPlayer* const _this)>(0x1551530);
	static inline auto FIsMimicOv0 = PreyFunction<bool(const ArkPlayer* const _this, const unsigned _entityId)>(0x15514D0);
	static inline auto FGetMimicEntity = PreyFunction<const IEntity* (const ArkPlayer* const _this)>(0x154FB80);
	static inline auto FGetMimicEntityId = PreyFunction<unsigned(const ArkPlayer* const _this)>(0x154FBF0);
	static inline auto FIsAlternateForm = PreyFunction<bool(const ArkPlayer* const _this)>(0x15513F0);
	static inline auto FIsShifting = PreyFunction<bool(const ArkPlayer* const _this)>(0x1551650);
	...
	static inline auto FEnableIdleBreak = PreyFunction<void(IArkPlayer* const _this, const bool _bEnable)>(0x154EBF0);
	static inline auto FSerializeLevelToLevel = PreyFunction<void(ArkPlayer* const _this, TSerialize& _ser)>(0x1556C20);
	static inline auto FShouldGenerateGameNoises = PreyFunction<bool(const ArkPlayer* const _this)>(0x1557DF0);
	static inline auto FUpdateShadow = PreyFunction<void(const ArkPlayer* const _this, bool _b3PShadow)>(0x1558D30);
	...
	static inline auto FHideAttachment = PreyFunction<void(const ArkPlayer* const _this, const char* _attachmentName, bool _bHide)>(0x15503B0);
	...
	static inline auto FOnSystemEvent = PreyFunction<void(ISystemEventListener* const _this, ESystemEvent event, uint64_t wparam, uint64_t lparam)>(0x1551C80);
	...
	static inline auto FReloadExtension = PreyFunction<bool(ArkPlayer* const _this, IGameObject* _pGameObject, const SEntitySpawnParams& _params)>(0xDD23F0);
	static inline auto FPostReloadExtension = PreyFunction<void(ArkPlayer* const _this, IGameObject* _pGameObject, const SEntitySpawnParams& _params)>(0xA13080);
	...
	static inline auto FGetSpawnInfo = PreyFunction<_smart_ptr<ISerializableInfo>*(ArkPlayer* const _this, _smart_ptr<ISerializableInfo>* _return_value_)>(0x13883F0);
	static inline auto FHandleEvent = PreyFunction<void(ArkPlayer* const _this, const SGameObjectEvent& _event)>(0x154FF80);
	...
	static inline auto FGetHealthAsRoundedPercentage = PreyFunction<int(const ArkPlayer* const _this)>(0x158AEF0);
	static inline auto FSetMaxHealth = PreyFunction<void(ArkPlayer* const _this, float _maxHealth)>(0xA13080);
	static inline auto FGetArmor = PreyFunction<int(const ArkPlayer* const _this)>(0x158AEF0);
	static inline auto FGetMaxArmor = PreyFunction<int(const ArkPlayer* const _this)>(0x158AEF0);
	static inline auto FIsFallen = PreyFunction<bool(const ArkPlayer* const _this)>(0xDD23F0);
	...
	static inline auto FGetGrabbedEntityId = PreyFunction<unsigned(const ArkPlayer* const _this)>(0x158AEF0);
	static inline auto FHideAllAttachments = PreyFunction<void(ArkPlayer* const _this, bool _bIsHiding)>(0xA13080);
	static inline auto FSetIKPos = PreyFunction<void(ArkPlayer* const _this, const char* _pLimbName, const Vec3& _goalPos, int _priority)>(0xA13080);
	static inline auto FIsFriendlyEntity = PreyFunction<bool(const ArkPlayer* const _this, unsigned _entityId, bool _bUsingAIIgnorePlayer)>(0xDD23F0);
	...
	static inline auto FGetHolsteredItem = PreyFunction<IItem* (const ArkPlayer* const _this)>(0x158AEF0);
	...
	static inline auto FIsThirdPerson = PreyFunction<bool(const ArkPlayer* const _this)>(0xDD23F0);
	static inline auto FToggleThirdPerson = PreyFunction<void(ArkPlayer* const _this)>(0xA13080);
	static inline auto FIsPlayer = PreyFunction<bool(const ArkPlayer* const _this)>(0x1B933B0);
	static inline auto FIsClient = PreyFunction<bool(const ArkPlayer* const _this)>(0x1B933B0);
	static inline auto FIsMigrating = PreyFunction<bool(const ArkPlayer* const _this)>(0xDD23F0);
	static inline auto FSetMigrating = PreyFunction<void(ArkPlayer* const _this, bool _bIsMigrating)>(0xA13080);
	static inline auto FGetActorClassName = PreyFunction<const char* (const ArkPlayer* const _this)>(0x154F790);
	static inline auto FGetActorClass = PreyFunction<int(const ArkPlayer* const _this)>(0x158AEF0);
	static inline auto FSerializeXML = PreyFunction<void(ArkPlayer* const _this, XmlNodeRef& _node, bool _bLoading)>(0xA13080);
	static inline auto FPlayExactPositioningAnimation = PreyFunction<void(ArkPlayer* const _this, const char* _pAnimationName, bool _bSignal, const Vec3& _position, const Vec3& _direction, float _startWidth, float _startArcAngle, float _directionTolerance)>(0xA13080);
	...
	static inline auto FShouldMuteWeaponSoundStimulus = PreyFunction<bool(const ArkPlayer* const _this)>(0xDD23F0);
	...
	static inline auto FGetEntityClassName = PreyFunction<const char* (const ArkPlayer* const _this)>(0x154F9B0);
	static inline auto FOnPreparedFromPool = PreyFunction<void(ArkPlayer* const _this)>(0xA13080);
	static inline auto FGetEventPriority = PreyFunction<int(const ArkPlayer* const _this, const int _eventID)>(0x154F9C0);
	static inline auto FGetTeamId = PreyFunction<int(const ArkPlayer* const _this)>(0x158AEF0);
	static inline auto FGetBoneTransform = PreyFunction<const QuatT& (const ArkPlayer* const _this, int ID)>(0x154F910);
	static inline auto FInhibitRotation = PreyFunction<void(IArkPlayer* const _this, const bool _bInhibit)>(0x1550460);
