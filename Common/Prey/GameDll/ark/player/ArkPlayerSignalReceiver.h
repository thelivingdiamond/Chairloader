...
public:
	...
	static inline auto FArkPlayerSignalReceiverOv1 = PreyFunction<void(ArkPlayerSignalReceiver* const _this)>(0x169B4D0);
	static inline auto FInit = PreyFunction<void(ArkPlayerSignalReceiver* const _this, const unsigned& _entityId)>(0x169C530);
	static inline auto FOnReceiveSignal = PreyFunction<void(ArkPlayerSignalReceiver* const _this, const ArkSignalSystem::Package& _package)>(0x169C570);
	static inline auto FGetPackageSignalRampContainer = PreyFunction<ArkSignalSystem::PackageSignalRampContainer* (ArkPlayerSignalReceiver* const _this)>(0x10ED4B0);
};
#endif // !MOONCRASH
