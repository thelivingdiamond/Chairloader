...
// ArkCystoid
// Header:  Prey/GameDll/ark/cystoid/ArkCystoid.h
class ArkCystoid
	: public CGameObjectExtensionHelper<ArkCystoid, IGameObjectExtension>
...
public:
	...
	virtual void SetAuthority(bool auth);
	virtual void GetMemoryUsage(ICrySizer* s) const;
	void UpdateCystoid(const float _timeDelta, const Vec3& _playerPos) { FUpdateCystoid(this, _timeDelta, _playerPos); }
	void PostSerializeCystoid() { FPostSerializeCystoid(this); }
	void ReceiveSignalPackage(const ArkSignalSystem::Package& _package) { FReceiveSignalPackage(this, _package); }
	void RegisterForSignals(bool _bRegister) { FRegisterForSignals(this, _bRegister); }
	void FollowTarget(const unsigned& _newTarget) { FFollowTarget(this, _newTarget); }
	float GetUpdateRate() const { return FGetUpdateRate(this); }
	bool TestTarget(unsigned _target) const { return FTestTarget(this, _target); }
	...
	void NotifyOfSwarmMemberAdded(ArkCystoid* _pCystoid) const { FNotifyOfSwarmMemberAdded(this, _pCystoid); }
	bool IsSwarmLeader() const { return FIsSwarmLeader(this); }
	bool CanHypnotize(const unsigned _source) const { return FCanHypnotize(this, _source); }
	bool HandleHypnotize(const unsigned _source) { return FHandleHypnotize(this, _source); }
	void OnSpawnedByWeaver() { FOnSpawnedByWeaver(this); }
	void Explode() { FExplode(this); }
	void SetState(EArkCystoidState _state, bool _bForce) { FSetState(this, _state, _bForce); }
	...
	float GetDistanceSqToTarget() const { return FGetDistanceSqToTarget(this); }
	void SpawnStateVFX(IParticleEffect* _pParticleEffect) { FSpawnStateVFX(this, _pParticleEffect); }
	void ProcessNearbyCystoids(float _nearbyRange, void (*_pFunc)(const ArkCystoid* const, ArkCystoid* const)) { FProcessNearbyCystoids(this, _nearbyRange, _pFunc); }
	static void LureCystoid(const ArkCystoid* const _pSourceCystoid, ArkCystoid* const _pNearbyCystoid) { FLureCystoid(_pSourceCystoid, _pNearbyCystoid); }
	...
	bool IsDead() const;
	unsigned GetSwarmLeader() const;
	void SetProperties(const ArkCystoidProperties* _arg0_);
	void SpawnParticle(IParticleEffect* _arg0_) const;
	void HandleScriptEvent(const char* _arg0_);
	void EnableAttentionObject();
	void DisableAttentionObject();
#endif

	static inline auto FArkCystoid = PreyFunction<void(ArkCystoid* const _this)>(0x152F850);
	static inline auto FInit = PreyFunction<bool(ArkCystoid* const _this, IGameObject* _pGameObject)>(0x1530E40);
	static inline auto FInitClient = PreyFunction<void(ArkCystoid* const _this, int channelId)>(0x1333E90);
	static inline auto FPostInit = PreyFunction<void(ArkCystoid* const _this, IGameObject* _pGameObject)>(0x1532340);
	static inline auto FPostInitClient = PreyFunction<void(ArkCystoid* const _this, int channelId)>(0x1333E90);
	static inline auto FReloadExtension = PreyFunction<bool(ArkCystoid* const _this, IGameObject* pGameObject, const SEntitySpawnParams& params)>(0x13B0900);
	static inline auto FPostReloadExtension = PreyFunction<void(ArkCystoid* const _this, IGameObject* pGameObject, const SEntitySpawnParams& params)>(0x1333E90);
	static inline auto FGetEntityPoolSignature = PreyFunction<bool(ArkCystoid* const _this, TSerialize signature)>(0x13B0900);
	static inline auto FRelease = PreyFunction<void(ArkCystoid* const _this)>(0x3E3960);
	static inline auto FFullSerialize = PreyFunction<void(ArkCystoid* const _this, TSerialize _ser)>(0x1530570);
	static inline auto FNetSerialize = PreyFunction<bool(ArkCystoid* const _this, TSerialize ser, EEntityAspects aspect, uint8_t profile, int flags)>(0x1A302A0);
	static inline auto FPostSerialize = PreyFunction<void(ArkCystoid* const _this)>(0x1532620);
	static inline auto FSerializeSpawnInfo = PreyFunction<void(ArkCystoid* const _this, TSerialize ser)>(0x1333E90);
	static inline auto FGetSpawnInfo = PreyFunction<_smart_ptr<ISerializableInfo>*(ArkCystoid* const _this, _smart_ptr<ISerializableInfo>* _return_value_)>(0x361570);
	static inline auto FUpdate = PreyFunction<void(ArkCystoid* const _this, SEntityUpdateContext& ctx, int updateSlot)>(0x1333E90);
	static inline auto FPostUpdate = PreyFunction<void(ArkCystoid* const _this, float frameTime)>(0x1333E90);
	static inline auto FPostRemoteSpawn = PreyFunction<void(ArkCystoid* const _this)>(0x1333E90);
	static inline auto FHandleEvent = PreyFunction<void(ArkCystoid* const _this, const SGameObjectEvent& _event)>(0x1530B10);
	static inline auto FProcessEvent = PreyFunction<void(ArkCystoid* const _this, SEntityEvent& _event)>(0x1532690);
	static inline auto FSetChannelId = PreyFunction<void(ArkCystoid* const _this, uint16_t id)>(0x1333E90);
	static inline auto FSetAuthority = PreyFunction<void(ArkCystoid* const _this, bool auth)>(0x1333E90);
	static inline auto FGetMemoryUsage = PreyFunction<void(const ArkCystoid* const _this, ICrySizer* s)>(0x154FF00);
	static inline auto FUpdateCystoid = PreyFunction<void(ArkCystoid* const _this, const float _timeDelta, const Vec3& _playerPos)>(0x1533E20);
	static inline auto FPostSerializeCystoid = PreyFunction<void(ArkCystoid* const _this)>(0x1532660);
	static inline auto FReceiveSignalPackage = PreyFunction<void(ArkCystoid* const _this, const ArkSignalSystem::Package& _package)>(0x1532C90);
	static inline auto FRegisterForSignals = PreyFunction<void(ArkCystoid* const _this, bool _bRegister)>(0x1532FC0);
	static inline auto FFollowTarget = PreyFunction<void(ArkCystoid* const _this, const unsigned& _newTarget)>(0x1530550);
	static inline auto FGetUpdateRate = PreyFunction<float(const ArkCystoid* const _this)>(0xE9ABF0);
	static inline auto FTestTarget = PreyFunction<bool(const ArkCystoid* const _this, unsigned _target)>(0x1533B70);
	static inline auto FTryToSetTarget = PreyFunction<void(ArkCystoid* const _this, unsigned _target, unsigned _nestEntity, bool _bTestCurrentTarget)>(0x1533BB0);
	static inline auto FSetTarget = PreyFunction<void(ArkCystoid* const _this, unsigned _newTarget)>(0x15334B0);
	static inline auto FSetActive = PreyFunction<void(ArkCystoid* const _this, bool _bActive, bool _bForce)>(0x1533160);
	static inline auto FSetSwarmLeader = PreyFunction<void(ArkCystoid* const _this, const unsigned _swarmLeader, bool _bForce)>(0x1533300);
	static inline auto FNotifyOfSwarmMemberAdded = PreyFunction<void(const ArkCystoid* const _this, ArkCystoid* _pCystoid)>(0x15319B0);
	static inline auto FIsSwarmLeader = PreyFunction<bool(const ArkCystoid* const _this)>(0x1530F60);
	static inline auto FCanHypnotize = PreyFunction<bool(const ArkCystoid* const _this, const unsigned _source)>(0x152FBC0);
	static inline auto FHandleHypnotize = PreyFunction<bool(ArkCystoid* const _this, const unsigned _source)>(0x1530DD0);
	static inline auto FOnSpawnedByWeaver = PreyFunction<void(ArkCystoid* const _this)>(0x1531DE0);
	static inline auto FExplode = PreyFunction<void(ArkCystoid* const _this)>(0x1530140);
	static inline auto FSetState = PreyFunction<void(ArkCystoid* const _this, EArkCystoidState _state, bool _bForce)>(0x15331A0);
	static inline auto FOnReset = PreyFunction<void(ArkCystoid* const _this, bool _bEnteringGameMode)>(0x1531A30);
	static inline auto FUpdateTarget = PreyFunction<void(ArkCystoid* const _this, float _frameTime)>(0x15343E0);
	static inline auto FOnStopCarry = PreyFunction<void(IArkPlayerCarryListener* const _this, IEntity* const _pEntity, bool _bThrown)>(0x15322F0);
	...
	static inline auto FOnEtherDuplicateCreated = PreyFunction<void(IArkEtherDuplicateListener* const _this, const unsigned _etherDuplicate)>(0x1531A10);
	static inline auto FEnterState = PreyFunction<void(ArkCystoid* const _this, bool _bForce)>(0x152FC40);
	static inline auto FExitState = PreyFunction<void(ArkCystoid* const _this)>(0x1530010);
	static inline auto FSetUpdateRate = PreyFunction<void(ArkCystoid* const _this, EArkCystoidState _state)>(0x15335E0);
	static inline auto FMoveTowardsTarget = PreyFunction<void(ArkCystoid* const _this, const float _frameTime, const bool _bUpdateMovement)>(0x1530FF0);
	static inline auto FGetDistanceSqToTarget = PreyFunction<float(const ArkCystoid* const _this)>(0x15309D0);
	static inline auto FSpawnStateVFX = PreyFunction<void(ArkCystoid* const _this, IParticleEffect* _pParticleEffect)>(0x1533650);
	static inline auto FProcessNearbyCystoids = PreyFunction<void(ArkCystoid* const _this, float _nearbyRange, void (*_pFunc)(const ArkCystoid* const, ArkCystoid* const))>(0x1532940);
	static inline auto FLureCystoid = PreyFunction<void(const ArkCystoid* const _pSourceCystoid, ArkCystoid* const _pNearbyCystoid)>(0x1530F70);
};
#endif // !MOONCRASH
