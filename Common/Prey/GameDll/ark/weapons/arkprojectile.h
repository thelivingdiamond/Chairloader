...
public:
	...
	{ // Size=280 (0x118)
		...
		static inline auto FLoadEntityEffect = PreyFunction<void(CArkProjectile::ArkProjectileEntityEffect* const _this, ArkSafeScriptTable _properties, const string _propertyName, const float _duration, const float _sizeScale)>(0x176B460);
		static inline auto FStart = PreyFunction<void(CArkProjectile::ArkProjectileEntityEffect* const _this, const bool _bUseCheap)>(0x176E730);
		static inline auto FKill = PreyFunction<void(CArkProjectile::ArkProjectileEntityEffect* const _this)>(0x176A820);
		static inline auto FSetLocalTM = PreyFunction<void(CArkProjectile::ArkProjectileEntityEffect* const _this, const Matrix34& _localTM)>(0x176CD10);
	};
	...
	{ // Size=136 (0x88)
		...
		static inline auto FLoadFFEffect = PreyFunction<void(CArkProjectile::ArkProjectileFFEffect* const _this, ArkSafeScriptTable _properties, const string _propertyName)>(0x176B5D0);
		static inline auto FStart = PreyFunction<void(CArkProjectile::ArkProjectileFFEffect* const _this, const bool _bUseCheap, const Vec3& _position, const Vec3& _worldDirection, const float _scale)>(0x176E780);
	};
	...
	ArkEntityEffect m_trailEffect;
	static inline auto m_pTracerArchetype = PreyGlobal<IEntityArchetype*>(0x2D812D8);
	static inline auto s_groupIdGen = PreyGlobal<unsigned>(0x2D812E0);
	...
	virtual void SetOwnerIdAndWeaponClassName(const unsigned _ownerEntityId, const uint64_t _ownerWeaponId, const string& _weaponName);
	static CArkProjectile* SpawnProjectile(IEntityArchetype* const _pArchetype, const Vec3& _position, const Vec3& _direction, const unsigned _ownerEntityId, const uint64_t _ownerWeaponId, const string _weaponClassName, const bool _bIsCritical, const bool _bIsPooled, const unsigned _extendedFlags, const unsigned _groupId, const bool _bSpawnFromCamera, const bool _bMatchMuzzle) { return FSpawnProjectile(_pArchetype, _position, _direction, _ownerEntityId, _ownerWeaponId, _weaponClassName, _bIsCritical, _bIsPooled, _extendedFlags, _groupId, _bSpawnFromCamera, _bMatchMuzzle); }
	...
	virtual void SetPhysicsParameters(const string& _physicsType, const bool _bImpulseOnCollision);
	...
	static void SpawnTracer(CArkProjectile* const _pProjectile, const Vec3& _position, const Vec3& _direction, const unsigned _ownerEntityId, const uint64_t _ownerWeaponId, const string _weaponClassName, const bool _bTracerIsPooled, const bool _bSpawnFromCamera) { FSpawnTracer(_pProjectile, _position, _direction, _ownerEntityId, _ownerWeaponId, _weaponClassName, _bTracerIsPooled, _bSpawnFromCamera); }
	virtual void StartParticleEffect(ArkFireAndForgetEffect& _effect, const char* _propTableName, const float _scale, const Vec3& _worldDirection);
	float GetLifetime() const { return FGetLifetime(this); }
	virtual void AttachParticleEffectsForLiveProjectiles();
	virtual void CheckForCheapParticleUse();

#if 0
	void SetOwnerEntityId(const unsigned _arg0_);
	const string& GetWeaponClassName() const;
	bool IsTracerPooled();
	void SetGroupId(unsigned _arg0_);
	static unsigned GenerateGroupId();
	unsigned GetOwnerEntityId() const;
	uint64_t GetOwnerWeaponId() const;
	unsigned GetShooterId() const;
	void SetPackageId(uint64_t _arg0_);
	bool IsDestroying() const;
	void SetSpawnPosition(const Vec3& _arg0_);
	...
	static inline auto FCArkProjectileOv1 = PreyFunction<void(CArkProjectile* const _this)>(0x1768BB0);
	static inline auto FBitNotCArkProjectile = PreyFunction<void(CArkProjectile* const _this)>(0x1768CE0);
	static inline auto FIsGrenade = PreyFunction<bool(const CArkProjectile* const _this)>(0x13B0900);
	static inline auto FGetMemoryUsage = PreyFunction<void(const CArkProjectile* const _this, ICrySizer* _s)>(0x17699F0);
	static inline auto FInit = PreyFunction<bool(CArkProjectile* const _this, IGameObject* _pGameObject)>(0x176A3F0);
	static inline auto FPostInit = PreyFunction<void(CArkProjectile* const _this, IGameObject* _pGameObject)>(0x176C150);
	static inline auto FInitClient = PreyFunction<void(CArkProjectile* const _this, int _channelId)>(0x1333E90);
	static inline auto FPostInitClient = PreyFunction<void(CArkProjectile* const _this, int _channelId)>(0x1333E90);
	static inline auto FReloadExtension = PreyFunction<bool(CArkProjectile* const _this, IGameObject* _pGameObject, const SEntitySpawnParams& _params)>(0x13B0900);
	static inline auto FPostReloadExtension = PreyFunction<void(CArkProjectile* const _this, IGameObject* _pGameObject, const SEntitySpawnParams& _params)>(0x1333E90);
	static inline auto FGetEntityPoolSignature = PreyFunction<bool(CArkProjectile* const _this, TSerialize _signature)>(0x13B0900);
	static inline auto FRelease = PreyFunction<void(CArkProjectile* const _this)>(0x3E3960);
	static inline auto FFullSerialize = PreyFunction<void(CArkProjectile* const _this, TSerialize _ser)>(0x1769600);
	static inline auto FNetSerialize = PreyFunction<bool(CArkProjectile* const _this, TSerialize _ser, EEntityAspects _aspect, uint8_t _profile, int _pflags)>(0x13B0900);
	static inline auto FPostSerialize = PreyFunction<void(CArkProjectile* const _this)>(0x176C540);
	static inline auto FSerializeSpawnInfo = PreyFunction<void(CArkProjectile* const _this, TSerialize _ser)>(0x1333E90);
	static inline auto FGetSpawnInfo = PreyFunction<_smart_ptr<ISerializableInfo>*(CArkProjectile* const _this, _smart_ptr<ISerializableInfo>* _return_value_)>(0x361570);
	static inline auto FUpdate = PreyFunction<void(CArkProjectile* const _this, SEntityUpdateContext& _ctx, int _slot)>(0x176EEF0);
	static inline auto FHandleEvent = PreyFunction<void(CArkProjectile* const _this, const SGameObjectEvent& _event)>(0x176A1E0);
	static inline auto FProcessEvent = PreyFunction<void(CArkProjectile* const _this, SEntityEvent& _event)>(0x176C700);
	static inline auto FSetChannelId = PreyFunction<void(CArkProjectile* const _this, uint16_t _id)>(0x1333E90);
	static inline auto FSetAuthority = PreyFunction<void(CArkProjectile* const _this, bool _auth)>(0x1333E90);
	static inline auto FGetRMIBase = PreyFunction<const void* (const CArkProjectile* const _this)>(0x1CBB0B0);
	static inline auto FPostUpdate = PreyFunction<void(CArkProjectile* const _this, float _frameTime)>(0x1333E90);
	static inline auto FPostRemoteSpawn = PreyFunction<void(CArkProjectile* const _this)>(0x1333E90);
	static inline auto FReInitFromPool = PreyFunction<void(CArkProjectile* const _this)>(0x176C780);
	static inline auto FSetOwnerIdAndWeaponClassName = PreyFunction<void(CArkProjectile* const _this, const unsigned _ownerEntityId, const uint64_t _ownerWeaponId, const string& _weaponName)>(0x176CD30);
	static inline auto FSpawnProjectile = PreyFunction<CArkProjectile* (IEntityArchetype* const _pArchetype, const Vec3& _position, const Vec3& _direction, const unsigned _ownerEntityId, const uint64_t _ownerWeaponId, const string _weaponClassName, const bool _bIsCritical, const bool _bIsPooled, const unsigned _extendedFlags, const unsigned _groupId, const bool _bSpawnFromCamera, const bool _bMatchMuzzle)>(0x176D4D0);
	static inline auto FDestroy = PreyFunction<void(CArkProjectile* const _this, const bool _bDeleting, const bool _bDestroyImmediate)>(0x17691E0);
	static inline auto FStartDestroy = PreyFunction<void(CArkProjectile* const _this)>(0x176E990);
	static inline auto FStartHiddenIfNecessary = PreyFunction<void(CArkProjectile* const _this, const float _hideTime)>(0x176EA70);
	static inline auto FGetPackageId = PreyFunction<uint64_t(const CArkProjectile* const _this)>(0x1769AC0);
	static inline auto FGetProjectileFromEntityId = PreyFunction<CArkProjectile* (const unsigned _entityId)>(0x1769AD0);
	static inline auto FSetGravityTimer = PreyFunction<void(CArkProjectile* const _this, const float _gravityTime)>(0x176CD00);
	static inline auto FGetAmmoPickupArchetype = PreyFunction<IEntityArchetype* (const CArkProjectile* const _this)>(0x1769840);
	static inline auto FIsUsingExpensiveParticles = PreyFunction<bool(const CArkProjectile* const _this)>(0x176A800);
	static inline auto FInitializeLiveProjectile = PreyFunction<void(CArkProjectile* const _this)>(0x176A420);
	static inline auto FGetPropertiesTable = PreyFunction<ArkSafeScriptTable*(const CArkProjectile* const _this, ArkSafeScriptTable* _return_value_)>(0x10E1850);
	static inline auto FLoadCachedProperties = PreyFunction<void(CArkProjectile* const _this)>(0x176A840);
	static inline auto FPhysicalize = PreyFunction<void(CArkProjectile* const _this, const string& _physicsType)>(0x176BA60);
	static inline auto FSetPhysicsParameters = PreyFunction<void(CArkProjectile* const _this, const string& _physicsType, const bool _bImpulseOnCollision)>(0x176CF00);
	static inline auto FLoadModel = PreyFunction<void(CArkProjectile* const _this)>(0x176B830);
	static inline auto FDoDamage = PreyFunction<void(CArkProjectile* const _this, const EventPhysCollision& _collision, const unsigned& _targetId, const int _targetIndex)>(0x17692B0);
	static inline auto FShowHitDamageUI = PreyFunction<bool(const CArkProjectile* const _this)>(0x1A302A0);
	static inline auto FGetWeaponOwnerId = PreyFunction<unsigned(const CArkProjectile* const _this)>(0x176A1B0);
	static inline auto FGetWeapon = PreyFunction<CArkWeapon* (const CArkProjectile* const _this)>(0x176A130);
	static inline auto FSetCriticalHit = PreyFunction<void(CArkProjectile* const _this)>(0x176CB50);
	static inline auto FIsCriticalHit = PreyFunction<bool(const CArkProjectile* const _this)>(0x176A650);
	static inline auto FGetModelFilename = PreyFunction<string*(CArkProjectile* const _this, string* _return_value_, const ArkSafeScriptTable& _propertiesTable)>(0x1769A10);
	static inline auto FSpawnTracer = PreyFunction<void(CArkProjectile* const _pProjectile, const Vec3& _position, const Vec3& _direction, const unsigned _ownerEntityId, const uint64_t _ownerWeaponId, const string _weaponClassName, const bool _bTracerIsPooled, const bool _bSpawnFromCamera)>(0x176DD50);
	static inline auto FStartParticleEffect = PreyFunction<void(CArkProjectile* const _this, ArkFireAndForgetEffect& _effect, const char* _propTableName, const float _scale, const Vec3& _worldDirection)>(0x176EB10);
	static inline auto FGetLifetime = PreyFunction<float(const CArkProjectile* const _this)>(0x1769860);
	static inline auto FAttachParticleEffectsForLiveProjectiles = PreyFunction<void(CArkProjectile* const _this)>(0x17691B0);
	static inline auto FCheckForCheapParticleUse = PreyFunction<void(CArkProjectile* const _this)>(0x1333E90);
};
#endif // !MOONCRASH
