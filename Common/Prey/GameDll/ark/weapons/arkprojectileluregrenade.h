...
// CArkProjectileLureGrenade
// Header:  Prey/GameDll/ark/weapons/ArkProjectileLureGrenade.h
class CArkProjectileLureGrenade : public CArkProjectileGrenade
{ // Size=1928 (0x788)
public:
	ArkGameNoise::Params m_noiseParams;
	float m_explosionRadiusPartialGravity;
...
#if 0
	static CArkProjectileLureGrenade* GetProjectileGrenadeFromEntityId(const unsigned _arg0_);
#endif

	static inline auto FCArkProjectileLureGrenadeOv1 = PreyFunction<void(CArkProjectileLureGrenade* const _this)>(0x1487DC0);
	static inline auto FGetMemoryUsage = PreyFunction<void(const CArkProjectileLureGrenade* const _this, ICrySizer* _s)>(0x1487F30);
	static inline auto FPostInit = PreyFunction<void(CArkProjectileLureGrenade* const _this, IGameObject* _pGameObject)>(0x1488050);
	static inline auto FFullSerialize = PreyFunction<void(CArkProjectileLureGrenade* const _this, TSerialize _ser)>(0x1487F10);
	static inline auto FUpdate = PreyFunction<void(CArkProjectileLureGrenade* const _this, SEntityUpdateContext& _ctx, int _slot)>(0x1487DB0);
	static inline auto FLoadCachedProperties = PreyFunction<void(CArkProjectileLureGrenade* const _this)>(0x1487F50);
	static inline auto FPulse = PreyFunction<void(CArkProjectileLureGrenade* const _this)>(0x1488060);
	static inline auto FDoDetonation = PreyFunction<void(CArkProjectileLureGrenade* const _this)>(0x1487EF0);
};
#endif // !MOONCRASH
