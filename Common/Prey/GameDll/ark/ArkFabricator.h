...
// ArkFabricator
// Header:  Prey/GameDll/ark/ArkFabricator.h
class ArkFabricator
	: public ArkInteractiveMachine
	, public ArkUIMenuBase<ArkFabricator>
	, public IArkInventoryListener
	, public IArkFabricationPlanListener
{ // Size=1984 (0x7C0)
public:
	EArkFabricatorState m_state;
	ArkSimpleTimer m_timer;
	...
	std::array<std::vector<QuatT>, 4> m_gridLocs;
	ArkMaterialAnimationManager m_materialAnimationManager;
	std::vector<uint64_t> m_planOrder;
	int m_animFabricateId;
	int m_animShortFabricateId;
	float m_releaseTime;
	float m_shortReleaseTime;
	...
	int m_gameTokenFabricatedEntityName;
	int m_gameTokenFabricatedEntityId;
	std::array<uint64_t, 4> m_ingredientArchetypes;
	...
	void OnItemCreate(IUIElement* const _pSender, const SUIEventDesc& _event, const SUIArguments& _args) { FOnItemCreate(this, _pSender, _event, _args); }
	void OnItemSelect(IUIElement* const _pSender, const SUIEventDesc& _event, const SUIArguments& _args) { FOnItemSelect(this, _pSender, _event, _args); }
	void OnPlaceIngredients(IUIElement* const _pSender, const SUIEventDesc& _event, const SUIArguments& _args) { FOnPlaceIngredients(this, _pSender, _event, _args); }
	virtual void OnReset(bool _bEnteringGameMode);
	virtual void LoadProperties();
	virtual void InitCachedPositionData();
	virtual bool IsProcessing() const;
	...
	bool IsItemPresent() const;
	void AddIngredients();
	void RefreshForPlan(const uint64_t _arg0_);
	void SpawnIngredient(EArkCraftingIngredientType _arg0_, unsigned _arg1_);
	bool RemoveIngredient(EArkCraftingIngredientType _arg0_, unsigned _arg1_);
	void SetError(const string& _arg0_, const string& _arg1_);
#endif

	static inline auto FArkFabricatorOv1 = PreyFunction<void(ArkFabricator* const _this)>(0x11AEBB0);
	static inline auto FBitNotArkFabricator = PreyFunction<void(ArkFabricator* const _this)>(0x11AF180);
	static inline auto FPostInit = PreyFunction<void(ArkFabricator* const _this, IGameObject* _pGameObject)>(0x11B32C0);
	static inline auto FFullSerialize = PreyFunction<void(ArkFabricator* const _this, TSerialize _ser)>(0x11B0740);
	static inline auto FPostSerialize = PreyFunction<void(ArkFabricator* const _this)>(0x11B3330);
	static inline auto FUpdate = PreyFunction<void(ArkFabricator* const _this, SEntityUpdateContext& _ctx, int _updateSlot)>(0x11B5FB0);
	static inline auto FProcessEvent = PreyFunction<void(ArkFabricator* const _this, SEntityEvent& _event)>(0x11B3430);
	static inline auto FGetMemoryUsage = PreyFunction<void(const ArkFabricator* const _this, ICrySizer* _s)>(0x11B0B50);
	static inline auto FOnItemAdded = PreyFunction<void(IArkInventoryListener* const _this, unsigned _itemId, unsigned _originalId, bool _bPrimaryInventory)>(0x11B2800);
	static inline auto FOnItemRemoved = PreyFunction<void(IArkInventoryListener* const _this, unsigned _itemId, bool _bPrimaryInventory)>(0x11B2B00);
	static inline auto FOnItemCountChanged = PreyFunction<void(IArkInventoryListener* const _this, unsigned _itemId, bool _bPrimaryInventory)>(0x11B2950);
	static inline auto FOnInteraction = PreyFunction<bool(IArkPlayerInteractionListener* const _this, EArkInteractionType _interaction, EArkInteractionMode _mode, IEntity* const _pEntity)>(0x11B2710);
	static inline auto FTestInteraction = PreyFunction<bool(const IArkPlayerInteractionListener* const _this, const IEntity* const _pEntity, const ArkInteractionInfo& _interactionInfo, EArkInteractionMode _mode, ArkInteractionTestResult& _result)>(0x11B5DD0);
	static inline auto FOnStartLookingAt = PreyFunction<void(IArkPlayerInteractionListener* const _this, unsigned _targetId)>(0x11B2EC0);
	static inline auto FOnStopLookingAt = PreyFunction<void(IArkPlayerInteractionListener* const _this, unsigned _targetId)>(0x11B2EF0);
	static inline auto FGetInteractionPosition = PreyFunction<Vec3*(const IArkPlayerInteractionListener* const _this, Vec3* _return_value_, const IEntity* const _pEntity)>(0x11B0AE0);
	static inline auto FOnFabricationPlanAdded = PreyFunction<void(IArkFabricationPlanListener* const _this, const uint64_t _id)>(0x11B2640);
	static inline auto FOnFabricationPlanUsed = PreyFunction<void(IArkFabricationPlanListener* const _this, const uint64_t _id)>(0x11B25F0);
	static inline auto FOnFabricationPlanReverseEngineered = PreyFunction<void(IArkFabricationPlanListener* const _this, const uint64_t _oldId, const uint64_t _newId)>(0x11B26F0);
	static inline auto FOnFabricationErrorSet = PreyFunction<void(IArkFabricationPlanListener* const _this, const uint64_t _id)>(0x11B25F0);
	static inline auto FOnFabricationErrorCleared = PreyFunction<void(IArkFabricationPlanListener* const _this, const uint64_t _id)>(0x11B25F0);
	static inline auto FOnFabricationPlanPostSerialize = PreyFunction<void(IArkFabricationPlanListener* const _this)>(0x11B2690);
	static inline auto FOnWorldUIInstanceGranted = PreyFunction<void(ArkFabricator* const _this, IUIElement* _pUIInstance)>(0x11B31C0);
	static inline auto FOnWorldUIInstanceRevoked = PreyFunction<void(ArkFabricator* const _this, IUIElement* _pUIInstance)>(0x11B3250);
	static inline auto FGetInteractiveScreenType = PreyFunction<EArkInteractiveScreenType(const ArkFabricator* const _this)>(0x1CBB0B0);
	static inline auto FOnButtonPress = PreyFunction<void(ArkFabricator* const _this, IUIElement* const _pSender, const SUIEventDesc& _event, const SUIArguments& _args)>(0x11B22D0);
	static inline auto FOnItemCreate = PreyFunction<void(ArkFabricator* const _this, IUIElement* const _pSender, const SUIEventDesc& _event, const SUIArguments& _args)>(0x11B2960);
	static inline auto FOnItemSelect = PreyFunction<void(ArkFabricator* const _this, IUIElement* const _pSender, const SUIEventDesc& _event, const SUIArguments& _args)>(0x11B2B40);
	static inline auto FOnPlaceIngredients = PreyFunction<void(ArkFabricator* const _this, IUIElement* const _pSender, const SUIEventDesc& _event, const SUIArguments& _args)>(0x11B2C90);
	static inline auto FOnReset = PreyFunction<void(ArkFabricator* const _this, bool _bEnteringGameMode)>(0x11B2CA0);
	static inline auto FLoadProperties = PreyFunction<void(ArkFabricator* const _this)>(0x11B12A0);
	static inline auto FInitCachedPositionData = PreyFunction<void(ArkFabricator* const _this)>(0x11B0C30);
	static inline auto FIsProcessing = PreyFunction<bool(const ArkFabricator* const _this)>(0x11B1290);
	static inline auto FIsInteractive = PreyFunction<bool(const ArkFabricator* const _this)>(0x11B1270);
	static inline auto FSetState = PreyFunction<void(ArkFabricator* const _this, EArkFabricatorState _state)>(0x11B42C0);
	static inline auto FSpawnItem = PreyFunction<IEntity* (ArkFabricator* const _this)>(0x11B49F0);
	static inline auto FSpawnMaterial = PreyFunction<void(ArkFabricator* const _this)>(0x11B5AB0);
	static inline auto FClearSpawnedItem = PreyFunction<void(ArkFabricator* const _this)>(0x11B0700);
	static inline auto FRegisterSpawnedItem = PreyFunction<void(ArkFabricator* const _this)>(0x11B4070);
	static inline auto FReinitializeUI = PreyFunction<void(ArkFabricator* const _this)>(0x11B4150);
	static inline auto FRefreshUIPlayerIngredients = PreyFunction<void(ArkFabricator* const _this)>(0x11B3F30);
	static inline auto FRefreshUIIngredients = PreyFunction<void(ArkFabricator* const _this)>(0x11B39C0);
	static inline auto FRefreshUIDisplayedPlans = PreyFunction<void(ArkFabricator* const _this)>(0x11B35A0);
	static inline auto FRefreshUIPlanDescription = PreyFunction<void(ArkFabricator* const _this)>(0x11B3C80);
	static inline auto FSpawnIngredients = PreyFunction<void(ArkFabricator* const _this)>(0x11B47C0);
	static inline auto FOnUsed = PreyFunction<void(ArkFabricator* const _this)>(0x11B3030);
	static inline auto FInitGridLocs = PreyFunction<void(ArkFabricator* const _this)>(0x11B0F20);
	static inline auto FSetSlotsFlashing = PreyFunction<void(ArkFabricator* const _this, bool _bFlashing)>(0x11B4220);
	static inline auto FTestForIngredientChange = PreyFunction<void(ArkFabricator* const _this, unsigned _itemId)>(0x11B5D40);
	static inline auto FUpdateFlashing = PreyFunction<void(ArkFabricator* const _this)>(0x11B61C0);
	static inline auto FOnEnabledChanged = PreyFunction<void(ArkFabricator* const _this, bool _bForce)>(0x11B23A0);
	static inline auto FAwakeSpawnedItem = PreyFunction<void(const ArkFabricator* const _this)>(0x11B0510);
	static inline auto FRefreshPlanOrder = PreyFunction<void(ArkFabricator* const _this)>(0x11B3520);
};
#endif // !MOONCRASH
