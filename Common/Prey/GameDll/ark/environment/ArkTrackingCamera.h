...
// ArkTrackingCamera
// Header:  Prey/GameDll/ark/environment/ArkTrackingCamera.h
class ArkTrackingCamera : public ArkEnvironmentalObject, public IArkDisruptableListener
{ // Size=360 (0x168)
public:
	std::vector<unsigned int> m_potentialTargets;
	unsigned m_activeTarget;
	...
	static inline auto FArkTrackingCameraOv1 = PreyFunction<void(ArkTrackingCamera* const _this)>(0x13116C0);
	static inline auto FInit = PreyFunction<bool(ArkTrackingCamera* const _this, IGameObject* _pGameObject)>(0x1311C50);
	static inline auto FPostInit = PreyFunction<void(ArkTrackingCamera* const _this, IGameObject* _pGameObject)>(0x13124D0);
	static inline auto FFullSerialize = PreyFunction<void(ArkTrackingCamera* const _this, TSerialize _ser)>(0x13118A0);
	static inline auto FPostSerialize = PreyFunction<void(ArkTrackingCamera* const _this)>(0x13126C0);
	static inline auto FUpdate = PreyFunction<void(ArkTrackingCamera* const _this, SEntityUpdateContext& _ctx, int _updateSlot)>(0x13128C0);
	static inline auto FProcessEvent = PreyFunction<void(ArkTrackingCamera* const _this, SEntityEvent& _event)>(0x1312700);
	static inline auto FGetMemoryUsage = PreyFunction<void(const ArkTrackingCamera* const _this, ICrySizer* _s)>(0x1311B70);
	static inline auto FSetEnabled = PreyFunction<void(ArkTrackingCamera* const _this, bool _bEnabled)>(0x1312830);
	static inline auto FOnReset = PreyFunction<void(ArkTrackingCamera* const _this, bool _bEnteringGameMode)>(0x1312450);
	static inline auto FLoadProperties = PreyFunction<void(ArkTrackingCamera* const _this)>(0x1311DC0);
	static inline auto FOnDisruptedChanged = PreyFunction<void(IArkDisruptableListener* const _this, bool _bDisrupted, bool _bWasForced)>(0x13123F0);
	static inline auto FGetSparkLoc = PreyFunction<QuatT*(const IArkDisruptableListener* const _this, QuatT* _return_value_)>(0x1311BD0);
	static inline auto FInitArea = PreyFunction<void(ArkTrackingCamera* const _this)>(0x1311D40);
	static inline auto FOnReceiveSignal = PreyFunction<void(ArkTrackingCamera* const _this, const ArkSignalSystem::Package& _package)>(0x1312440);
	static inline auto FRegisterForSignals = PreyFunction<void(ArkTrackingCamera* const _this, bool _bRegister)>(0x1312820);
};
#endif // !MOONCRASH
