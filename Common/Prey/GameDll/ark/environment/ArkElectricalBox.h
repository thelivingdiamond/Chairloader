...
// ArkElectricalBox
// Header:  Prey/GameDll/ark/environment/ArkElectricalBox.h
...
public:
	...
	bool m_bUpdating;
	std::vector<unsigned int> m_targets;
	std::vector<unsigned int> m_linkedTargets;
	bool m_bTargetsChanged;
	unsigned m_decalId;
	float m_gooAccumulation;
	ArkRepairable m_repairable;
	...
	static inline auto FArkElectricalBoxOv1 = PreyFunction<void(ArkElectricalBox* const _this)>(0x14BEE10);
	static inline auto FBitNotArkElectricalBox = PreyFunction<void(ArkElectricalBox* const _this)>(0x14BF010);
	static inline auto FInit = PreyFunction<bool(ArkElectricalBox* const _this, IGameObject* _pGameObject)>(0x14C03D0);
	static inline auto FPostInit = PreyFunction<void(ArkElectricalBox* const _this, IGameObject* _pGameObject)>(0x14C28B0);
	static inline auto FFullSerialize = PreyFunction<void(ArkElectricalBox* const _this, TSerialize _ser)>(0x14BFF90);
	static inline auto FPostSerialize = PreyFunction<void(ArkElectricalBox* const _this)>(0x14C2900);
	static inline auto FUpdate = PreyFunction<void(ArkElectricalBox* const _this, SEntityUpdateContext& ctx, int updateSlot)>(0x14C3010);
	static inline auto FProcessEvent = PreyFunction<void(ArkElectricalBox* const _this, SEntityEvent& _event)>(0x14C2970);
	static inline auto FGetMemoryUsage = PreyFunction<void(const ArkElectricalBox* const _this, ICrySizer* _s)>(0x14C0230);
	static inline auto FOnReceiveSignal = PreyFunction<void(ArkElectricalBox* const _this, const ArkSignalSystem::Package& _package)>(0x14C2370);
	static inline auto FOnLightningCallback = PreyFunction<void(ArkElectricalBox* const _this, IEntity* _pArc, IEntity* _pTarget, float _strikeTime)>(0x14C1E50);
	static inline auto FSetPowered = PreyFunction<void(ArkElectricalBox* const _this, bool _bPowered, unsigned _activator)>(0x14C2DB0);
	static inline auto FInitArea = PreyFunction<void(ArkElectricalBox* const _this)>(0x14C04F0);
	static inline auto FAddTarget = PreyFunction<bool(ArkElectricalBox* const _this, unsigned _entityId)>(0x14BF710);
	static inline auto FOnReset = PreyFunction<void(ArkElectricalBox* const _this, bool _bEnteringGameMode)>(0x14C26A0);
	static inline auto FLoadProperties = PreyFunction<void(ArkElectricalBox* const _this)>(0x14C08E0);
	static inline auto FRegisterForSignals = PreyFunction<void(ArkElectricalBox* const _this, bool _bRegister)>(0x14C2CA0);
	static inline auto FUpdateHazardTargets = PreyFunction<void(ArkElectricalBox* const _this)>(0x14C33C0);
	static inline auto FRecheckFortifyTargets = PreyFunction<void(ArkElectricalBox* const _this)>(0x14C2AC0);
	static inline auto FUpdateArcs = PreyFunction<void(ArkElectricalBox* const _this)>(0x14C31C0);
	static inline auto FCreateArcs = PreyFunction<void(ArkElectricalBox* const _this)>(0x14BF9F0);
	static inline auto FExplodeNearbyGoo = PreyFunction<void(ArkElectricalBox* const _this)>(0x14BFDC0);
	static inline auto FClearGooAccumulation = PreyFunction<void(ArkElectricalBox* const _this)>(0x14BF930);
	static inline auto FUpdateGooAccumulation = PreyFunction<void(ArkElectricalBox* const _this, float _delta)>(0x14C3290);
	static inline auto FStartWarning = PreyFunction<void(ArkElectricalBox* const _this)>(0x14C2EA0);
	static inline auto FStopWarning = PreyFunction<void(ArkElectricalBox* const _this, bool _bImmediate)>(0x14C2F10);
	static inline auto FOnBrokenChanged = PreyFunction<void(IArkRepairableListener* const _this, bool _bBroken, bool _bWasForced)>(0x14C1A00);
	static inline auto FOnFortified = PreyFunction<void(IArkRepairableListener* const _this)>(0x14C1DC0);
	static inline auto FOnDisruptedChanged = PreyFunction<void(IArkDisruptableListener* const _this, bool _bDisrupted, bool _bWasForced)>(0x14C1C00);
	static inline auto FGetSparkLoc = PreyFunction<QuatT*(const IArkDisruptableListener* const _this, QuatT* _return_value_)>(0x14C02F0);
	static inline auto FOnEntityEvent = PreyFunction<void(IEntityEventListener* const _this, IEntity* _pEntity, SEntityEvent& _event)>(0x14C1D10);
	static inline auto FClearArcs = PreyFunction<void(ArkElectricalBox* const _this)>(0x14BF860);
};
#endif // !MOONCRASH
