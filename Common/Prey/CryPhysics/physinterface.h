...
#include <Prey/CryMemory/IGeneralMemoryHeap.h>
#include <Prey/CryMath/Cry_Geo.h>
#include <Prey/CryCore/stridedptr.h>
...
enum pe_collision_class
{
	...
	collision_class_game        = 1 << 7,
	collision_class_permeable_to_AOE= 1 << 10,
	collision_class_ragdoll         = 1 << 11,
	collision_class_ai				= 1 << 14,
	collision_class_goo				= 1 << 15,
	collision_class_smokeform		= 1 << 16,
	collision_class_projectile		= 1 << 18,
	collision_class_transparent		= 1 << 19,
	collision_class_breakable		= 1 << 20,
	collision_class_permeable		= 1 << 21,
	collision_class_coral			= 1 << 22,
};
...
struct pe_params_flags : pe_params
{
	...
	unsigned int arkFlagsOR;
	unsigned int arkFlagsAND;
};
...
struct pe_player_dimensions : pe_params
{
	...
	unsigned int ignoreCollisionsWith;
...
struct PhysicsVars : SolverSettings
{
	...
	float minMassScale;
	float maxMassScale;
	float livingInAirImpulseScale;
	float bounceGooImpulseScale;
	float articulatedImpulseScale;
	float bounceGooOnGooImpulseScale;
	float bounceGooZeroGScale;
	int playerLeverageLevel;
	float rigidBodyDampingZeroG;
	float ragdollPenetrationThreshold;
};
