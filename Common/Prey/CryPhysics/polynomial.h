...
#pragma once
#include <_unknown/polynomial_tpl.h>

// polynomial_tpl<double,3>
// Header:  CryEngine/cryphysics/polynomial.h
class polynomial_tpl<double,3>
{ // Size=40 (0x28)
public:
	double denom;
	double data[4];

	int findroots(double start, double end, double* proots, int nIters, int degree, bool noDegreeCheck) const { return Ffindroots(this, start, end, proots, nIters, degree, noDegreeCheck); }

#if 0
	polynomial_tpl<double,3>();
	polynomial_tpl<double,3>(double _arg0_);
	polynomial_tpl<double,3>(const polynomial_tpl<double,3>& _arg0_);
	polynomial_tpl<double,3>& zero();
	polynomial_tpl<double,3>& operator=(const polynomial_tpl<double,3>& _arg0_);
	polynomial_tpl<double,3>& set(double* _arg0_);
	double& operator[](int _arg0_);
	void calc_deriviative(polynomial_tpl<double,3>& _arg0_, int _arg1_) const;
	polynomial_tpl<double,3>& fixsign();
	int nroots(double _arg0_, double _arg1_) const;
	double eval(double _arg0_) const;
	double eval(double _arg0_, int _arg1_) const;
	polynomial_tpl<double,3>& operator+=(double _arg0_);
	polynomial_tpl<double,3>& operator-=(double _arg0_);
	polynomial_tpl<double,3> operator*(double _arg0_) const;
	polynomial_tpl<double,3>& operator*=(double _arg0_);
	polynomial_tpl<double,3> operator/(double _arg0_) const;
	polynomial_tpl<double,3>& operator/=(double _arg0_);
	polynomial_tpl<double,6> sqr() const;
#endif

	static inline auto Ffindroots = PreyFunction<int(const polynomial_tpl<double,3>* const _this, double start, double end, double* proots, int nIters, int degree, bool noDegreeCheck)>(0xB90FB0);
};

// polynomial_tpl<double,4>
// Header:  CryEngine/cryphysics/polynomial.h
class polynomial_tpl<double,4>
{ // Size=48 (0x30)
public:
	double denom;
	double data[5];
...
#if 0
	polynomial_tpl<double,4>();
	polynomial_tpl<double,4>(double _arg0_);
	polynomial_tpl<double,4>(const polynomial_tpl<double,4>& _arg0_);
	polynomial_tpl<double,4>& zero();
	polynomial_tpl<double,4>& operator=(const polynomial_tpl<double,4>& _arg0_);
	polynomial_tpl<double,4>& set(double* _arg0_);
	double& operator[](int _arg0_);
	void calc_deriviative(polynomial_tpl<double,4>& _arg0_, int _arg1_) const;
	polynomial_tpl<double,4>& fixsign();
	int nroots(double _arg0_, double _arg1_) const;
	double eval(double _arg0_) const;
	double eval(double _arg0_, int _arg1_) const;
	polynomial_tpl<double,4>& operator+=(double _arg0_);
	polynomial_tpl<double,4>& operator-=(double _arg0_);
	polynomial_tpl<double,4> operator*(double _arg0_) const;
	polynomial_tpl<double,4>& operator*=(double _arg0_);
	polynomial_tpl<double,4> operator/(double _arg0_) const;
	polynomial_tpl<double,4>& operator/=(double _arg0_);
	polynomial_tpl<double,8> sqr() const;
#endif

	static inline auto Ffindroots = PreyFunction<int(const polynomial_tpl<double,4>* const _this, double start, double end, double* proots, int nIters, int degree, bool noDegreeCheck)>(0xC89B80);
};
#endif // !MOONCRASH
