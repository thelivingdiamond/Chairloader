...
// ArkProperty
// Header:  Prey/ArkCommon/reflection/ArkProperty.h
class ArkProperty
{ // Size=32 (0x20)
public:
	enum class EArkType
	...
	virtual void SetValue(ArkReflectedObject* const _pObject, const IArkValueBase* _v) const = 0;
	virtual bool IsArray() const;
	virtual ArkReflectedObject* GetMemPtr(ArkReflectedObject* const _pObject) const;
	virtual void Reset(ArkReflectedObject* _pObject) const;

#if 0
	ArkProperty(const string& _arg0_, ArkProperty::EArkType _arg1_, const char* _arg2_);
