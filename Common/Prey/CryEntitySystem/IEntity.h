...
enum EPartIds
{
	...
	PARTID_LINKED = 30000,
	PARTID_CGA = 3000000,
	PARTID_MAX_NUM_ATTACHMENTS = 0x40,
};
#endif
...
struct SEntitySpawnParams
{
	...
	bool bCreatedThroughPool = false;
	uint8_t sceneMask = 0;
	uint8_t shadowCasterType = 0;
...
enum EEntityXFormFlags
{
	...
	ENTITY_XFORM_BOUNDS_CHECK             = BIT(20),
	ENTITY_XFORM_NO_BOUNDS_CHECK          = BIT(21),
	ENTITY_XFORM_ALLOW_STATIONARY_TEST    = BIT(22),
...
enum EEntityEvent
{
	...
	ENTITY_EVENT_XFORM_FINISHED_EDITOR_GLOBAL,
	...
	ENTITY_EVENT_INVISIBLE_LAYER,
	ENTITY_EVENT_VISIBLE_LAYER,
	...
	ENTITY_EVENT_TRACKVIEW_SEQUENCE_START,
	ENTITY_EVENT_TRACKVIEW_SEQUENCE_STOP,
...
enum EEntityFlagsExtended
{
	...
	ENTITY_FLAG_EXTENDED_BREAKS_GLASS					= BIT(5),
	ENTITY_FLAG_EXTENDED_CASTSUNSHADOW					= BIT(6),
	ENTITY_FLAG_EXTENDED_RENDERFLAG_MASK				= ENTITY_FLAG_EXTENDED_DYNAMIC_DISTANCE_SHADOWS | ENTITY_FLAG_EXTENDED_CASTSUNSHADOW,
	ENTITY_FLAG_EXTENDED_SKIP_METRICS_LOGGING			= BIT(7),
	ENTITY_FLAG_EXTENDED_CUSTOM_CASTSHADOWVIEWDIST_RATIO = BIT(8),
	ENTITY_FLAG_EXTENDED_SPAWNED_BY_CAPTURE_VOLUME		= BIT(9),
};
...
struct IEntity
{
	...
	virtual const IEntityArchetype* GetArchetype() const = 0;
	...
	virtual void SetSlotAlpha(int slot, float alpha) = 0;
