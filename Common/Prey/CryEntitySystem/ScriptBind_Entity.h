...
public:
	...
	static inline auto FCScriptBind_EntityOv1 = PreyFunction<void(CScriptBind_Entity* const _this, IScriptSystem* pSS, ISystem* pSystem, IEntitySystem* pEntitySystem)>(0x950930);
	static inline auto FDelegateCalls = PreyFunction<void(CScriptBind_Entity* const _this, IScriptTable* pInstanceTable)>(0x95C950);
	static inline auto FGoalParamsHelper = PreyFunction<void(CScriptBind_Entity* const _this, IFunctionHandler* pH, unsigned index, GoalParams& node)>(0x967010);
	static inline auto FGetMemoryUsage = PreyFunction<void(const CScriptBind_Entity* const _this, ICrySizer* pSizer)>(0x963E60);
	static inline auto FDeleteThis = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95CA10);
	static inline auto FCreateRenderProxy = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95C830);
	static inline auto FCheckShaderParamCallbacks = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x77DB10);
	static inline auto FLoadObject = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, const char* sFilename)>(0x96B140);
	static inline auto FLoadObjectWithFlags = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, const char* sFilename, const int loadFlags)>(0x96B3F0);
	static inline auto FLoadObjectLattice = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot)>(0x96B2C0);
	static inline auto FLoadSubObject = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, const char* sFilename, const char* sGeomName)>(0x96C100);
	static inline auto FLoadCharacter = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, const char* sFilename)>(0x96AC50);
	static inline auto FLoadGeomCache = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, const char* sFilename)>(0x96AF00);
	static inline auto FLoadLight = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, SmartScriptTable table)>(0x96AFF0);
	static inline auto FSetLightColorParams = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, Vec3 color, float specular_multiplier)>(0x97B250);
	static inline auto FUpdateLightClipBounds = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot)>(0x97F260);
	static inline auto FSetSelfAsLightCasterException = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nLightSlot)>(0x97C520);
	static inline auto FLoadCloud = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, const char* sFilename)>(0x96AD40);
	static inline auto FSetCloudMovementProperties = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, SmartScriptTable table)>(0x976B10);
	static inline auto FLoadFogVolume = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, SmartScriptTable table)>(0x96ADE0);
	static inline auto FFadeGlobalDensity = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, float fadeTime, float newGlobalDensity)>(0x95E930);
	static inline auto FLoadVolumeObject = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, const char* sFilename)>(0x96C200);
	static inline auto FSetVolumeObjectMovementProperties = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, SmartScriptTable table)>(0x97DFC0);
	static inline auto FLoadParticleEffect = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, const char* sEffectName, SmartScriptTable table)>(0x96B570);
	static inline auto FPreLoadParticleEffect = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const char* sEffectName)>(0x972DB0);
	static inline auto FIsSlotParticleEmitter = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot)>(0x96A820);
	static inline auto FIsSlotLight = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot)>(0x96A700);
	static inline auto FIsSlotGeometry = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot)>(0x96A5E0);
	static inline auto FIsSlotCharacter = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot)>(0x96A4C0);
	static inline auto FGetSlotCount = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x965380);
	static inline auto FGetSlotPos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot)>(0x965770);
	static inline auto FSetSlotPos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, Vec3 vPos)>(0x97CC10);
	static inline auto FSetSlotPosAndDir = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, Vec3 pos, Vec3 dir)>(0x97CD20);
	static inline auto FGetSlotAngles = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot)>(0x965090);
	static inline auto FSetSlotAngles = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, Ang3 vAngles)>(0x97C630);
	static inline auto FSetSlotAnglesDeg = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, Vec3 vAnglesDeg)>(0x97C910);
	static inline auto FGetSlotScale = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot)>(0x965820);
	static inline auto FSetSlotScale = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, float fScale)>(0x97CF50);
	static inline auto FIsSlotValid = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot)>(0x96A940);
	static inline auto FCopySlotTM = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int destSlot, int srcSlot, bool includeTranslation)>(0x95C180);
	static inline auto FMultiplyWithSlotTM = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot, Vec3 pos)>(0x96C880);
	static inline auto FSetSlotWorldTM = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, Vec3 pos, Vec3 dir)>(0x97D1D0);
	static inline auto FGetSlotWorldPos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot)>(0x965900);
	static inline auto FGetSlotWorldDir = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot)>(0x965900);
	static inline auto FSetSlotHud3D = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot)>(0x77DB10);
	static inline auto FSetPos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, Vec3 vPos)>(0x97BE20);
	static inline auto FGetPos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x964720);
	static inline auto FSetAngles = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, Ang3 vAngles)>(0x974890);
	static inline auto FGetAngles = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95EE20);
	static inline auto FSetScale = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, float fScale)>(0x97C460);
	static inline auto FGetScale = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x966F70);
	static inline auto FGetCenterOfMassPos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9608D0);
	static inline auto FGetWorldBoundsCenter = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x966DD0);
	static inline auto FSetLocalPos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, Vec3 vPos)>(0x97B6B0);
	static inline auto FGetLocalPos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9636D0);
	static inline auto FSetLocalAngles = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, Ang3 vAngles)>(0x97B480);
	static inline auto FGetLocalAngles = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x963180);
	static inline auto FSetLocalScale = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, float fScale)>(0x97B700);
	static inline auto FGetLocalScale = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x966F70);
	static inline auto FSetWorldPos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, Vec3 vPos)>(0x97BE20);
	static inline auto FGetWorldPos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x964720);
	static inline auto FGetWorldDir = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x966F00);
	static inline auto FSetWorldAngles = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, Ang3 vAngles)>(0x97E0D0);
	static inline auto FGetWorldAngles = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x966C30);
	static inline auto FSetWorldScale = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, float fScale)>(0x97B700);
	static inline auto FGetWorldScale = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x966F70);
	static inline auto FGetBoneLocal = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const char* boneName, Vec3 trgDir)>(0x95FD70);
	static inline auto FCalcWorldAnglesFromRelativeDir = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, Vec3 dir)>(0x95A0E0);
	static inline auto FIsEntityInside = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, ScriptHandle entityId)>(0x969450);
	static inline auto FGetDistance = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x960FD0);
	static inline auto FDrawSlot = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, int nEnable)>(0x95E3D0);
	static inline auto FIgnorePhysicsUpdatesOnSlot = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot)>(0x967FE0);
	static inline auto FFreeSlot = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot)>(0x95EC00);
	static inline auto FFreeAllSlots = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95EB30);
	static inline auto FGetCharacter = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot)>(0x9609F0);
	static inline auto FDestroyPhysics = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95CB10);
	static inline auto FEnablePhysics = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, bool bEnable)>(0x95E5D0);
	static inline auto FResetPhysics = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x974310);
	static inline auto FAwakePhysics = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nAwake)>(0x959F70);
	static inline auto FAwakeCharacterPhysics = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, const char* sRootBoneName, int nAwake)>(0x959C80);
	static inline auto FPhysicalize = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, int nPhysicsType, SmartScriptTable physicsParams)>(0x9727B0);
	static inline auto FSetAreaAffectsParticleEmitterPosition = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int bAreaAffectsParticleEmitterPosition)>(0x974BD0);
	static inline auto FSetPhysicParams = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97BC70);
	static inline auto FSetCharacterPhysicParams = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9767D0);
	static inline auto FActivatePlayerPhysics = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, bool bEnable)>(0x957F70);
	static inline auto FReattachSoftEntityVtx = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, ScriptHandle entityId, int partId)>(0x973730);
	static inline auto FPhysicalizeSlot = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot, SmartScriptTable physicsParams)>(0x972A60);
	static inline auto FUpdateSlotPhysics = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot)>(0x97F350);
	static inline auto FSetColliderMode = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int mode)>(0x976BA0);
	static inline auto FSelectPipe = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x974370);
	static inline auto FIsUsingPipe = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x96A9F0);
	static inline auto FActivate = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int bActive)>(0x957BF0);
	static inline auto FIsActive = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9691E0);
	static inline auto FIsFromPool = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x96A010);
	static inline auto FSetUpdatePolicy = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nUpdatePolicy)>(0x97DBF0);
	static inline auto FSetLocalBBox = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, Vec3 vMin, Vec3 vMax)>(0x97B620);
	static inline auto FGetLocalBBox = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9633F0);
	static inline auto FGetWorldBBox = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x966CD0);
	static inline auto FGetProjectedWorldBBox = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x964790);
	static inline auto FSetTriggerBBox = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, Vec3 vMin, Vec3 vMax)>(0x97DAB0);
	static inline auto FGetTriggerBBox = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9664D0);
	static inline auto FInvalidateTrigger = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x969090);
	static inline auto FForwardTriggerEventsTo = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, ScriptHandle entityId)>(0x95EAD0);
	static inline auto FSetUpdateRadius = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97DC30);
	static inline auto FGetUpdateRadius = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x966630);
	static inline auto FTriggerEvent = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97EF60);
	static inline auto FGetHelperPos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x962560);
	static inline auto FGetHelperDir = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9621A0);
	static inline auto FGetHelperAngles = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x961A60);
	static inline auto FGetSlotHelperPos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot, const char* helperName, bool objectSpace)>(0x965420);
	static inline auto FGetBonePos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9604D0);
	static inline auto FGetBoneDir = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95F9E0);
	static inline auto FGetBoneUp = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x960730);
	static inline auto FGetBoneGlobal = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const Vec3& _trgDir)>(0x95FA20);
	static inline auto FGetBoneVelocity = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* boneName)>(0x960760);
	static inline auto FGetBoneAngularVelocity = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* boneName)>(0x95F870);
	static inline auto FGetBoneNameFromTable = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x960360);
	static inline auto FSetName = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97BB30);
	static inline auto FGetName = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x963EE0);
	static inline auto FGetRawId = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x964FA0);
	static inline auto FSetAIName = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x974790);
	static inline auto FGetAIName = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95ECA0);
	static inline auto FSetFlags = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int flags, int mode)>(0x97AE20);
	static inline auto FGetFlags = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9616C0);
	static inline auto FHasFlags = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int flags)>(0x9675B0);
	static inline auto FSetFlagsExtended = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int flags, int mode)>(0x97AEA0);
	static inline auto FGetFlagsExtended = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x961760);
	static inline auto FHasFlagsExtended = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int flags)>(0x967660);
	static inline auto FGetArchetype = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95F2B0);
	static inline auto FIntersectRay = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot, Vec3 rayOrigin, Vec3 rayDir, float maxDistance)>(0x9683C0);
	static inline auto FAttachChild = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, ScriptHandle childEntityId, int flags)>(0x959980);
	static inline auto FDetachThis = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95CC90);
	static inline auto FDetachAll = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95CBD0);
	static inline auto FGetParent = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9640C0);
	static inline auto FGetChildCount = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x960B40);
	static inline auto FGetChild = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nIndex)>(0x960AA0);
	static inline auto FEnableInheritXForm = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, bool bEnable)>(0x95E4F0);
	static inline auto FNetPresent = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x96C9E0);
	static inline auto FRenderShadow = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x973C50);
	static inline auto FSetRegisterInSectors = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97C390);
	static inline auto FIsColliding = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x969370);
	static inline auto FGetDirectionVector = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x960D30);
	static inline auto FSetDirectionVector = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, Vec3 dir)>(0x976E10);
	static inline auto FIsAnimationRunning = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, int layer)>(0x969280);
	static inline auto FAddImpulse = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x958DA0);
	static inline auto FAddConstraint = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x958080);
	static inline auto FSetPublicParam = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97BF20);
	static inline auto FGetAllAuxAudioProxiesID = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95EDB0);
	static inline auto FGetDefaultAuxAudioProxyID = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x960CC0);
	static inline auto FCreateAuxAudioProxy = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95C390);
	static inline auto FRemoveAuxAudioProxy = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const ScriptHandle hAudioProxyLocalID)>(0x9738E0);
	static inline auto FExecuteAudioTrigger = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const ScriptHandle hTriggerID, const ScriptHandle hAudioProxyLocalID)>(0x95E760);
	static inline auto FStopAudioTrigger = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const ScriptHandle hTriggerID, const ScriptHandle hAudioProxyLocalID)>(0x97EB60);
	static inline auto FSetAudioSwitchState = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const ScriptHandle hSwitchID, const ScriptHandle hSwitchStateID, const ScriptHandle hAudioProxyLocalID)>(0x976640);
	static inline auto FSetFadeDistance = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const float fFadeDistance)>(0x97ACD0);
	static inline auto FSetAudioProxyOffset = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const Vec3 vOffset, const ScriptHandle hAudioProxyLocalID)>(0x976360);
	static inline auto FSetAudioProxyAttenuationScale = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const float _fScale, const ScriptHandle _hAudioProxyLocalID)>(0x976220);
	static inline auto FSetEnvironmentFadeDistance = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const float fEnvironmentFadeDistance)>(0x97ABB0);
	static inline auto FSetAudioEnvironmentID = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const ScriptHandle hAudioEnvironmentID)>(0x975E70);
	static inline auto FSetCurrentAudioEnvironments = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x976C10);
	static inline auto FSetAudioRtpcValue = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const ScriptHandle hRtpcID, const float fValue, const ScriptHandle hAudioProxyLocalID)>(0x9764E0);
	static inline auto FSetGeomCachePlaybackTime = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, float time)>(0x97B0A0);
	static inline auto FSetGeomCacheParams = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, bool looping, const char* standIn, const char* standInMaterial, const char* firstFrameStandIn, const char* firstFrameStandInMaterial, const char* lastFrameStandIn, const char* lastFrameStandInMaterial, float standInDistance, float streamInDistance)>(0x97AF80);
	static inline auto FSetGeomCacheStreaming = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, bool active, float time)>(0x97B160);
	static inline auto FIsGeomCacheStreaming = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x96A0B0);
	static inline auto FGetGeomCachePrecachedTime = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x961800);
	static inline auto FSetGeomCacheDrawing = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, bool active)>(0x97AF20);
	static inline auto FSetGeomCacheSortOffset = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, float _sortOffset)>(0x97B100);
	static inline auto FStartAnimation = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97E3E0);
	static inline auto FStopAnimation = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, int layer)>(0x97EAE0);
	static inline auto FResetAnimation = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, int layer)>(0x9740E0);
	static inline auto FRedirectAnimationToLayer0 = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, bool redirect)>(0x974A90);
	static inline auto FSetAnimationBlendOut = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, int layer, float blendOut)>(0x974A90);
	static inline auto FEnableBoneAnimation = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, int layer, const char* boneName, bool status)>(0x974A90);
	static inline auto FEnableBoneAnimationAll = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, int layer, bool status)>(0x974A90);
	static inline auto FEnableProceduralFacialAnimation = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, bool enable)>(0x95E700);
	static inline auto FPlayFacialAnimation = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, char* name, bool looping)>(0x972D20);
	static inline auto FSetAnimationEvent = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, const char* sAnimation)>(0x1CBB0B0);
	static inline auto FSetAnimationKeyEvent = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x1CBB0B0);
	static inline auto FDisableAnimationEvent = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, const char* sAnimation)>(0x1CBB0B0);
	static inline auto FSetAnimationSpeed = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, int layer, float speed)>(0x974AD0);
	static inline auto FSetAnimationTime = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, int nLayer, float fNormalizedTime)>(0x974B60);
	static inline auto FGetAnimationTime = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, int nLayer)>(0x95F1C0);
	static inline auto FGetNumQueuedAnimations = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, int nLayer)>(0x963FC0);
	static inline auto FGetCurAnimation = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x960BE0);
	static inline auto FGetAnimationLength = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* animation)>(0x95F060);
	static inline auto FSetAnimationFlip = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, Vec3 flip)>(0x974A90);
	static inline auto FSetTimer = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97D9B0);
	static inline auto FKillTimer = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x96AB90);
	static inline auto FSetScriptUpdateRate = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nMillis)>(0x97C4C0);
	static inline auto FGotoState = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const char* sStateName)>(0x9674D0);
	static inline auto FIsInState = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const char* sStateName)>(0x96A210);
	static inline auto FGetState = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x965B50);
	static inline auto FIsHidden = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x96A170);
	static inline auto FGetTouchedSurfaceID = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9663C0);
	static inline auto FGetTouchedPoint = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9660D0);
	static inline auto FCreateBoneAttachment = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* boneName, const char* attachmentName)>(0x95C540);
	static inline auto FCreateSkinAttachment = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* attachmentName)>(0x95C8C0);
	static inline auto FDestroyAttachment = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* attachmentName)>(0x95CA80);
	static inline auto FGetAttachmentBone = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* attachmentName)>(0x95F3A0);
	static inline auto FGetAttachmentCGF = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* attachmentName)>(0x95F4C0);
	static inline auto FResetAttachment = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* attachmentName)>(0x9740F0);
	static inline auto FSetAttachmentEffect = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* attachmentName, const char* effectName, Vec3 offset, Vec3 dir, float scale, int flags)>(0x975720);
	static inline auto FSetAttachmentObject = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* attachmentName, ScriptHandle entityId, int slot, int flags)>(0x975BA0);
	static inline auto FSetAttachmentCGF = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* attachmentName, const char* filePath)>(0x974F60);
	static inline auto FSetAttachmentLight = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* attachmentName, SmartScriptTable lightTable, int flags)>(0x975890);
	static inline auto FSetAttachmentPos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* attachmentName, Vec3 pos)>(0x975DA0);
	static inline auto FSetAttachmentAngles = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* attachmentName, Vec3 angles)>(0x974D30);
	static inline auto FSetAttachmentDir = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* attachmentName, Vec3 dir, bool worldSpace)>(0x975080);
	static inline auto FHideAttachment = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* attachmentName, bool hide, bool hideShadow)>(0x967920);
	static inline auto FHideAllAttachments = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, bool hide, bool hideShadow)>(0x967810);
	static inline auto FHideAttachmentMaster = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, bool hide)>(0x9679D0);
	static inline auto FPhysicalizeAttachment = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, const char* attachmentName, bool physicalize)>(0x9729C0);
	static inline auto FDamage = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x77DB10);
	static inline auto FGetExplosionObstruction = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9615B0);
	static inline auto FGetExplosionImpulse = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x961490);
	static inline auto FSetMaterial = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97B870);
	static inline auto FGetMaterial = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x963990);
	static inline auto FGetEntityMaterial = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x961360);
	static inline auto FChangeAttachmentMaterial = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const char* attachmentName, const char* materialName)>(0x95A670);
	static inline auto FCloneAttachmentMaterial = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* _pH, int _characterSlot, const char* _attachmentName)>(0x95BFE0);
	static inline auto FSetAttachmentMaterialFloat = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int _characterSlot, const char* _attachmentName, int _nSubMtlId, int _nParam, float _fValue)>(0x975A00);
	static inline auto FSetAttachmentMaterialVec3 = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int _characterSlot, const char* _attachmentName, int _nSubMtlId, int _nParam, Vec3 _vValue)>(0x975AB0);
	static inline auto FGetAttachmentMaterialVec3 = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int _characterSlot, const char* _attachmentName, int _nSubMtlId, int _nParam)>(0x95F680);
	static inline auto FReplaceMaterial = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot, const char* name, const char* replacement)>(0x973DD0);
	static inline auto FResetMaterial = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot)>(0x974170);
	static inline auto FEnableMaterialLayer = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, bool enable, int layer)>(0x95E530);
	static inline auto FCloneMaterial = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot)>(0x95C0A0);
	static inline auto FSetMaterialFloat = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot, int nSubMtlId, int _nParam, float fValue)>(0x97B9A0);
	static inline auto FGetMaterialFloat = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot, int nSubMtlId, int _nParam)>(0x963BF0);
	static inline auto FSetMaterialVec3 = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot, int nSubMtlId, int _nParam, Vec3 vValue)>(0x97BA50);
	static inline auto FGetMaterialVec3 = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot, int nSubMtlId, int _nParam)>(0x963D10);
	static inline auto FMaterialFlashInvoke = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x96C2D0);
	static inline auto FToLocal = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slotId, Vec3 point)>(0x97EE10);
	static inline auto FToGlobal = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slotId, Vec3 point)>(0x97EC10);
	static inline auto FVectorToLocal = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slotId, Vec3 dir)>(0x97F530);
	static inline auto FVectorToGlobal = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slotId, Vec3 dir)>(0x97F390);
	static inline auto FCheckCollisions = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95A910);
	static inline auto FAwakeEnvironment = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x959D30);
	static inline auto FGetTimeSinceLastSeen = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x965FF0);
	static inline auto FGetViewDistRatio = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9669D0);
	static inline auto FSetViewDistRatio = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97DE50);
	static inline auto FSetViewDistUnlimited = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97DF60);
	static inline auto FSetLodRatio = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97B760);
	static inline auto FGetLodRatio = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x963740);
	static inline auto FSetStateClientside = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97D8E0);
	static inline auto FInsertSubpipe = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x968040);
	static inline auto FCancelSubpipe = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95A4D0);
	static inline auto FPassParamsToPipe = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9726A0);
	static inline auto FSetDefaultIdleAnimations = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x976D20);
	static inline auto FGetVelocity = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x966720);
	static inline auto FGetVelocityEx = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x966840);
	static inline auto FSetVelocity = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, Vec3 velocity)>(0x97DD10);
	static inline auto FSetVelocityEx = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, Vec3 velocity, Vec3 angularVelocity)>(0x97DDA0);
	static inline auto FGetSpeed = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9659A0);
	static inline auto FGetMass = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x963810);
	static inline auto FGetVolume = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot)>(0x966AA0);
	static inline auto FGetGravity = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9618C0);
	static inline auto FGetSubmergedVolume = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot, Vec3 planeNormal, Vec3 planeOrigin)>(0x965C10);
	static inline auto FCreateLink = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const char* name)>(0x95C740);
	static inline auto FGetLinkName = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, ScriptHandle targetId)>(0x962E40);
	static inline auto FSetLinkTarget = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const char* name, ScriptHandle targetId)>(0x97B380);
	static inline auto FGetLinkTarget = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const char* name)>(0x962FC0);
	static inline auto FRemoveLink = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const char* name)>(0x973A60);
	static inline auto FRemoveAllLinks = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9738B0);
	static inline auto FGetLink = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int ith)>(0x962CF0);
	static inline auto FCountLinks = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95C2C0);
	static inline auto FRemoveDecals = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x973A00);
	static inline auto FEnableDecals = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot, bool enable)>(0x95E490);
	static inline auto FForceCharacterUpdate = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, bool updateAlways)>(0x95EA10);
	static inline auto FCharacterUpdateAlways = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, bool updateAlways)>(0x95A810);
	static inline auto FCharacterUpdateOnRender = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int characterSlot, bool bUpdateOnRender)>(0x95A890);
	static inline auto FSetAnimateOffScreenShadow = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, bool bAnimateOffScreenShadow)>(0x974A30);
	static inline auto FRagDollize = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot)>(0x9732A0);
	static inline auto FHide = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x967710);
	static inline auto FNoExplosionCollision = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x96CBA0);
	static inline auto FNoBulletForce = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, bool state)>(0x96CAB0);
	static inline auto FUpdateAreas = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97F1D0);
	static inline auto FIsPointInsideArea = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int areaId, Vec3 point)>(0x96A2F0);
	static inline auto FIsEntityInsideArea = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int areaId, ScriptHandle entityId)>(0x969870);
	static inline auto FGetPhysicalStats = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x964320);
	static inline auto FSetParentSlot = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int child, int parent)>(0x97BC20);
	static inline auto FGetParentSlot = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int child)>(0x9641A0);
	static inline auto FBreakToPieces = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, int nPiecesSlot, float fExplodeImp, Vec3 vHitPt, Vec3 vHitImp, float fLifeTime, bool bMaterialEffects)>(0x959FE0);
	static inline auto FAttachSurfaceEffect = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, const char* effect, bool countPerUnit, const char* form, const char* typ, float countScale, float sizeScale)>(0x959A30);
	static inline auto FProcessBroadcastEvent = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x9731B0);
	static inline auto FActivateOutput = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x957C30);
	static inline auto FCreateCameraProxy = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x95C680);
	static inline auto FUnSeenFrames = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x97F0E0);
	static inline auto FDeleteParticleEmitter = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int slot)>(0x95C970);
	static inline auto FRegisterForAreaEvents = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int enable)>(0x9737C0);
	static inline auto FRenderAlways = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int enable)>(0x973B60);
	static inline auto FGetTimeOfDayHour = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x965F60);
	static inline auto FGetAttachmentPos = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, const char* _attachmentName)>(0x95F7E0);
	static inline auto FSetDisplayName = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* const _pH, const char* _pName)>(0x9771C0);
	static inline auto FGetDisplayName = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* const _pH)>(0x960F30);
	static inline auto FSetAsSceneWindow = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, bool _bIsSceneWindow)>(0x974CC0);
	static inline auto FSetEntireMaterialFloat = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* const pH, const int _slot, const char* const _paramName, float _value)>(0x977200);
	static inline auto FRenderBeginMorphingSwipe = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, int nSlot, int nEnable, float time)>(0x973BE0);
	static inline auto FGetEntity = PreyFunction<IEntity* (CScriptBind_Entity* const _this, IFunctionHandler* pH)>(0x961180);
	static inline auto FSetEntityPhysicParams = PreyFunction<int(CScriptBind_Entity* const _this, IFunctionHandler* pH, IPhysicalEntity* pe, int nType, IScriptTable* pTable, ICharacterInstance* pIChar)>(0x977350);
	static inline auto FParseLightParams = PreyFunction<bool(CScriptBind_Entity* const _this, IScriptTable* pLightTable, IEntity* pEntity, CDLight& light)>(0x96E330);
	static inline auto FParseFogVolumesParams = PreyFunction<bool(CScriptBind_Entity* const _this, IScriptTable* pTable, IEntity* pEntity, SFogVolumeProperties& properties)>(0x96D6E0);
	static inline auto FParseVolumeObjectMovementProperties = PreyFunction<bool(CScriptBind_Entity* const _this, IScriptTable* pTable, IEntity* pEntity, SVolumeObjectMovementProperties& properties)>(0x972440);
	static inline auto FParsePhysicsParams = PreyFunction<bool(CScriptBind_Entity* const _this, IScriptTable* pTable, SEntityPhysicalizeParams& params)>(0x9705E0);
	static inline auto FcmpIntersectionResult = PreyFunction<int(const void* v1, const void* v2)>(0x1CBB0B0);
	static inline auto FOnAudioTriggerFinishedEvent = PreyFunction<void(const SAudioRequestInfo* const pAudioRequestInfo)>(0x96D670);
	static inline auto FIStatObjRayIntersect = PreyFunction<int(CScriptBind_Entity* const _this, IStatObj* pStatObj, const Vec3& rayOrigin, const Vec3& rayDir, float maxDistance, CScriptBind_Entity::SIntersectionResult* pOutResult, unsigned maxResults)>(0x967A30);
};
#endif // !MOONCRASH
