...
struct IEntitySystem
{
	...
	virtual std::vector<string> *GetArchetypeNames(std::vector<CryStringT<char>> *result, const CryStringT<char> *) = 0;
	virtual std::vector<IEntityArchetype *> *GetArchetypes(std::vector<IEntityArchetype *> *result, const CryStringT<char> *) = 0;
