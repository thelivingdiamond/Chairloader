...
struct IEntityProxy : public IComponent
{
	...
	virtual ComponentEventPriority GetEventPriority(const int eventID) const override { return ENTITY_PROXY_LAST - const_cast<IEntityProxy*>(this)->GetType(); }
...
struct SEntityPhysicalizeParams
{
	...
	struct pe_params_collision_class *pCollisionParams;
...
struct IEntityPhysicalProxy : public IEntityProxy
{
	...
	virtual void EnablePhysicsForSerialization(bool bEnable) = 0;
...
enum EEntitySlotFlags
{
	...
	ENTITY_SLOT_HIDDEN_IN_PROBES = 0x0020,
};
...
struct IEntityRenderProxy : public IEntityProxy
{
	...
	virtual void ResetMorphing(int, bool) = 0;
	virtual void BeginMorphingSwipe(int, bool, float) = 0;
	virtual void BeginShiftEffect(const char *, const Vec3_tpl<float> *) = 0;
	virtual void EndShiftEffect() = 0;
	virtual void SetSlotAlpha(int, float) = 0;
	virtual void SetHighlightColor(const Color_tpl<float> *) = 0;
	virtual void SetGlintConfig(const ArkGlintConfig *) = 0;
	...
	virtual void ForceDissolve(bool, float) = 0;
	...
	virtual int GetFirstRenderedSlot() = 0;
	...
	virtual void SetCastShadowViewDistRatio(int) = 0;
	virtual void SetLodRatio(int) = 0;
	virtual void SetEntitySceneMask(unsigned __int8) = 0;
	virtual void SetEntitySceneWindow(bool) = 0;
	virtual void SetShouldGlint(bool) = 0;
	virtual void UpdateLightBounds() = 0;
