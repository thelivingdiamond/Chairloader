...
enum EERType
{
	...
	eERType_ArkRemoved_03,
	eERType_RenderProxy,
	eERType_GameEffect,
	eERType_ArkRemoved_04,
	eERType_Dummy_3,
	eERType_MergedMesh,
	eERType_GeomCache,
	eERType_ArkBreakableGlass,
...
struct IShadowCaster
{
	...
	uint8                              m_shadowCasterType;
	uint8                              m_ucCastShadowViewDistRatio;
	int8                               m_cShadowLodBias;
	float                              m_fWSMaxCastShadowViewDist;
};
...
struct IRenderNode : public IShadowCaster
{
	...
	//virtual EERType    GetRenderNodeType() = 0;
	virtual float GetMaxCastShadowViewDist() = 0;
	...
	virtual void SetSceneMask(unsigned __int8) = 0;
	virtual void SetSceneWindow(bool) = 0;
...
public:
	...
	//int8              m_cShadowLodBias;
	unsigned char m_nSceneMask;
};

inline void IRenderNode::SetViewDistRatio(int nViewDistRatio)
{
	nViewDistRatio = std::clamp(nViewDistRatio, 0, 255);
