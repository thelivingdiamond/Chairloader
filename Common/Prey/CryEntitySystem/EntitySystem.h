...
public:
	...
	static inline auto FRelease = PreyFunction<void(CEntitySystem* const _this)>(0x3E3960);
	static inline auto FUpdate = PreyFunction<void(CEntitySystem* const _this)>(0x943F70);
	static inline auto FDeletePendingEntities = PreyFunction<void(CEntitySystem* const _this)>(0x93DE00);
	static inline auto FPrePhysicsUpdate = PreyFunction<void(CEntitySystem* const _this)>(0x9416A0);
	static inline auto FReset = PreyFunction<void(CEntitySystem* const _this)>(0x942520);
	static inline auto FUnload = PreyFunction<void(CEntitySystem* const _this)>(0x943D10);
	static inline auto FPurgeHeaps = PreyFunction<void(CEntitySystem* const _this)>(0x941920);
	static inline auto FEditorReset = PreyFunction<void(CEntitySystem* const _this, bool _bEnteringGameMode)>(0x93EDB0);
	static inline auto FGetClassRegistry = PreyFunction<IEntityClassRegistry* (CEntitySystem* const _this)>(0x93F3F0);
	static inline auto FSpawnEntityInternal = PreyFunction<IEntity* (CEntitySystem* const _this, SEntitySpawnParams& params, bool bAutoInit)>(0x943990);
	static inline auto FSpawnEntityFromArchetype = PreyFunction<IEntity* (CEntitySystem* const _this, IEntityArchetype* _pArchetype, SEntitySpawnParams& _params, bool _bAutoInit)>(0x943600);
	static inline auto FSpawnEntity = PreyFunction<IEntity* (CEntitySystem* const _this, SEntitySpawnParams& _params, bool _bAutoInit)>(0x9435E0);
	static inline auto FInitEntity = PreyFunction<bool(CEntitySystem* const _this, IEntity* pEntity, SEntitySpawnParams& params)>(0x940250);
	static inline auto FGetEntity = PreyFunction<IEntity* (const CEntitySystem* const _this, unsigned id)>(0x93F470);
	static inline auto FArkSafeGetEntity = PreyFunction<IEntity* (const CEntitySystem* const _this, unsigned _id)>(0x93C0E0);
	static inline auto FGetClonedEntityId = PreyFunction<unsigned(const CEntitySystem* const _this, unsigned origId, unsigned refId)>(0x93F400);
	static inline auto FFindEntityByName = PreyFunction<IEntity* (const CEntitySystem* const _this, const char* sEntityName)>(0x93F050);
	static inline auto FReserveEntityId = PreyFunction<void(CEntitySystem* const _this, const unsigned id)>(0x942450);
	static inline auto FReserveUnknownEntityId = PreyFunction<unsigned(CEntitySystem* const _this)>(0x942490);
	static inline auto FRemoveEntity = PreyFunction<void(CEntitySystem* const _this, unsigned entity, bool bForceRemoveNow)>(0x941C80);
	static inline auto FGetNumEntities = PreyFunction<unsigned(const CEntitySystem* const _this)>(0x93FE50);
	static inline auto FGetEntityIterator = PreyFunction<IEntityIt* (CEntitySystem* const _this)>(0x93F4E0);
	static inline auto FSendEventViaEntityEvent = PreyFunction<void(CEntitySystem* const _this, IEntity* piEntity, SEntityEvent& event)>(0x942D60);
	static inline auto FSendEventToAll = PreyFunction<void(CEntitySystem* const _this, SEntityEvent& event)>(0x942C20);
	static inline auto FQueryProximity = PreyFunction<int(CEntitySystem* const _this, SEntityProximityQuery& query)>(0x941990);
	static inline auto FResizeProximityGrid = PreyFunction<void(CEntitySystem* const _this, int nWidth, int nHeight)>(0x942BF0);
	static inline auto FGetPhysicalEntitiesInBox = PreyFunction<int(const CEntitySystem* const _this, const Vec3& origin, float radius, IPhysicalEntity* * & pList, int physFlags, const char* _debugString)>(0x93FE90);
	static inline auto FGetEntityFromPhysics = PreyFunction<IEntity* (const CEntitySystem* const _this, IPhysicalEntity* pPhysEntity)>(0x93F4C0);
	static inline auto FAddSink = PreyFunction<void(CEntitySystem* const _this, IEntitySystemSink* pSink, unsigned subscriptions, uint64_t onEventSubscriptions)>(0x93BF70);
	static inline auto FRemoveSink = PreyFunction<void(CEntitySystem* const _this, IEntitySystemSink* pSink)>(0x942250);
	static inline auto FPauseTimers = PreyFunction<void(CEntitySystem* const _this, bool bPause, bool bResume)>(0x9413B0);
	static inline auto FIsIDUsed = PreyFunction<bool(const CEntitySystem* const _this, unsigned nID)>(0x940490);
	static inline auto FGetMemoryStatistics = PreyFunction<void(const CEntitySystem* const _this, ICrySizer* pSizer)>(0x93FB30);
	static inline auto FGetSystem = PreyFunction<ISystem* (const CEntitySystem* const _this)>(0x105410);
	static inline auto FSetNextSpawnId = PreyFunction<void(CEntitySystem* const _this, unsigned id)>(0x943380);
	static inline auto FResetAreas = PreyFunction<void(CEntitySystem* const _this)>(0x942AD0);
	static inline auto FUnloadAreas = PreyFunction<void(CEntitySystem* const _this)>(0x943E10);
	static inline auto FAddEntityEventListener = PreyFunction<void(CEntitySystem* const _this, unsigned nEntity, EEntityEvent event, IEntityEventListener* pListener)>(0x93BC80);
	static inline auto FRemoveEntityEventListenerOv1 = PreyFunction<void(CEntitySystem* const _this, unsigned nEntity, EEntityEvent event, IEntityEventListener* pListener)>(0x941F10);
	static inline auto FHasEntityEventListener = PreyFunction<bool(const CEntitySystem* const _this, const IEntityEventListener& _listener)>(0x940080);
	static inline auto FIsEntityStatic = PreyFunction<bool(const CEntitySystem* const _this, unsigned _id)>(0x940460);
	static inline auto FFindEntityByGuid = PreyFunction<unsigned(const CEntitySystem* const _this, const uint64_t& guid)>(0x93EFC0);
	static inline auto FFindEntityByEditorGuid = PreyFunction<unsigned(const CEntitySystem* const _this, const char* pGuid)>(0x93EFB0);
	static inline auto FLoadEntityArchetypeOv1 = PreyFunction<IEntityArchetype* (CEntitySystem* const _this, XmlNodeRef oArchetype)>(0x940860);
	static inline auto FLoadEntityArchetypeOv0 = PreyFunction<IEntityArchetype* (CEntitySystem* const _this, const char* sArchetype)>(0x940850);
	static inline auto FFindEntityArchetype = PreyFunction<IEntityArchetype* (const CEntitySystem* const _this, const char* _archetypeName)>(0x93EFA0);
	static inline auto FCreateEntityArchetype = PreyFunction<IEntityArchetype* (CEntitySystem* const _this, IEntityClass* pClass, const char* sArchetype, uint64_t _id)>(0x93C710);
	static inline auto FGetEntityArchetypeOv1 = PreyFunction<IEntityArchetype* (CEntitySystem* const _this, uint64_t _id)>(0x93F4B0);
	static inline auto FGetEntityArchetypeOv0 = PreyFunction<const IEntityArchetype* (const CEntitySystem* const _this, uint64_t _id)>(0x93F4B0);
	static inline auto FGetArchetypeId = PreyFunction<uint64_t(const CEntitySystem* const _this, const char* _archetypeName)>(0x93F350);
	static inline auto FDeleteEntityArchetype = PreyFunction<void(CEntitySystem* const _this, const char* _archetypeName)>(0x93DDF0);
	static inline auto FRenameArchetype = PreyFunction<void(const CEntitySystem* const _this, const char* _archetypeName, const char* _newArchetypeName)>(0x942440);
	static inline auto FGetArchetypeNames = PreyFunction<std::vector<string>*(const CEntitySystem* const _this, std::vector<string>* _return_value_, const string& _libraryName)>(0x93F390);
	static inline auto FGetArchetypes = PreyFunction<std::vector<IEntityArchetype*>*(const CEntitySystem* const _this, std::vector<IEntityArchetype*>* _return_value_, const string& _libraryName)>(0x93F3B0);
	static inline auto FLoadArchetypeLibrary = PreyFunction<bool(CEntitySystem* const _this, const string& _libraryName)>(0x940730);
	static inline auto FRegisterEntityArchetypeListener = PreyFunction<void(CEntitySystem* const _this, IEntityArchetypeListener* _pListener)>(0x941B80);
	static inline auto FUnregisterEntityArchetypeListener = PreyFunction<void(CEntitySystem* const _this, IEntityArchetypeListener* _pListener)>(0x943F30);
	static inline auto FSerialize = PreyFunction<void(CEntitySystem* const _this, TSerialize ser)>(0x942D70);
	static inline auto FDumpEntities = PreyFunction<void(CEntitySystem* const _this)>(0x93E760);
	static inline auto FGetLayerId = PreyFunction<int(const CEntitySystem* const _this, const char* szLayerName)>(0x93F790);
	static inline auto FGetLayerName = PreyFunction<const char* (const CEntitySystem* const _this, int layerId)>(0x93F800);
	static inline auto FGetLayerChildCount = PreyFunction<int(const CEntitySystem* const _this, const char* szLayerName)>(0x93F5C0);
	static inline auto FGetLayerChild = PreyFunction<const char* (const CEntitySystem* const _this, const char* szLayerName, int childIdx)>(0x93F530);
	static inline auto FGetVisibleLayerIDs = PreyFunction<int(const CEntitySystem* const _this, uint8_t* pLayerMask, const unsigned maxCount)>(0x93FF90);
	static inline auto FLockSpawning = PreyFunction<void(CEntitySystem* const _this, bool lock)>(0x940E20);
	static inline auto FIsSpawningLocked = PreyFunction<bool(const CEntitySystem* const _this)>(0x940630);
	static inline auto FOnLoadLevel = PreyFunction<bool(CEntitySystem* const _this, const char* szLevelPath)>(0x9412D0);
	static inline auto FOnLevelEnd = PreyFunction<void(CEntitySystem* const _this)>(0x941270);
	static inline auto FOnLevelLoadStart = PreyFunction<void(CEntitySystem* const _this)>(0x9412C0);
	static inline auto FAddLayer = PreyFunction<CEntityLayer* (CEntitySystem* const _this, const char* name, const char* parent, uint16_t id, bool bHasPhysics, int specs, bool bDefaultLoaded, int _loadTokenId, int _loadTokenValue)>(0x93BD30);
	static inline auto FGetLayersState = PreyFunction<std::vector<bool>*(const CEntitySystem* const _this, std::vector<bool>* _return_value_)>(0x93F8A0);
	static inline auto FLoadLayers = PreyFunction<void(CEntitySystem* const _this, const char* dataFile)>(0x940A70);
	static inline auto FLinkLayerChildren = PreyFunction<void(CEntitySystem* const _this)>(0x940660);
	static inline auto FAddEntityToLayer = PreyFunction<void(CEntitySystem* const _this, const char* layer, unsigned id)>(0x93BD00);
	static inline auto FRemoveEntityFromLayers = PreyFunction<void(CEntitySystem* const _this, unsigned id)>(0x9421B0);
	static inline auto FGetLayerNameForEntity = PreyFunction<const char* (CEntitySystem* const _this, unsigned id)>(0x93F880);
	static inline auto FClearLayers = PreyFunction<void(CEntitySystem* const _this)>(0x93C380);
	static inline auto FEnableDefaultLayers = PreyFunction<void(CEntitySystem* const _this, bool isSerialized)>(0x93EDC0);
	static inline auto FEnableLayer = PreyFunction<void(CEntitySystem* const _this, const char* layer, bool _bIsVisible, bool isEnable, bool isSerialized)>(0x93EE80);
	static inline auto FIsLayerEnabled = PreyFunction<bool(const CEntitySystem* const _this, const char* layer, bool bMustBeLoaded)>(0x940590);
	static inline auto FShouldSerializedEntity = PreyFunction<bool(CEntitySystem* const _this, IEntity* pEntity)>(0x943440);
	static inline auto FRegisterPhysicCallbacks = PreyFunction<void(CEntitySystem* const _this)>(0x941C00);
	static inline auto FUnregisterPhysicCallbacks = PreyFunction<void(CEntitySystem* const _this)>(0x943F50);
	static inline auto FFindLayer = PreyFunction<CEntityLayer* (CEntitySystem* const _this, const char* layer)>(0x93F150);
	static inline auto FMarkEntityAsUsingPlayerTime = PreyFunction<void(CEntitySystem* const _this, const IEntity& rEntity)>(0x940E30);
	static inline auto FUnmarkEntityAsUsingPlayerTime = PreyFunction<void(CEntitySystem* const _this, const IEntity& rEntity)>(0x943E40);
	static inline auto FShouldEntityUsePlayerTime = PreyFunction<bool(const CEntitySystem* const _this, const IEntity& rEntity)>(0x9433F0);
	static inline auto FGetLayerForEntity = PreyFunction<CEntityLayer* (CEntitySystem* const _this, unsigned id)>(0x93F640);
	static inline auto FOnBeforeSpawn = PreyFunction<bool(CEntitySystem* const _this, SEntitySpawnParams& params)>(0x940F10);
	static inline auto FOnEntityReused = PreyFunction<void(CEntitySystem* const _this, IEntity* pEntity, SEntitySpawnParams& params)>(0x9411C0);
	static inline auto FAddTimerEvent = PreyFunction<void(CEntitySystem* const _this, SEntityTimerEvent& event, CTimeValue startTime)>(0x93C020);
	static inline auto FLoadEntitiesOv1 = PreyFunction<void(CEntitySystem* const _this, XmlNodeRef& objectsNode, bool bIsLoadingLevelFile)>(0x940740);
	static inline auto FLoadEntitiesOv0 = PreyFunction<void(CEntitySystem* const _this, XmlNodeRef& objectsNode, bool bIsLoadingLevelFile, const Vec3& segmentOffset, std::vector<IEntity*>* outGlobalEntityIds, std::vector<IEntity*>* outLocalEntityIds)>(0x940810);
	static inline auto FHoldLayerEntities = PreyFunction<void(CEntitySystem* const _this, const char* pLayerName)>(0x940110);
	static inline auto FCloneHeldLayerEntities = PreyFunction<void(CEntitySystem* const _this, const char* pLayerName, const Vec3& localOffset, const Matrix34& l2w, const char* * pExcludeLayers, int numExcludeLayers)>(0x93C440);
	static inline auto FReleaseHeldEntities = PreyFunction<void(CEntitySystem* const _this)>(0x941C50);
	static inline auto FExtractEntityLoadParams = PreyFunction<bool(const CEntitySystem* const _this, XmlNodeRef& entityNode, SEntitySpawnParams& spawnParams)>(0x93EF90);
	static inline auto FBeginCreateEntities = PreyFunction<void(CEntitySystem* const _this, int nAmtToCreate)>(0x93C140);
	static inline auto FCreateEntity = PreyFunction<bool(CEntitySystem* const _this, XmlNodeRef& entityNode, SEntitySpawnParams& pParams, unsigned& outUsingId)>(0x93C700);
	static inline auto FEndCreateEntities = PreyFunction<void(CEntitySystem* const _this)>(0x93EF80);
	static inline auto FRemoveTimerEvent = PreyFunction<void(CEntitySystem* const _this, unsigned id, int nTimerId)>(0x942300);
	static inline auto FActivateEntity = PreyFunction<void(CEntitySystem* const _this, CEntity* pEntity, bool bActivate)>(0x93B910);
	static inline auto FActivatePrePhysicsUpdateForEntity = PreyFunction<void(CEntitySystem* const _this, CEntity* pEntity, bool bActivate)>(0x93BA70);
	static inline auto FIsPrePhysicsActive = PreyFunction<bool(CEntitySystem* const _this, CEntity* pEntity)>(0x9405D0);
	static inline auto FOnEntityEvent = PreyFunction<void(CEntitySystem* const _this, CEntity* pEntity, SEntityEvent& event)>(0x940FC0);
	static inline auto FGetAreaManager = PreyFunction<IAreaManager* (const CEntitySystem* const _this)>(0x93F3D0);
	static inline auto FGetBreakableManager = PreyFunction<IBreakableManager* (const CEntitySystem* const _this)>(0x93F3E0);
	static inline auto FGetIEntityPoolManager = PreyFunction<IEntityPoolManager* (const CEntitySystem* const _this)>(0x93F520);
	static inline auto FReloadAllEntityArchetypes = PreyFunction<void(CEntitySystem* const _this)>(0x941C60);
	static inline auto FReloadEntityArchetype = PreyFunction<void(CEntitySystem* const _this, const char* _sArchetype)>(0x941C70);
	static inline auto FGenerateEntityId = PreyFunction<unsigned(CEntitySystem* const _this, bool bStaticId)>(0x93F240);
	static inline auto FResetEntityId = PreyFunction<bool(CEntitySystem* const _this, CEntity* pEntity, unsigned newEntityId)>(0x942AF0);
	static inline auto FRegisterEntityGuid = PreyFunction<void(CEntitySystem* const _this, const uint64_t& guid, unsigned id)>(0x941B90);
	static inline auto FUnregisterEntityGuid = PreyFunction<void(CEntitySystem* const _this, const uint64_t& guid)>(0x943F40);
	static inline auto FChangeEntityName = PreyFunction<void(CEntitySystem* const _this, CEntity* pEntity, const char* sNewName)>(0x93C150);
	static inline auto FRemoveEntityEventListeners = PreyFunction<void(CEntitySystem* const _this, CEntity* pEntity)>(0x941FF0);
	static inline auto FGetEntityFromID = PreyFunction<CEntity* (const CEntitySystem* const _this, unsigned id)>(0x93F470);
	static inline auto FPurgeDeferredCollisionEvents = PreyFunction<void(CEntitySystem* const _this, bool bForce)>(0x941860);
	static inline auto FComponentRegister = PreyFunction<void(CEntitySystem* const _this, unsigned id, std::shared_ptr<IComponent> pComponent, const int flags)>(0x93C620);
	static inline auto FComponentEnableEvent = PreyFunction<void(CEntitySystem* const _this, const unsigned id, const int eventID, const bool enable)>(0x93C610);
	static inline auto FDebugDrawOv1 = PreyFunction<void(CEntitySystem* const _this)>(0x93CD80);
	static inline auto FDebugDrawOv0 = PreyFunction<void(CEntitySystem* const _this, CEntity* ce, float timeMs)>(0x93C720);
	static inline auto FCreateBSPTree3D = PreyFunction<IBSPTree3D* (CEntitySystem* const _this, const DynArray<DynArray<Vec3_tpl<float>,int,NArray::SmallDynStorage<NAlloc::AllocCompatible<NAlloc::ModuleAlloc> > >,int,NArray::SmallDynStorage<NAlloc::AllocCompatible<NAlloc::ModuleAlloc> > >& faceList)>(0x93C6D0);
	static inline auto FReleaseBSPTree3D = PreyFunction<void(CEntitySystem* const _this, IBSPTree3D* & pTree)>(0x941C20);
	static inline auto FSetSafeBounds = PreyFunction<void(CEntitySystem* const _this, const AABB& _safeBounds)>(0x9433D0);
	static inline auto FIsInSafeBounds = PreyFunction<bool(const CEntitySystem* const _this, const Vec3& _pos)>(0x9404B0);
	static inline auto FQueueEntityVisibilityNotify = PreyFunction<void(CEntitySystem* const _this, unsigned _entityId, float _distance)>(0x941A10);
	static inline auto FDoUpdateLoop = PreyFunction<void(CEntitySystem* const _this, float fFrameTime)>(0x93DE60);
	static inline auto FDeleteEntity = PreyFunction<void(CEntitySystem* const _this, CEntity* pEntity)>(0x93DC50);
	static inline auto FRemoveEntityFromActiveList = PreyFunction<void(CEntitySystem* const _this, CEntity* pEntity)>(0x942110);
	static inline auto FUpdateEngineCVars = PreyFunction<void(CEntitySystem* const _this)>(0x944450);
	static inline auto FUpdateTimers = PreyFunction<void(CEntitySystem* const _this)>(0x944810);
	static inline auto FDebugDrawEntityUsage = PreyFunction<void(CEntitySystem* const _this)>(0x93CD90);
	static inline auto FDebugDrawProximityTriggers = PreyFunction<void(CEntitySystem* const _this)>(0x93D980);
