...
#include <Prey/Cry3DEngine/IStatObj.h> // <> required for Interfuscator
#include <Prey/CryRenderer/IRenderer.h>
#include <Prey/CrySystem/IProcess.h>                 // <> required for Interfuscator
//#include <Cry3DEngine/IMaterial.h>              // <> required for Interfuscator
//#include <Cry3DEngine/ISurfaceType.h>           // <> required for Interfuscator
#include <Prey/CryEntitySystem/IEntityRenderState.h> // <> required for Interfuscator
...
{
	E3DPARAM_SUN_COLOR = 0x0,
	E3DPARAM_SKY_COLOR = 0x1,
	E3DPARAM_SUN_SPECULAR_MULTIPLIER = 0x2,
	E3DPARAM_AMBIENT_GROUND_COLOR = 0x3,
	E3DPARAM_AMBIENT_MIN_HEIGHT = 0x4,
	E3DPARAM_AMBIENT_MAX_HEIGHT = 0x5,
	E3DPARAM_FOG_COLOR = 0x6,
	E3DPARAM_FOG_COLOR2 = 0x7,
	E3DPARAM_FOG_RADIAL_COLOR = 0x8,
	E3DPARAM_VOLFOG_HEIGHT_DENSITY = 0x9,
	E3DPARAM_VOLFOG_HEIGHT_DENSITY2 = 0xA,
	E3DPARAM_VOLFOG_GRADIENT_CTRL = 0xB,
	E3DPARAM_VOLFOG_GLOBAL_DENSITY = 0xC,
	E3DPARAM_VOLFOG_RAMP = 0xD,
	E3DPARAM_VOLFOG_SHADOW_RANGE = 0xE,
	E3DPARAM_VOLFOG_SHADOW_DARKENING = 0xF,
	E3DPARAM_VOLFOG_SHADOW_ENABLE = 0x10,
	E3DPARAM_VOLFOG2_CTRL_PARAMS = 0x11,
	E3DPARAM_VOLFOG2_SCATTERING_PARAMS = 0x12,
	E3DPARAM_VOLFOG2_RAMP = 0x13,
	E3DPARAM_VOLFOG2_COLOR = 0x14,
	E3DPARAM_VOLFOG2_GLOBAL_DENSITY = 0x15,
	E3DPARAM_VOLFOG2_HEIGHT_DENSITY = 0x16,
	E3DPARAM_VOLFOG2_HEIGHT_DENSITY2 = 0x17,
	E3DPARAM_VOLFOG2_COLOR1 = 0x18,
	E3DPARAM_VOLFOG2_COLOR2 = 0x19,
	E3DPARAM_SKYLIGHT_SUN_INTENSITY = 0x1A,
	E3DPARAM_SKYLIGHT_KM = 0x1B,
	E3DPARAM_SKYLIGHT_KR = 0x1C,
	E3DPARAM_SKYLIGHT_G = 0x1D,
	E3DPARAM_SKYLIGHT_WAVELENGTH_R = 0x1E,
	E3DPARAM_SKYLIGHT_WAVELENGTH_G = 0x1F,
	E3DPARAM_SKYLIGHT_WAVELENGTH_B = 0x20,
	E3DPARAM_NIGHSKY_HORIZON_COLOR = 0x21,
	E3DPARAM_NIGHSKY_ZENITH_COLOR = 0x22,
	E3DPARAM_NIGHSKY_ZENITH_SHIFT = 0x23,
	E3DPARAM_NIGHSKY_STAR_INTENSITY = 0x24,
	E3DPARAM_NIGHSKY_MOON_DIRECTION = 0x25,
	E3DPARAM_NIGHSKY_MOON_COLOR = 0x26,
	E3DPARAM_NIGHSKY_MOON_SIZE = 0x27,
	E3DPARAM_NIGHSKY_MOON_INNERCORONA_COLOR = 0x28,
	E3DPARAM_NIGHSKY_MOON_INNERCORONA_SCALE = 0x29,
	E3DPARAM_NIGHSKY_MOON_OUTERCORONA_COLOR = 0x2A,
	E3DPARAM_NIGHSKY_MOON_OUTERCORONA_SCALE = 0x2B,
	E3DPARAM_CLOUDSHADING_MULTIPLIERS = 0x2C,
	E3DPARAM_CLOUDSHADING_SUNCOLOR = 0x2D,
	E3DPARAM_CLOUDSHADING_SKYCOLOR = 0x2E,
	E3DPARAM_CORONA_SIZE = 0x2F,
	E3DPARAM_SKY_HIGHLIGHT_COLOR = 0x30,
	E3DPARAM_SKY_HIGHLIGHT_SIZE = 0x31,
	E3DPARAM_SKY_HIGHLIGHT_POS = 0x32,
	E3DPARAM_SKY_MOONROTATION = 0x33,
	EPARAM_SUN_SHAFTS_VISIBILITY = 0x34,
	E3DPARAM_SKYBOX_MULTIPLIER = 0x35,
	E3DPARAM_DAY_NIGHT_INDICATOR = 0x36,
	E3DPARAM_HDR_FILMCURVE_SHOULDER_SCALE = 0x37,
	E3DPARAM_HDR_FILMCURVE_LINEAR_SCALE = 0x38,
	E3DPARAM_HDR_FILMCURVE_TOE_SCALE = 0x39,
	E3DPARAM_HDR_FILMCURVE_WHITEPOINT = 0x3A,
	E3DPARAM_HDR_EYEADAPTATION_PARAMS = 0x3B,
	E3DPARAM_HDR_EYEADAPTATION_PARAMS_LEGACY = 0x3C,
	E3DPARAM_HDR_BLOOM_AMOUNT = 0x3D,
	E3DPARAM_HDR_COLORGRADING_COLOR_SATURATION = 0x3E,
	E3DPARAM_HDR_COLORGRADING_COLOR_BALANCE = 0x3F,
	E3DPARAM_COLORGRADING_FILTERS_PHOTOFILTER_COLOR = 0x40,
	E3DPARAM_COLORGRADING_FILTERS_PHOTOFILTER_DENSITY = 0x41,
	E3DPARAM_COLORGRADING_FILTERS_GRAIN = 0x42,
};
...
struct IVisArea : public IClipVolume
{
	...
	virtual bool IsPortalValid() = 0;
	virtual bool IsVisAreaOverlapVisArea(const IVisArea *) = 0;
	// </interfuscator:shuffle>
};
...
struct I3DEngine : public IProcess
{
	...
	virtual IStatObj *LoadStatObj(TSerialize) = 0;
	...
	virtual ArkLoadingProgress GetLoadingProgress() = 0;
	...
	virtual void DestroyDecal(unsigned int) = 0;
	virtual bool SetDecalBlend(unsigned int, float) = 0;
	virtual void FadeOutDecal(unsigned int) = 0;
	...
	virtual void SetSunEnabled(bool) = 0;
	...
	virtual void GetIntersectingVisAreas(const IVisArea *, PodArray<IVisArea *, 0> &) = 0;
	...
	virtual void  SetPostEffectParam(const SSetPostEffectParam &) = 0;
	virtual void  SetPostEffectParam(const SSetPostEffectParamVec4 &) = 0;
	virtual void  SetPostEffectParam(const SSetPostEffectParamString &) = 0;
	...
	virtual bool  IsPostEffectParam(const char *) = 0;
	...
	virtual void SetLayerVisibility(uint16 nLayerId, bool) = 0;
	...
	virtual IArkGlass *CreateBreakableGlass() = 0;
	virtual IArkSpaceManager *GetArkSpaceManager() = 0;
	virtual void UpdateTODProbeLightEntities(bool) = 0;
	virtual unsigned int RegisterForVisChecks(const AABB *) = 0;
	virtual bool WasVisibleRecently(unsigned int, unsigned int) = 0;
	virtual bool UnregisterForVisChecks(unsigned int) = 0;
...
struct SRendItemSorter
{
	...
	enum { eArkUserSelectMask = 0x3FFF, };
