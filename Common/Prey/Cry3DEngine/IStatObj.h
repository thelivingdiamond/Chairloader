...
#include <vector>
#include <Prey/CryCore/smartptr.h>     // TYPEDEF_AUTOPTR
...
enum EStaticObjectFlags
{
	...
	STATIC_OBJECT_WAS_PRELOADED      = BIT(24),
...
struct IStatObj : IMeshObj, IStreamable
{
	...
	enum ELoadingFlags
	{
		...
		ELoadingFlagsLevelPreload   = BIT(5),
	};
	...
	virtual void CopyFoliageData_TODO();
	...
	virtual IStatObj::SSubObject *AddSubObject(IArkGlass *) = 0;
