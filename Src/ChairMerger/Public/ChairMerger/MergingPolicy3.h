...
public:
    ...
    struct Attribute
    {
        ...
        //! If true, mods can't use this attribute at all. Use for attributes that are filled automatically during finalization.
        //! Base nodes are allowed to contain such attributes.
        bool prohibitInMods = false;
