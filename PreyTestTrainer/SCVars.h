...
typedef struct SCVars SCVars, *PSCVars;

typedef struct SGameReleaseConstantCVars SGameReleaseConstantCVars, *PSGameReleaseConstantCVars;

typedef struct ICVar ICVar, *PICVar;

typedef struct SPowerSprintParams SPowerSprintParams, *PSPowerSprintParams;

typedef struct SJumpAirControl SJumpAirControl, *PSJumpAirControl;

typedef struct SPlayerHealth SPlayerHealth, *PSPlayerHealth;

typedef struct SPlayerMovement SPlayerMovement, *PSPlayerMovement;

typedef struct SPlayerLedgeClamber SPlayerLedgeClamber, *PSPlayerLedgeClamber;

typedef struct SPlayerLadder SPlayerLadder, *PSPlayerLadder;

typedef struct SPlayerPickAndThrow SPlayerPickAndThrow, *PSPlayerPickAndThrow;

typedef struct SPlayerSlideControl SPlayerSlideControl, *PSPlayerSlideControl;

typedef struct SPlayerEnemyRamming SPlayerEnemyRamming, *PSPlayerEnemyRamming;

typedef struct SAICollisions SAICollisions, *PSAICollisions;

typedef struct SPlayerMelee SPlayerMelee, *PSPlayerMelee;

typedef struct SAltNormalization SAltNormalization, *PSAltNormalization;

typedef struct SCaptureTheFlagParams SCaptureTheFlagParams, *PSCaptureTheFlagParams;

typedef struct SExtractionParams SExtractionParams, *PSExtractionParams;

typedef struct SPredatorParams SPredatorParams, *PSPredatorParams;

typedef struct SDeathCamSPParams SDeathCamSPParams, *PSDeathCamSPParams;

typedef struct SPostEffect SPostEffect, *PSPostEffect;

typedef struct SSpectacularKillCVars SSpectacularKillCVars, *PSSpectacularKillCVars;

typedef struct SAIPerceptionCVars SAIPerceptionCVars, *PSAIPerceptionCVars;

typedef struct SAIThreatModifierCVars SAIThreatModifierCVars, *PSAIThreatModifierCVars;
...
struct SCVars {
    struct SGameReleaseConstantCVars m_releaseConstants;
    float cl_fov;
    float cl_hfov;
    ...
    struct ICVar * ca_GameControlledStrafingPtr;
    ...
    struct ICVar * sv_aiTeamName;
    struct ICVar * performance_profile_logname;
    ...
    struct ICVar * g_forceHeavyWeapon;
    struct ICVar * g_forceLoadoutPackage;
    ...
    struct SPowerSprintParams pl_power_sprint;
    struct SJumpAirControl pl_jump_control;
    struct SPlayerHealth pl_health;
    struct SPlayerMovement pl_movement;
    struct SPlayerLedgeClamber pl_ledgeClamber;
    struct SPlayerLadder pl_ladderControl;
    struct SPlayerPickAndThrow pl_pickAndThrow;
    struct SPlayerSlideControl pl_sliding_control;
    struct SPlayerSlideControl pl_sliding_control_mp;
    struct SPlayerEnemyRamming pl_enemy_ramming;
    struct SAICollisions AICollisions;
    struct SPlayerMelee pl_melee;
    struct SAltNormalization aim_altNormalization;
    struct SCaptureTheFlagParams mp_ctfParams;
    struct SExtractionParams mp_extractionParams;
    struct SPredatorParams mp_predatorParams;
    ...
    struct ICVar * i_debuggun_1;
    struct ICVar * i_debuggun_2;
    float slide_spread;
    ...
    struct SDeathCamSPParams g_deathCamSP;
    ...
    struct ICVar * autotest_state_setup;
    ...
    struct SPostEffect g_postEffect;
    ...
    struct SSpectacularKillCVars g_spectacularKill;
    ...
    struct ICVar * g_dummyPlayersGameRules;
    ...
    struct ICVar * g_presaleURL;
    struct ICVar * g_messageOfTheDay;
    struct ICVar * g_serverImageUrl;
    struct SAIPerceptionCVars ai_perception;
    struct SAIThreatModifierCVars ai_threatModifiers;
